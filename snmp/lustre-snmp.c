                    ...
                    WriteMethod    **write_method)
{
        ...
        if (current >= next_update) {
                ...
                if (read_string(file_path, (char *) string, sizeof(string)) != SUCCESS)
                        return NULL;

                sscanf((char * ) string, "%u %u %u %u %u %u %u %lu %lu %lu %lu", 
        ...
        case LNETDROPCOUNT:
                *var_len = sizeof(c32);
                ...
                return (unsigned char *) &c32;
        case LNETSENDBYTES:
                convert_ul(&c64, ull[0], var_len);
                return (unsigned char *) &c64;
        case LNETRECVBYTES:
                convert_ul(&c64, ull[1], var_len);
                return (unsigned char *) &c64;
        case LNETROUTEBYTES:
                convert_ul(&c64, ull[2], var_len);
                return (unsigned char *) &c64;
        case LNETDROPBYTES:
                convert_ul(&c64, ull[3], var_len);
                return (unsigned char *) &c64;
        default:
                return NULL;
        }
