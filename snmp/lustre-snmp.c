    	    ...
    	    WriteMethod **write_method)
{
	...
	if (cfs_get_param_path(&path, "obdfilter/"))
		return NULL;
    	    ...
    	    WriteMethod **write_method)
{
	...
	if (cfs_get_param_path(&path, "osc/"))
		return NULL;
    	    ...
    	    WriteMethod **write_method)
{
	...
	if (cfs_get_param_path(&path, "mds/"))
		return NULL;
    	    ...
    	    WriteMethod **write_method)
{
	...
	if (cfs_get_param_path(&path, "mdc/"))
		return NULL;
    	    ...
    	    WriteMethod **write_method)
{
	...
	if (cfs_get_param_path(&path, "llite/"))
		return NULL;
    	    ...
    	    WriteMethod **write_method)
{
	...
	if (cfs_get_param_path(&path, "lov/"))
		return NULL;
    	    ...
    	    WriteMethod **write_method)
{
	...
	if (cfs_get_param_path(&path, "ldlm/namespaces"))
		return NULL;
                    ...
                    WriteMethod    **write_method)
{
	...
	glob_t			  file_path;
		...
		if (cfs_get_param_path(&file_path, "stats"))
			return NULL;
