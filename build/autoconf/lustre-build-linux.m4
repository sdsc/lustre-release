...
# ----------- kconfig.h exists ---------------
# kernel 3.0, $LINUX/include/linux/kconfig.h is added
LB_CHECK_FILE([$LINUX_OBJ/include/linux/kconfig.h],
              [FIRSTLY_INCLUDE=include/linux/kconfig.h],
              [FIRSTLY_INCLUDE=include/$AUTOCONF_HDIR/autoconf.h])
	AC_SUBST(FIRSTLY_INCLUDE)
