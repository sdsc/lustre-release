...
int  kiblnd_create_peer(struct lnet_ni *ni, kib_peer_t **peerp, lnet_nid_t nid);
...
void kiblnd_txlist_done(struct lnet_ni *ni, struct list_head *txlist, int status);
...
int  kiblnd_recv(struct lnet_ni *ni, void *private, struct lnet_msg *lntmsg, int delayed,
