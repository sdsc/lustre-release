...
static struct proc_dir_entry *o2iblnd_proc_root;
...
kiblnd_proc_init(void)
{
        ...
        o2iblnd_proc_root = proc_mkdir(O2IB_PROC_ROOT, init_net.proc_net);
        ...
        entry = proc_create(O2IB_PROC_STATS, 0644, o2iblnd_proc_root,
                            &kiblnd_stats_fops);
        if (entry == NULL) {
...
kiblnd_proc_fini(void)
{
        ...
        remove_proc_entry(O2IB_PROC_ROOT,  init_net.proc_net);
}
