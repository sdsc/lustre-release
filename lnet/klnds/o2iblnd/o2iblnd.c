...
static int
kiblnd_fmr_pool_size(struct lnet_o2iblnd_tunables *tunables, int ncpts)
{
...
static int
kiblnd_fmr_flush_trigger(struct lnet_o2iblnd_tunables *tunables, int ncpts)
{
