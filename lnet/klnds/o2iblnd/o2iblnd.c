                   ...
                   int state, int version)
{
	...
	init_qp_attr->cap.max_send_sge = *kiblnd_tunables.kib_wr_sge;
	init_qp_attr->cap.max_recv_sge = *kiblnd_tunables.kib_wr_sge;
...
kiblnd_destroy_tx_pool(kib_pool_t *pool)
{
		...
		int	  wr_sge = *kiblnd_tunables.kib_wr_sge;
