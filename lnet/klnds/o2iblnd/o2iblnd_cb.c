...
kiblnd_map_tx(lnet_ni_t *ni, kib_tx_t *tx, kib_rdma_desc_t *rd, int nfrags)
{
	...
	if (mr != NULL) {
		...
		CERROR("2 - Setting rd_key to %x / %x\n", mr->lkey, mr->rkey);
