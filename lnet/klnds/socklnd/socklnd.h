...
ksocknal_nid2peerlist(lnet_nid_t nid)
{
	...
	hash = ((unsigned int)nid) % ksocknal_data.ksnd_peer_hash_size;
...
void ksocknal_query(struct lnet_ni *ni, lnet_nid_t nid, cfs_time_t *when);
...
int ksocknal_lib_tunables_init(void);
void ksocknal_lib_tunables_fini(void);
