...
static struct smoketest_rpc {
	...
	struct lnet_handle_any	rpc_lnet_eq;	/* _the_ LNet event queue */
...
srpc_post_passive_rdma(int portal, int local, __u64 matchbits, void *buf,
		       ...
		       struct lnet_handle_any *mdh, srpc_event_t *ev)
{
	int rc;
	struct lnet_md md;
	struct lnet_handle_any meh;
...
srpc_post_active_rdma(int portal, __u64 matchbits, void *buf, int len,
		      ...
		      lnet_nid_t self, struct lnet_handle_any *mdh,
		      srpc_event_t *ev)
{
	int rc;
	struct lnet_md md;
