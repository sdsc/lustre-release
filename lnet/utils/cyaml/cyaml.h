 ...
 */
extern struct cYAML *cYAML_build_tree(char *yaml_file, const char *yaml_blk,
 ...
 */
extern void cYAML_print_tree(struct cYAML *node);
 ...
 *   node - Node where you want to start printing
 */
extern void cYAML_print_tree2file(FILE *f, struct cYAML *node);
 ...
 */
extern void cYAML_free_tree(struct cYAML *node);
 ...
 */
extern struct cYAML *cYAML_get_object_item(struct cYAML *parent,
					   const char *name);
 ...
 *
 */
extern struct cYAML *cYAML_get_next_seq_item(struct cYAML *seq,
					     struct cYAML **itm);
 ...
 *
 */
extern int cYAML_is_seq(struct cYAML *node);
 ...
 *   name - key name of the object you want to find.
 */
extern struct cYAML *cYAML_find_object(struct cYAML *root, const char *name);
 ...
 */
extern void cYAML_clean_usr_data(struct cYAML *node,
 ...
 */
extern void cYAML_tree_recursive_walk(struct cYAML *node, cYAML_walk_cb cb,
 ...
 *  key - node key
 */
extern struct cYAML *cYAML_create_object(struct cYAML *parent, char *key);
 ...
 *  key - node key
 */
extern struct cYAML *cYAML_create_seq(struct cYAML *parent, char *key);
 ...
 *  parent - parent node
 */
extern struct cYAML *cYAML_create_seq_item(struct cYAML *seq);
 ...
 *   value - value of node
 */
extern struct cYAML *cYAML_create_string(struct cYAML *parent, char *key,
					 char *value);
 ...
 *   value - value of node
 */
extern struct cYAML *cYAML_create_number(struct cYAML *parent, char *key,
					 double value);
 ...
 */
extern void cYAML_insert_sibling(struct cYAML *root, struct cYAML *sibling);
 ...
 */
extern void cYAML_insert_child(struct cYAML *parent, struct cYAML *node);
