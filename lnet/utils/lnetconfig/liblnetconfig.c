			 ...
			 struct cYAML **show_rc, struct cYAML **err_rc)
{
	...
	for (i = 0;; i++) {
		 ...
		 * size of data
		 */
		data->hdr.ioc_len = sizeof(struct lnet_ioctl_config_data) +
		...
		net_config = (struct lnet_ioctl_net_config *)data->ioc_bulk;
			     ...
			     struct cYAML **err_rc)
{
	...
	for (i = 0;; i++) {
		...
		pool_cfg = (struct lnet_ioctl_pool_cfg *)data->ioc_bulk;
