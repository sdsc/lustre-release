 ...
 */
extern int lustre_lnet_config_route(char *nw, char *gw, int hops, int prio,
 ...
 *   gw - gateway
 */
extern int lustre_lnet_del_route(char *nw, char *gw, int seq_no,
				 struct cYAML **err_rc);
 ...
 *   err_rc - [OUT] struct cYAML tree describing the error. Freed by caller
 */
extern int lustre_lnet_config_net(char *net, char *intf, int peer_to,
				  int peer_cr, int peer_buf_cr, int credits,
				  char *smp, int seq_no,
				  struct cYAML **err_rc);
 ...
 *   err_rc - [OUT] struct cYAML tree describing the error. Freed by caller
 */
extern int lustre_lnet_del_net(char *nw, int seq_no,
			       struct cYAML **err_rc);
 ...
 *   err_rc - [OUT] struct cYAML tree describing the error. Freed by caller
 */
extern int lustre_lnet_show_net(char *nw, int detail, int seq_no,
 ...
 *   err_rc - [OUT] struct cYAML tree describing the error. Freed by caller
 */
extern int lustre_lnet_enable_routing(int enable, int seq_no,
				      struct cYAML **err_rc);
 ...
 *   err_rc - [OUT] struct cYAML tree describing the error. Freed by caller
 */
extern int lustre_lnet_config_buf(int tiny, int small, int large, int seq_no,
				  struct cYAML **err_rc);
 ...
 *   err_rc - [OUT] struct cYAML tree describing the error. Freed by caller
 */
extern int lustre_lnet_show_buf(int seq_no, struct cYAML **show_rc,
				struct cYAML **err_rc);
 ...
 */
extern int lustre_lnet_show_peer_credits(int seq_no, struct cYAML **show_rc,
					 struct cYAML **err_rc);
 ...
 *     err_rc - YAML strucutre of the resultant return code.
 */
extern int lustre_lnet_show_stats(int seq_no, struct cYAML **show_rc,
				  struct cYAML **err_rc);
 ...
 *   err_rc - [OUT] struct cYAML tree describing the error. Freed by caller
 */
extern int lustre_yaml_config(char *f, struct cYAML **err_rc);
 ...
 *   err_rc - [OUT] struct cYAML tree describing the error. Freed by caller
 */
extern int lustre_yaml_del(char *f, struct cYAML **err_rc);
 ...
 *   err_rc - [OUT] struct cYAML tree describing the error. Freed by caller
 */
extern int lustre_yaml_show(char *f, struct cYAML **show_rc,
			    struct cYAML **err_rc);
