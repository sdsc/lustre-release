...
static int jt_lnet_help(int argc, char **argv);
...
command_t lnet_cmds[] = {
	...
	{"help", jt_lnet_help, 0, "display this help\n"},
	{ 0, 0, 0, NULL }
};
...
static inline int print_help(const command_t cmds[], const char *cmd_type,
			      const char *pc_name)
{
	const command_t *cmd;
...
static int jt_lnet_help(int argc, char **argv)
{
	return print_help(lnet_cmds, "lnet", NULL);
}

static int jt_route_help(int argc, char **argv)
{
	return print_help(route_cmds, "route", NULL);
}

static int jt_net_help(int argc, char **argv)
{
	return print_help(net_cmds, "net", NULL);
}

static int jt_set_help(int argc, char **argv)
{
	return print_help(set_cmds, "set", NULL);
}

static int jt_stats_help(int argc, char **argv)
{
	return print_help(stats_cmds, "stats", NULL);
}

static int jt_peer_credits_help(int argc, char **argv)
{
	return print_help(credits_cmds, "peer_credits", NULL);
}

static int jt_routing_help(int argc, char **argv)
{
	return print_help(routing_cmds, "routing", NULL);
}
		       ...
		       const char *sub_cmd, int argc, char **argv)
{
	...
	if (argc > 1 && strcmp(argv[1], "help") == 0) {
		return print_help(cmd_list, cmd, sub_cmd);
	}
	...
	while ((opt = getopt_long(argc, argv, short_options,
		...
		switch (opt) {
		case 'h':
			rc = print_help(cmd_list, cmd, sub_cmd);
			break;
		default:
			rc = -1;
			break;
...
static int jt_config_lnet(int argc, char **argv)
{
	...
	if (handle_help(lnet_cmds, "lnet", "configure", argc, argv) == 0)
		return 0;
...
static int jt_add_route(int argc, char **argv)
{
	...
	if (handle_help(route_cmds, "route", "add", argc, argv) == 0)
		return 0;
...
static int jt_add_net(int argc, char **argv)
{
	...
	if (handle_help(net_cmds, "net", "add", argc, argv) == 0)
		return 0;
...
static int jt_del_route(int argc, char **argv)
{
	...
	if (handle_help(route_cmds, "route", "del", argc, argv) == 0)
		return 0;
...
static int jt_del_net(int argc, char **argv)
{
	...
	if (handle_help(net_cmds, "net", "del", argc, argv) == 0)
		return 0;
...
static int jt_show_route(int argc, char **argv)
{
	...
	if (handle_help(route_cmds, "route", "show", argc, argv) == 0)
		return 0;
...
static int jt_show_net(int argc, char **argv)
{
	...
	if (handle_help(net_cmds, "net", "show", argc, argv) == 0)
		return 0;
