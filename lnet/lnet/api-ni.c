		   ...
		   __s32 peer_cr, __s32 peer_buf_cr, __s32 credits)
{
	...
	if (!lnd) {
		...
		if (!lnd) {
			...
			LCONSOLE_ERROR_MSG(0x104, "Your kernel must be compiled with kernel module loading support.");
#endif
			rc = -EINVAL;
			goto failed0;
		}
...
LNetCtl(unsigned int cmd, void *arg)
{
	...
	case IOC_LIBCFS_NOTIFY_ROUTER:
		secs_passed = (cfs_time_current_sec() - data->ioc_u64[0]);
