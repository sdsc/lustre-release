...
static void
lnet_fill_ni_info(struct lnet_ni *ni, __u32 *ncpts, __u64 *nid, int *peer_to,
...
int
lnet_get_net(int idx, __u32 *ncpts, __u64 *nid, int *peer_to, int *peer_cr,
	     int *peer_buf_cr, int *credits,
	     struct libcfs_ioctl_net_config *net_config)
{
	struct lnet_ni	*ni;
	cfs_list_t	*tmp;
