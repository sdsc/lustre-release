...
unsigned int
lnet_kiov_nob(unsigned int niov, struct lnet_kiov *kiov)
{
	unsigned int nob = 0;
...
void
lnet_copy_kiov2kiov(unsigned int ndiov, struct lnet_kiov *diov, unsigned int doffset,
		    unsigned int nsiov, struct lnet_kiov *siov, unsigned int soffset,
		    unsigned int nob)
{
	/* NB diov, siov are READ-ONLY */
	unsigned int    this_nob;
...
lnet_copy_kiov2iov (unsigned int niov, struct kvec *iov, unsigned int iovoffset,
		    unsigned int nkiov, struct lnet_kiov *kiov, unsigned int kiovoffset,
                    unsigned int nob)
{
...
void
lnet_copy_iov2kiov(unsigned int nkiov, struct lnet_kiov *kiov, unsigned int kiovoffset,
...
int
lnet_extract_kiov(int dst_niov, struct lnet_kiov *dst,
...
void
lnet_ni_recv(struct lnet_ni *ni, void *private, struct lnet_msg *msg, int delayed,
             unsigned int offset, unsigned int mlen, unsigned int rlen)
{
	unsigned int niov = 0;
	struct kvec *iov = NULL;
	struct lnet_kiov *kiov = NULL;
	int rc;
...
static inline int
lnet_peer_is_alive(struct lnet_peer *lp, cfs_time_t now)
{
	int alive;
        cfs_time_t deadline;
...
lnet_find_route_locked(struct lnet_ni *ni, lnet_nid_t target, lnet_nid_t rtr_nid)
{
 ...
 */
int
LNetPut(lnet_nid_t self, struct lnet_handle_any mdh, enum lnet_ack_req ack,
...
void
lnet_set_reply_msg_len(struct lnet_ni *ni, struct lnet_msg *reply, unsigned int len)
{
 ...
 */
int
LNetGet(lnet_nid_t self, struct lnet_handle_any mdh,
	struct lnet_process_id target, unsigned int portal,
	__u64 match_bits, unsigned int offset)
{
	struct lnet_msg	*msg;
