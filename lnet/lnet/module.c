...
EXPORT_SYMBOL(lnet_ni_addref);
EXPORT_SYMBOL(lnet_ni_decref);
EXPORT_SYMBOL(lnet_get_counters);
EXPORT_SYMBOL(lnet_reset_counters);
EXPORT_SYMBOL(lnet_net_to_cpuid);
EXPORT_SYMBOL(lnet_net_to_cpuid_locked);
