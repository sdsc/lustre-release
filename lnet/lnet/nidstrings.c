...
struct nidrange *nidrange_alloc_init(struct list_head *nidlist)
{
	struct nidrange *nr;
 ...
 * list can be used to match a NID against a set of NIDS defined by \a
