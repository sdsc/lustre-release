...
struct lnet_match_table {
	...
	/*
	 * time stamp of the last buffer posting.
	 * Match-table is marked as inactive if no buffer left on it and
	 * nobody posted any buffer in the last LNET_MT_DEADLINE seconds.
	 */
	unsigned long		mt_lastpost;
