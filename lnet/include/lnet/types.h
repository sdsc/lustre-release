 ...
 * struct lnet_process_id, the global process ID.
 */
 ...
 * The type struct lnet_handle_any can be used when a generic handle is needed.
 * Every handle value can be converted into a value of type lnet_handle_any
 * without loss of information.
 */
struct lnet_handle_any {
	__u64	cookie;
};
 ...
 */
static inline void LNetInvalidateHandle(struct lnet_handle_any *h)
{
 ...
 */
static inline int
LNetHandleIsEqual(struct lnet_handle_any h1, struct lnet_handle_any h2)
{
 ...
 */
static inline int LNetHandleIsInvalid(struct lnet_handle_any h)
{
...
struct lnet_md {
	 ...
	 * address of an array of struct lnet_kiov and the length field
	 * specifies the number of entries in the array. The length can't
	 * be bigger than LNET_MAX_IOV. The struct lnet_kiov is used to
	 * describe page-based fragments that are not necessarily mapped
	 * in virtal memory.
	 ...
	 *   struct lnet_kiov.
         ...
         */
	struct lnet_handle_any eq_handle;
};
