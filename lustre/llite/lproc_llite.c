...
static int ll_rd_statahead_balance(char *page, char **start, off_t off,
                                   int count, int *eof, void *data)
{
        struct super_block *sb = data;
        struct ll_sb_info *sbi = ll_s2sbi(sb);
...
static int ll_wr_statahead_balance(struct file *file, const char *buffer,
                                   unsigned long count, void *data)
{
        struct super_block *sb = data;
        struct ll_sb_info *sbi = ll_s2sbi(sb);
...
static struct lprocfs_vars lprocfs_llite_obd_vars[] = {
        ...
        { "statahead_balance",ll_rd_statahead_balance,
                              ll_wr_statahead_balance, 0 },
