...
static int ll_rd_balance_agl(char *page, char **start, off_t off,
                             int count, int *eof, void *data)
{
        struct super_block *sb = data;
        struct ll_sb_info *sbi = ll_s2sbi(sb);
...
static int ll_wr_balance_agl(struct file *file, const char *buffer,
                             unsigned long count, void *data)
{
        struct super_block *sb = data;
        struct ll_sb_info *sbi = ll_s2sbi(sb);
...
static struct lprocfs_vars lprocfs_llite_obd_vars[] = {
        ...
        { "balance_agl",      ll_rd_balance_agl, ll_wr_balance_agl, 0 },
