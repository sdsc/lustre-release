...
static int ll_rd_statahead_slow(char *page, char **start, off_t off,
                               int count, int *eof, void *data)
{
        struct super_block *sb = data;
        struct ll_sb_info *sbi = ll_s2sbi(sb);
...
static int ll_wr_statahead_slow(struct file *file, const char *buffer,
                               unsigned long count, void *data)
{
        struct super_block *sb = data;
        struct ll_sb_info *sbi = ll_s2sbi(sb);
        ...
        if (val >= 0)
                ...
                CERROR("Bad statahead_slow value %d, which should not be negative.\n", val);
...
static struct lprocfs_vars lprocfs_llite_obd_vars[] = {
        ...
        { "statahead_slow",   ll_rd_statahead_slow, ll_wr_statahead_slow, 0 },
