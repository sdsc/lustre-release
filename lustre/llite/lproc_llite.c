...
static int ll_rd_lockless_directio(char *page, char **start, off_t off,
                                   int count, int *eof, void *data)
{
        struct ll_sb_info *sbi = ll_s2sbi((struct super_block *)data);
...
static int ll_wr_lockless_directio(struct file *file, const char *buffer,
                                   unsigned long count, void *data)
{
        struct ll_sb_info *sbi = ll_s2sbi((struct super_block *)data);
        int val, rc;
...
static struct lprocfs_vars lprocfs_llite_obd_vars[] = {
        ...
        { "lockless_directio",  ll_rd_lockless_directio,
                                ll_wr_lockless_directio, 0 },
        { 0 }
};
