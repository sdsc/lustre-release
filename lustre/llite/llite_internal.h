...
struct ll_sb_info {
        ...
        unsigned int              ll_sa_agl;     /* agl window size */
...
#define LL_AGL_RPC_DEF  LL_SA_RPC_DEF
...
struct ll_statahead_info {
        ...
        unsigned int            sai_sent_all:1, /* all getattr RPC sent */
                                sai_ls_all:1;   /* "ls -al", do stat-ahead for
                                                 * hidden entries */
