...
/* default to about 64meg of readhead window on a file. */
...
struct ll_readahead_stride {
	...
	__u64		lrs_matched_number;
	/**
	 * Previous offset in byte
	 */
	loff_t		lrs_prev_byte;
	/**
	 * Stride size in byte
	 */
	loff_t		lrs_stride_nbyte;
	/**
	 * Request size in byte
	 */
	size_t		lrs_req_nbyte;
	/**
	 * Whether lrs_prev_byte is valid
	 */
	bool		lrs_prev_valid;
	/**
...
/**
 * Max pages a async readahead can commit. This value could be larger than
