...
static int client_common_fill_super(struct super_block *sb, char *md, char *dt)
{
        ...
        root = ll_iget(sb,
                       cl_fid_build_ino(&sbi->ll_root_fid,
                                        sbi->ll_32bitapi),
                       &lmd);
        ...
        sbi->ll_32bitapi = !!ll_need_32bit_api(sbi);
...
#endif
        inode->i_ino = cl_fid_build_ino(&body->fid1, sbi->ll_32bitapi);
