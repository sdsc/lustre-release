...
ll_iget_for_nfs(struct super_block *sb, struct lu_fid *fid, int create_lov)
{
        struct inode  *inode;
                                      ...
                                      int fh_len, int fh_type)
{
        ...
        RETURN(ll_iget_for_nfs(sb, &nfs_fid->lnf_child), 1);
}
                                      ...
                                      int fh_len, int fh_type)
{
        ...
        RETURN(ll_iget_for_nfs(sb, &nfs_fid->lnf_parent), 0);
}
...
static struct dentry *ll_get_dentry(struct super_block *sb, void *data)
{
        ...
        entry = ll_iget_for_nfs(sb, data, 1);
        RETURN(entry);
}
#endif
static struct dentry *ll_get_parent(struct dentry *dchild)
{
        ...
        result = ll_iget_for_nfs(dir->i_sb, &body->fid1, 0);
