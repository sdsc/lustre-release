...
restart:
        ...
        case SA_AGL_ENQU: {
                ...
                if (likely(!cfs_list_empty(&clli->lli_agl_list))) {
                        ...
                        /* I hold child's lock, others can not see SA_AGL_ENQU,
                         * except that someone wants to clean this entry. */
                        cfs_spin_unlock(&plli->lli_sa_lock);
        ...
        case SA_AGL_TAKE: {
                if (clli->lli_agl_u.lau_owner == cfs_curproc_pid()) {
                        ...
                        verified = cl_agl_fini(inode, &clli->lli_agl_args);
                               ...
                               struct ll_statahead_info *sai)
{
        ...
        rc = cl_agl_cleanup(&clli->lli_agl_args);
