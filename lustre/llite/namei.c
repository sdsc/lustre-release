 ...
 * the same as DCACHE_DISCONNECTED, and try to use it anyway. Actually it's safe
 * to just add new dentry here (call d_splice_alias directly), but it's cleaner
 * to reuse the existed INVALID dentry.
 */
