...
static int hash_lqe_cur_bits = HASH_LQE_CUR_BITS;
CFS_MODULE_PARM(hash_lqe_cur_bits, "i", int, 0444,
				      ...
				      struct lquota_entry_operations *ops)
{
	...
	site->lqs_hash= cfs_hash_create(hashname, hash_lqe_cur_bits,
					HASH_LQE_MAX_BITS,
					min(hash_lqe_cur_bits,
					    HASH_LQE_BKT_BITS),
