...
int qsd_set_init(const struct lu_env *env, struct qsd_set *set)
{
...
int qsd_set_prepare(const struct lu_env *env, struct qsd_set *set,
		    struct dt_object *root)
{
	cfs_list_t *l;
	struct qsd_instance *qsd;
...
int qsd_set_start(const struct lu_env *env, struct qsd_set *set)
{
	cfs_list_t *l;
	struct qsd_instance *qsd;
	int rc = 0;
...
void qsd_set_fini(const struct lu_env *env, struct qsd_set *set)
{
	cfs_list_t *l, *tmp;
	struct qsd_instance *qsd;
...
int qsd_set_add(struct qsd_set *set, struct qsd_instance *qsd)
{
	int rc;
...
struct qsd_instance *qsd_set_del(struct qsd_set *set, int pool_id)
{
	struct qsd_instance *qsd;
...
struct qsd_instance *qsd_set_lookup(struct qsd_set *set, int pool_id)
{
	struct qsd_instance *qsd;
