 ...
 *   used on MDT0 in a DNE filesystem, because there are not expected to be
 *   any OLD formatted DNE filesystems. Belongs to sequence in [12, 2^32 - 1]
 ...
 *
 *  For objects within the IDIF range, group extraction (non-DNE) will be:
 *
