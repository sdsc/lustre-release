...
int qsd_set_init(const struct lu_env *, struct quota_set *);
int qsd_set_start(const struct lu_env *, struct quota_set *);
int qsd_set_prepare(const struct lu_env *, struct quota_set *,
		    struct dt_object *);
void qsd_set_fini(const struct lu_env *, struct quota_set *);
struct qsd_instance *qsd_set_lookup(struct quota_set *, int);
int qsd_set_add(struct quota_set *, struct qsd_instance *);
struct qsd_instance *qsd_set_del(struct quota_set *, int);
/*
