...
struct ccc_object {
         ...
         * is evicted, some debug info will be printed, this flag will
         * be set during processing the first discarded page, then avoid
         * flooding debug message for lots of discarded pages.
         * \see ll_dirty_page_discard_warn.
         */
         int                    cob_discard_page_warned;
};
