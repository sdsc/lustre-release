...
out_err:
	/* If returning an error, mark update_reply swabbed so this isn't done
	 * again on the next access.  Later calls should also return an error
	 * for this update buffer and no further processing should be done. */
