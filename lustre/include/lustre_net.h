...
#define MDS_MAX_OTHR_THREADS	512
...
#define MDS_NTHRS_BASE		min(128, MDS_NTHRS_MAX)
#define MDS_NTHRS_DEFAULT	min(512, MDS_NTHRS_MAX)

/* read-page service */
#define MDS_RDPG_THR_FACTOR	4
#define MDS_RDPG_NTHRS_INIT	PTLRPC_NTHRS_INIT
#define MDS_RDPG_NTHRS_MAX	MDS_MAX_OTHR_THREADS
#define MDS_RDPG_NTHRS_BASE	min(64, MDS_RDPG_NTHRS_MAX)
#define MDS_RDPG_NTHRS_DEFAULT	min(256, MDS_RDPG_NTHRS_MAX)
...
#define MDS_SETA_NTHRS_BASE	min(64, MDS_SETA_NTHRS_MAX)
#define MDS_SETA_NTHRS_DEFAULT	min(256, MDS_SETA_NTHRS_MAX)
...
struct ptlrpc_service_part {
	...
	__u32				scp_hist_seq_num;
	/** timestamp for request sequence # */
	__u64				scp_hist_seq_time;
