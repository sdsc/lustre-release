...
struct nrs_orr_info {
	...
	__u8			oi_trr_mode_hp;
	enum nrs_orr_supp	oi_supp_req_reg;
	enum nrs_orr_supp	oi_supp_req_hp;
};
...
struct ptlrpc_service {
	 ...
	 *  handle HP requests */
	struct ptlrpc_nrs	       *srv_hpreq_nrs;
	/* Bitmask of  supported NRS policies */
	enum ptlrpc_nrs_pol_type	srv_nrs_supported;
