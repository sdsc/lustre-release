 ...
 *
 * - single object with 256 pages is 2048 bytes
...
#define OSS_IO_MAXREQSIZE	max_t(int, OSS_MAXREQSIZE, \
				(((_OSS_MAXREQSIZE_SUM - 1) | (1024 - 1)) + 1))

#define OSS_MAXREPSIZE		(9 * 1024)
#define OSS_IO_MAXREPSIZE	OSS_MAXREPSIZE

#define OSS_NBUFS		64
/** OSS_BUFSIZE = max_reqsize + max sptlrpc payload size */
#define OSS_BUFSIZE		max_t(int, OSS_MAXREQSIZE + 1024, 16 * 1024)
/**
 * OSS_IO_MAXREQSIZE is 18K, giving extra 46K can increase buffer utilization
 * rate of request buffer, please check comment of MDS_LOV_BUFSIZE for details.
 */
#define OSS_IO_BUFSIZE		max_t(int, OSS_IO_MAXREQSIZE + 1024, 64 * 1024)
