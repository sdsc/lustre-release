...
/**
 * OST_MAXREQSIZE ~=
 * 	lustre_msg + ptlrpc_body + obdo + ldlm_request + lustre_capa
 * it should be less than 1K, but it's set to 2K at here, so it has space
 * margin for future changes.
 */
...
#define OST_BUFSIZE		max_t(int, OST_MAXREQSIZE + 1024, 8 * 1024)
/**
