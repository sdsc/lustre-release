...
struct nrs_crrn_net {
	...
	__u64				cn_round;
	/**
	 * Determines the relevant ordering amongst request batches withing a
	 * scheduling round.
	 */
	__u64				cn_sequence;
	/**
...
struct nrs_crrn_client {
	...
	cfs_atomic_t			cc_ref;
	/**
	 * Round Robin quanum; the maximum number of RPCs the client is allowed
...
/**
 * Lower and upper offsets of a brw RPC
 */
 ...
 * maybe this can be replaced by OST FID
 */
struct nrs_orr_key {
	/* Object ID */
	obd_id		ok_id;
