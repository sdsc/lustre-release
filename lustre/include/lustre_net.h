...
struct ptlrpc_cli_req {
	...
	struct ptlrpc_request_pool	*cr_pool;
	...
	cfs_list_t			 cr_set_chain;
	/** link to waited ctx */
	cfs_list_t			 cr_ctx_chain;
...
struct ptlrpc_srv_req {
	 ...
	 * requests in time
	 */
	cfs_list_t			 sr_timed_list;
	/** server-side per-export list */
	cfs_list_t			 sr_exp_list;
	/** server-side history, used for debuging purposes. */
	cfs_list_t			 sr_hist_list;
	/** history sequence # */
	__u64				 sr_hist_seq;
	...
	struct lu_context		 sr_ses_recov;
	/** \addtogroup  nrs
	 * @{
	 */
...
#define rq_recov_session	rq_srv.sr_ses_recov
