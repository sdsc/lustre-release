 ...
 * name_len, and not contain '/'. The maximum length of a valid name
 * is really controlled by llite and mdd \see mdd_name_check(). We
 * only check for something insane coming from bed integer handling
 * here.
 */
