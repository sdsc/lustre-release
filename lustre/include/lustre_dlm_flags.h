...
#define ldlm_is_cos_incompat(_l)	LDLM_TEST_FLAG((_l), 1ULL << 57)
#define ldlm_set_cos_incompat(_l)	LDLM_SET_FLAG((_l), 1ULL << 57)
#define ldlm_clear_cos_incompat(_l)	LDLM_CLEAR_FLAG((_l), 1ULL << 57)
