 ...
 *
 * It has been AutoGen-ed  February 14, 2013 at 10:35:43 AM by AutoGen 5.17.2pre14
...
#define ldlm_is_lock_changed(_l)      LDLM_TEST_FLAG( (_l), LDLM_LOCK_CHANGED)
#define ldlm_set_lock_changed(_l)     LDLM_SET_FLAG(  (_l), LDLM_LOCK_CHANGED)
#define ldlm_clear_lock_changed(_l)   LDLM_CLEAR_FLAG((_l), LDLM_LOCK_CHANGED)
...
#define ldlm_is_block_granted(_l)     LDLM_TEST_FLAG( (_l), LDLM_BLOCK_GRANTED)
#define ldlm_set_block_granted(_l)    LDLM_SET_FLAG(  (_l), LDLM_BLOCK_GRANTED)
#define ldlm_clear_block_granted(_l)  LDLM_CLEAR_FLAG((_l), LDLM_BLOCK_GRANTED)
...
#define ldlm_is_block_conv(_l)        LDLM_TEST_FLAG( (_l), LDLM_BLOCK_CONV)
#define ldlm_set_block_conv(_l)       LDLM_SET_FLAG(  (_l), LDLM_BLOCK_CONV)
#define ldlm_clear_block_conv(_l)     LDLM_CLEAR_FLAG((_l), LDLM_BLOCK_CONV)
...
#define ldlm_is_block_wait(_l)        LDLM_TEST_FLAG( (_l), LDLM_BLOCK_WAIT)
#define ldlm_set_block_wait(_l)       LDLM_SET_FLAG(  (_l), LDLM_BLOCK_WAIT)
#define ldlm_clear_block_wait(_l)     LDLM_CLEAR_FLAG((_l), LDLM_BLOCK_WAIT)

/** blocking or cancel packet was queued for sending. */
#define LDLM_FL_AST_SENT              0x0000000000000020ULL // bit  5
#define ldlm_is_ast_sent(_l)          LDLM_TEST_FLAG( (_l), LDLM_AST_SENT)
#define ldlm_set_ast_sent(_l)         LDLM_SET_FLAG(  (_l), LDLM_AST_SENT)
#define ldlm_clear_ast_sent(_l)       LDLM_CLEAR_FLAG((_l), LDLM_AST_SENT)
...
#define ldlm_is_replay(_l)            LDLM_TEST_FLAG( (_l), LDLM_REPLAY)
#define ldlm_set_replay(_l)           LDLM_SET_FLAG(  (_l), LDLM_REPLAY)
#define ldlm_clear_replay(_l)         LDLM_CLEAR_FLAG((_l), LDLM_REPLAY)

/** Don't grant lock, just do intent. */
#define LDLM_FL_INTENT_ONLY           0x0000000000000200ULL // bit  9
#define ldlm_is_intent_only(_l)       LDLM_TEST_FLAG( (_l), LDLM_INTENT_ONLY)
#define ldlm_set_intent_only(_l)      LDLM_SET_FLAG(  (_l), LDLM_INTENT_ONLY)
#define ldlm_clear_intent_only(_l)    LDLM_CLEAR_FLAG((_l), LDLM_INTENT_ONLY)

/** lock request has intent */
#define LDLM_FL_HAS_INTENT            0x0000000000001000ULL // bit 12
#define ldlm_is_has_intent(_l)        LDLM_TEST_FLAG( (_l), LDLM_HAS_INTENT)
#define ldlm_set_has_intent(_l)       LDLM_SET_FLAG(  (_l), LDLM_HAS_INTENT)
#define ldlm_clear_has_intent(_l)     LDLM_CLEAR_FLAG((_l), LDLM_HAS_INTENT)

/** discard (no writeback) on cancel */
#define LDLM_FL_DISCARD_DATA          0x0000000000010000ULL // bit 16
#define ldlm_is_discard_data(_l)      LDLM_TEST_FLAG( (_l), LDLM_DISCARD_DATA)
#define ldlm_set_discard_data(_l)     LDLM_SET_FLAG(  (_l), LDLM_DISCARD_DATA)
#define ldlm_clear_discard_data(_l)   LDLM_CLEAR_FLAG((_l), LDLM_DISCARD_DATA)

/** Blocked by group lock - wait indefinitely */
#define LDLM_FL_NO_TIMEOUT            0x0000000000020000ULL // bit 17
#define ldlm_is_no_timeout(_l)        LDLM_TEST_FLAG( (_l), LDLM_NO_TIMEOUT)
#define ldlm_set_no_timeout(_l)       LDLM_SET_FLAG(  (_l), LDLM_NO_TIMEOUT)
#define ldlm_clear_no_timeout(_l)     LDLM_CLEAR_FLAG((_l), LDLM_NO_TIMEOUT)
...
#define ldlm_is_block_nowait(_l)      LDLM_TEST_FLAG( (_l), LDLM_BLOCK_NOWAIT)
#define ldlm_set_block_nowait(_l)     LDLM_SET_FLAG(  (_l), LDLM_BLOCK_NOWAIT)
#define ldlm_clear_block_nowait(_l)   LDLM_CLEAR_FLAG((_l), LDLM_BLOCK_NOWAIT)

/** return blocking lock */
#define LDLM_FL_TEST_LOCK             0x0000000000080000ULL // bit 19
#define ldlm_is_test_lock(_l)         LDLM_TEST_FLAG( (_l), LDLM_TEST_LOCK)
#define ldlm_set_test_lock(_l)        LDLM_SET_FLAG(  (_l), LDLM_TEST_LOCK)
#define ldlm_clear_test_lock(_l)      LDLM_CLEAR_FLAG((_l), LDLM_TEST_LOCK)
...
#define ldlm_is_cancel_on_block(_l)    LDLM_TEST_FLAG( (_l), LDLM_CANCEL_ON_BLOCK)
#define ldlm_set_cancel_on_block(_l)   LDLM_SET_FLAG(  (_l), LDLM_CANCEL_ON_BLOCK)
#define ldlm_clear_cancel_on_block(_l) LDLM_CLEAR_FLAG((_l), LDLM_CANCEL_ON_BLOCK)

/**
 * measure lock contention and return -EUSERS if locking contention is high
 */
#define LDLM_FL_DENY_ON_CONTENTION    0x0000000040000000ULL // bit 30
#define ldlm_is_deny_on_contention(_l)    LDLM_TEST_FLAG( (_l), LDLM_DENY_ON_CONTENTION)
#define ldlm_set_deny_on_contention(_l)   LDLM_SET_FLAG(  (_l), LDLM_DENY_ON_CONTENTION)
#define ldlm_clear_deny_on_contention(_l) LDLM_CLEAR_FLAG((_l), LDLM_DENY_ON_CONTENTION)
...
#define ldlm_is_ast_discard_data(_l)    LDLM_TEST_FLAG( (_l), LDLM_AST_DISCARD_DATA)
#define ldlm_set_ast_discard_data(_l)   LDLM_SET_FLAG(  (_l), LDLM_AST_DISCARD_DATA)
#define ldlm_clear_ast_discard_data(_l) LDLM_CLEAR_FLAG((_l), LDLM_AST_DISCARD_DATA)
...
#define ldlm_is_fail_loc(_l)          LDLM_TEST_FLAG( (_l), LDLM_FAIL_LOC)
#define ldlm_set_fail_loc(_l)         LDLM_SET_FLAG(  (_l), LDLM_FAIL_LOC)
#define ldlm_clear_fail_loc(_l)       LDLM_CLEAR_FLAG((_l), LDLM_FAIL_LOC)
...
#define ldlm_is_skipped(_l)           LDLM_TEST_FLAG( (_l), LDLM_SKIPPED)
#define ldlm_set_skipped(_l)          LDLM_SET_FLAG(  (_l), LDLM_SKIPPED)
#define ldlm_clear_skipped(_l)        LDLM_CLEAR_FLAG((_l), LDLM_SKIPPED)

/** this lock is being destroyed */
#define LDLM_FL_CBPENDING             0x0000000400000000ULL // bit 34
#define ldlm_is_cbpending(_l)         LDLM_TEST_FLAG( (_l), LDLM_CBPENDING)
#define ldlm_set_cbpending(_l)        LDLM_SET_FLAG(  (_l), LDLM_CBPENDING)
#define ldlm_clear_cbpending(_l)      LDLM_CLEAR_FLAG((_l), LDLM_CBPENDING)

/** not a real flag, not saved in lock */
#define LDLM_FL_WAIT_NOREPROC         0x0000000800000000ULL // bit 35
#define ldlm_is_wait_noreproc(_l)     LDLM_TEST_FLAG( (_l), LDLM_WAIT_NOREPROC)
#define ldlm_set_wait_noreproc(_l)    LDLM_SET_FLAG(  (_l), LDLM_WAIT_NOREPROC)
#define ldlm_clear_wait_noreproc(_l)  LDLM_CLEAR_FLAG((_l), LDLM_WAIT_NOREPROC)

/** cancellation callback already run */
#define LDLM_FL_CANCEL                0x0000001000000000ULL // bit 36
#define ldlm_is_cancel(_l)            LDLM_TEST_FLAG( (_l), LDLM_CANCEL)
#define ldlm_set_cancel(_l)           LDLM_SET_FLAG(  (_l), LDLM_CANCEL)
#define ldlm_clear_cancel(_l)         LDLM_CLEAR_FLAG((_l), LDLM_CANCEL)

/** whatever */
#define LDLM_FL_LOCAL_ONLY            0x0000002000000000ULL // bit 37
#define ldlm_is_local_only(_l)        LDLM_TEST_FLAG( (_l), LDLM_LOCAL_ONLY)
#define ldlm_set_local_only(_l)       LDLM_SET_FLAG(  (_l), LDLM_LOCAL_ONLY)
#define ldlm_clear_local_only(_l)     LDLM_CLEAR_FLAG((_l), LDLM_LOCAL_ONLY)

/** don't run the cancel callback under ldlm_cli_cancel_unused */
#define LDLM_FL_FAILED                0x0000004000000000ULL // bit 38
#define ldlm_is_failed(_l)            LDLM_TEST_FLAG( (_l), LDLM_FAILED)
#define ldlm_set_failed(_l)           LDLM_SET_FLAG(  (_l), LDLM_FAILED)
#define ldlm_clear_failed(_l)         LDLM_CLEAR_FLAG((_l), LDLM_FAILED)

/** lock cancel has already been sent */
#define LDLM_FL_CANCELING             0x0000008000000000ULL // bit 39
#define ldlm_is_canceling(_l)         LDLM_TEST_FLAG( (_l), LDLM_CANCELING)
#define ldlm_set_canceling(_l)        LDLM_SET_FLAG(  (_l), LDLM_CANCELING)
#define ldlm_clear_canceling(_l)      LDLM_CLEAR_FLAG((_l), LDLM_CANCELING)

/** local lock (ie, no srv/cli split) */
#define LDLM_FL_LOCAL                 0x0000010000000000ULL // bit 40
#define ldlm_is_local(_l)             LDLM_TEST_FLAG( (_l), LDLM_LOCAL)
#define ldlm_set_local(_l)            LDLM_SET_FLAG(  (_l), LDLM_LOCAL)
#define ldlm_clear_local(_l)          LDLM_CLEAR_FLAG((_l), LDLM_LOCAL)
...
#define ldlm_is_lvb_ready(_l)         LDLM_TEST_FLAG( (_l), LDLM_LVB_READY)
#define ldlm_set_lvb_ready(_l)        LDLM_SET_FLAG(  (_l), LDLM_LVB_READY)
#define ldlm_clear_lvb_ready(_l)      LDLM_CLEAR_FLAG((_l), LDLM_LVB_READY)
...
#define ldlm_is_kms_ignore(_l)        LDLM_TEST_FLAG( (_l), LDLM_KMS_IGNORE)
#define ldlm_set_kms_ignore(_l)       LDLM_SET_FLAG(  (_l), LDLM_KMS_IGNORE)
#define ldlm_clear_kms_ignore(_l)     LDLM_CLEAR_FLAG((_l), LDLM_KMS_IGNORE)

/** completion AST to be executed */
#define LDLM_FL_CP_REQD               0x0000080000000000ULL // bit 43
#define ldlm_is_cp_reqd(_l)           LDLM_TEST_FLAG( (_l), LDLM_CP_REQD)
#define ldlm_set_cp_reqd(_l)          LDLM_SET_FLAG(  (_l), LDLM_CP_REQD)
#define ldlm_clear_cp_reqd(_l)        LDLM_CLEAR_FLAG((_l), LDLM_CP_REQD)

/** cleanup_resource has already handled the lock */
#define LDLM_FL_CLEANED               0x0000100000000000ULL // bit 44
#define ldlm_is_cleaned(_l)           LDLM_TEST_FLAG( (_l), LDLM_CLEANED)
#define ldlm_set_cleaned(_l)          LDLM_SET_FLAG(  (_l), LDLM_CLEANED)
#define ldlm_clear_cleaned(_l)        LDLM_CLEAR_FLAG((_l), LDLM_CLEANED)
...
#define ldlm_is_atomic_cb(_l)         LDLM_TEST_FLAG( (_l), LDLM_ATOMIC_CB)
#define ldlm_set_atomic_cb(_l)        LDLM_SET_FLAG(  (_l), LDLM_ATOMIC_CB)
#define ldlm_clear_atomic_cb(_l)      LDLM_CLEAR_FLAG((_l), LDLM_ATOMIC_CB)
...
#define ldlm_is_bl_ast(_l)            LDLM_TEST_FLAG( (_l), LDLM_BL_AST)
#define ldlm_set_bl_ast(_l)           LDLM_SET_FLAG(  (_l), LDLM_BL_AST)
#define ldlm_clear_bl_ast(_l)         LDLM_CLEAR_FLAG((_l), LDLM_BL_AST)

/** whatever */
#define LDLM_FL_BL_DONE               0x0000800000000000ULL // bit 47
#define ldlm_is_bl_done(_l)           LDLM_TEST_FLAG( (_l), LDLM_BL_DONE)
#define ldlm_set_bl_done(_l)          LDLM_SET_FLAG(  (_l), LDLM_BL_DONE)
#define ldlm_clear_bl_done(_l)        LDLM_CLEAR_FLAG((_l), LDLM_BL_DONE)
...
#define ldlm_is_no_lru(_l)            LDLM_TEST_FLAG( (_l), LDLM_NO_LRU)
#define ldlm_set_no_lru(_l)           LDLM_SET_FLAG(  (_l), LDLM_NO_LRU)
#define ldlm_clear_no_lru(_l)         LDLM_CLEAR_FLAG((_l), LDLM_NO_LRU)
...
#define ldlm_is_fail_notified(_l)     LDLM_TEST_FLAG( (_l), LDLM_FAIL_NOTIFIED)
#define ldlm_set_fail_notified(_l)    LDLM_SET_FLAG(  (_l), LDLM_FAIL_NOTIFIED)
#define ldlm_clear_fail_notified(_l)  LDLM_CLEAR_FLAG((_l), LDLM_FAIL_NOTIFIED)
...
#define ldlm_is_destroyed(_l)         LDLM_TEST_FLAG( (_l), LDLM_DESTROYED)
#define ldlm_set_destroyed(_l)        LDLM_SET_FLAG(  (_l), LDLM_DESTROYED)
#define ldlm_clear_destroyed(_l)      LDLM_CLEAR_FLAG((_l), LDLM_DESTROYED)

/** flag whether this is a server namespace lock */
#define LDLM_FL_SERVER_LOCK           0x0008000000000000ULL // bit 51
#define ldlm_is_server_lock(_l)       LDLM_TEST_FLAG( (_l), LDLM_SERVER_LOCK)
#define ldlm_set_server_lock(_l)      LDLM_SET_FLAG(  (_l), LDLM_SERVER_LOCK)
#define ldlm_clear_server_lock(_l)    LDLM_CLEAR_FLAG((_l), LDLM_SERVER_LOCK)
...
#define ldlm_is_res_locked(_l)        LDLM_TEST_FLAG( (_l), LDLM_RES_LOCKED)
#define ldlm_set_res_locked(_l)       LDLM_SET_FLAG(  (_l), LDLM_RES_LOCKED)
#define ldlm_clear_res_locked(_l)     LDLM_CLEAR_FLAG((_l), LDLM_RES_LOCKED)
...
#define ldlm_is_waited(_l)            LDLM_TEST_FLAG( (_l), LDLM_WAITED)
#define ldlm_set_waited(_l)           LDLM_SET_FLAG(  (_l), LDLM_WAITED)
#define ldlm_clear_waited(_l)         LDLM_CLEAR_FLAG((_l), LDLM_WAITED)

/** Flag whether this is a server namespace lock. */
#define LDLM_FL_NS_SRV                0x0040000000000000ULL // bit 54
#define ldlm_is_ns_srv(_l)            LDLM_TEST_FLAG( (_l), LDLM_NS_SRV)
#define ldlm_set_ns_srv(_l)           LDLM_SET_FLAG(  (_l), LDLM_NS_SRV)
#define ldlm_clear_ns_srv(_l)         LDLM_CLEAR_FLAG((_l), LDLM_NS_SRV)
