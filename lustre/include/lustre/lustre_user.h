...
struct llapi_lu_ladvise {
	...
	__u16 lla_value1;	/* value for different advice types */
	__u32 lla_value2;
 ...
 *
 * The offset of lah_magic must stay the same, as we may use it in the future
 * to recognize different versions of the struct.  Versioning of this struct
 * will be used to detect possible size changes, not to deal with feature
 * compatibility, which is handled by feature specific checks. */
