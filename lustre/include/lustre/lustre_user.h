...
#define LU_LADVISE_NAMES {						\
	...
	[LU_LADVISE_REQUESTLOCK] = "requestlock",			\
}
...
#define LF_REQUESTLOCK_MASK LF_NONBLOCK
...
#define lla_requestlock_mode   lla_value1
#define lla_peradvice_flags    lla_value2
#define lla_requestlock_result lla_value3
...
enum requestlock_results {
	LRL_RESULT_SENT = 0,
	LRL_RESULT_DIFFERENT,
	LRL_RESULT_SAME,
};
