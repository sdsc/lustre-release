...
typedef void (*llapi_log_cb_t)(int level, int errcode, const char *msg);
...
#define LLAPI_MSG_IS_ERROR	0x00000020

extern void llapi_msg_set_level(int level);
extern void llapi_msg_set_callback(llapi_log_cb_t cb);
