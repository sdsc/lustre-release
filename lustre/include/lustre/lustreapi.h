...
extern int llapi_get_build_version(char *version, int version_size);
extern int llapi_get_release_version(char *version, int version_size);
/* llapi_get_version() is deprecated, use llapi_get_{build,release}_version() */
