...
extern int llapi_file_open2(const char *name, int flags, int mode,
			    struct llapi_stripe_param *param);
extern int llapi_file_create2(const char *name,
			      struct llapi_stripe_param *param);
...
extern int llapi_dir_create(const char *name, int flags,
			    struct llapi_stripe_param *param);
