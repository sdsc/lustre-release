...
typedef void (*llapi_log_cb_t)(int level, int errcode, const char *fmt,
			       va_list ap);
...
extern llapi_log_cb_t llapi_msg_error_callback_set(llapi_log_cb_t cb);
extern llapi_log_cb_t llapi_msg_info_callback_set(llapi_log_cb_t cb);
