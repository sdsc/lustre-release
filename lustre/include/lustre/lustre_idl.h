...
enum oss_rpc_opc {
	...
	OSS_QUOTACHECK		= 18,
	OSS_QUOTACTL		= 19,
	OSS_QUOTA_ADJUST_QUNIT	= 20,	/* not used since 2.4 */
	OSS_LAST_OPC,		/* do not exceed 32 */
	OSS_FIRST_OPC		= OSS_GETATTR
};

/* OST RPC opcodes for backward API compatibility since 2.4 */
enum ost_rpc_opc {
	OST_GETATTR		= OSS_GETATTR,
	OST_SETATTR		= OSS_SETATTR,
	OST_READ		= OSS_READ,
	OST_WRITE		= OSS_WRITE,
	OST_CREATE		= OSS_CREATE,
	OST_DESTROY		= OSS_DESTROY,
	OST_GET_INFO		= OSS_GET_INFO,
	OST_CONNECT		= OSS_CONNECT,
	OST_DISCONNECT		= OSS_DISCONNECT,
	OST_PUNCH		= OSS_PUNCH,
	OST_OPEN		= OSS_OPEN,
	OST_CLOSE		= OSS_CLOSE,
	OST_STATFS		= OSS_STATFS,
	OST_SYNC		= OSS_SYNC,
	OST_SET_INFO		= OSS_SET_INFO,
	OST_QUOTACHECK		= OSS_QUOTACHECK,
	OST_QUOTACTL		= OSS_QUOTACTL,
	OST_QUOTA_ADJUST_QUNIT	= OSS_QUOTA_ADJUST_QUNIT, /* unused since 2.4 */
	OST_LAST_OPC		= OSS_LAST_OPC,
	OST_FIRST_OPC		= OSS_FIRST_OPC
};
