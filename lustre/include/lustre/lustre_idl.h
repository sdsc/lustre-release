...
static inline unsigned fld_range_type(struct lu_seq_range *range)
{
	return range->lsr_flags & LU_SEQ_RANGE_MASK;
}

static inline int fld_is_ost_range(struct lu_seq_range *range)
{
	return fld_range_type(range) == LU_SEQ_RANGE_OST;
}

static inline int fld_is_mdt_range(struct lu_seq_range *range)
{
 ...
 * expected.
 */
static inline unsigned fld_is_all_range(struct lu_seq_range *range)
{
