...
/* For 64bit alignment purpose(with ou_count), it should be 4*n + 3
 * (n = 0 for now)*/
#define OUT_UPDATE_PARAMS_MAX	7
/* object update */
struct object_update {
	...
	__u16		ou_count;
	__u16		ou_lens[OUT_UPDATE_PARAMS_MAX];
						/* lengths of per-update
						 * parameters */
	char		ou_bufs[0];		/* per-params buf */
};
