...
/* Portal 63 is reserved for the Cray Inc DVS - roe@cray.com, n8851@cray.com */
...
/* #define MSG_CONNECT_PEER	0x00000008 obsolete since 1.2 */
#define MSG_CONNECT_LIBCLIENT	0x00000010 /* liblustre client (deprecated) */
...
/*	OSS_CLOSE		= 12,	obsolete since 1.0 */
	...
	OSS_SYNC		= 16,
	OSS_SET_INFO		= 17,
/*	OSS_QUOTACHECK		= 18,   obsolete since 2.4 */
	OSS_QUOTACTL		= 19,
/*	OSS_QUOTA_ADJUST_QUNIT	= 20,	obsolete since 2.4 */
	OSS_LADVISE		= 21,
	OSS_LAST_OPC,		/* must be < 33 to avoid MDS_GETATTR */
...
enum obd_rpc_opc {
	OBD_PING		= 400,
	OBD_LOG_CANCEL		= 401,
/*	OBD_QC_CALLBACK		= 402, obsolete since 2.4.0 */
	OBD_IDX_READ		= 403,
	OBD_LAST_OPC,
