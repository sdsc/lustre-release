...
#define OBD_CONNECT_EINPROGRESS 0x80000000000ULL /* client can handle the
                                                  ...
                                                  * RPC properly */
#define OBD_CONNECT_PACKAGED_XATTR 0x100000000000ULL/* packaged xattr support */
...
#define OBD_MD_FLXATTR       (0x0000001000000000ULL) /* xattr, packaged xattrs*/
...
struct mdt_body {
       ...
       obd_time        ctime;
        ...
        __u32          suppgid;
        __u32          eadatasize;
        __u32          mb_pxattr; /* valid bits for packaged xattr request,
