...
struct cl_attr {
        ...
        loff_t cat_kms;
	/**
	 * Modification time. Measured in seconds since epoch + nanoseconds.
	 */
	struct timespec cat_mtime;
	/**
	 * Access time. Measured in seconds since epoch + nanoseconds.
	 */
	struct timespec cat_atime;
	/**
	 * Change time. Measured in seconds since epoch + nanoseconds.
	 */
