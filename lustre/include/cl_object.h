...
static inline int __page_in_use(const struct cl_page *page, bool noref)
{
	int refc = noref == false;
...
#define cl_page_in_use(pg) __page_in_use(pg, false)
#define cl_page_in_use_noref(pg) __page_in_use(pg, true)
