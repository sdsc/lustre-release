...
struct cl_io_operations {
        ...
        struct {
                 ...
                 *
                 * Called top-to-bottom for post lock acquisition
                 * event, called after all lock are
...
struct cl_io {
        ...
        /** layout lock protecting the layout ci_lsm */
        struct layout_lock            *ci_ll;
        /**
...
int   cl_io_init         (const struct lu_env *env, struct cl_io *io,
                          ...
                          struct lov_stripe_md *lsm, struct layout_lock *ll);
