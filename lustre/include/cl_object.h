 ...
 *    page in Linux kernel, for example), page_t. It is assumed, that this
 ...
 *          environment.
 *
 *    The association between cl_page and page_t is immutable and
 ...
 *    implementing association between cl_page and page_t has to implement
 ...
 *              spin-lock;
 *
 *            - by starting from VM-locked page_t and following some
 ...
 *
 *    Binding between cl_page and page_t (which is a typedef for
...
/**
 * Fields are protected by the lock on page_t, except for atomics and
 * immutables.
 *
...
struct cl_page_operations {
        /**
	 * cl_page<->page_t methods. Only one layer in the stack has to
         ...
         */
	page_t *(*cpo_vmpage)(const struct lu_env *env,
...
void            cl_page_header_print(const struct lu_env *env, void *cookie,
                                     lu_printer_t printer,
                                     const struct cl_page *pg);
page_t     *cl_page_vmpage      (const struct lu_env *env,
                                     struct cl_page *page);
