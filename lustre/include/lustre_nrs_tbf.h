...
struct nrs_tbf_ops {
	char *o_name;
	int (*o_rule_start_default)(struct ptlrpc_nrs_policy *,
				    struct nrs_tbf_head *);
	cfs_hash_t *(*o_hash_create)(void);
	struct nrs_tbf_client *(*o_hash_lookup)(cfs_hash_t *,
						struct ptlrpc_request *);
	struct nrs_tbf_client *
		(*o_hash_findadd_unique)(cfs_hash_t *,
					 struct nrs_tbf_client *);
	void (*o_client_init_info)(struct nrs_tbf_client *,
				   struct ptlrpc_request *);
