...
#ifndef HAVE_DENTRY_D_ALIAS_LIST
#define ll_d_hlist_node hlist_node
#define ll_d_hlist_empty(list) hlist_empty(list)
#define ll_d_hlist_entry(ptr, type, name) hlist_entry(ptr.first, type, name)
#define ll_d_hlist_for_each(tmp, i_dentry) hlist_for_each(tmp, i_dentry)
# ifndef HAVE_DENTRY_D_U_D_ALIAS
# define d_u.d_alias		d_alias
# endif
# ifdef HAVE_HLIST_FOR_EACH_3ARG
# define ll_d_hlist_for_each_entry(dentry, p, i_dentry) \
	p = NULL; hlist_for_each_entry(dentry, i_dentry, d_u.d_alias)
# else
# define ll_d_hlist_for_each_entry(dentry, p, i_dentry) \
	hlist_for_each_entry(dentry, p, i_dentry, d_u.d_alias)
# endif
...
#endif /* !HAVE_DENTRY_D_ALIAS_LIST */
