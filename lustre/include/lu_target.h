...
#define urh_transno	urh_updates->ur_batchid
#define urh_cookie	urh_updates->ur_cookie
...
struct update_recovery_data {
	...
	int				urd_connected_tgt;
	int				urd_got_recovery_updates;
	__u64				urd_recovery_ready:1;
