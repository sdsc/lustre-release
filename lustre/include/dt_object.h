                                    ...
                                    struct thandle *th)
{
	...
	if (OBD_FAULT_CHECK(OBD_FAIL_DT_DECLARE_CREATE))
		return cfs_fail_err;
                                    ...
                                    struct thandle *th)
{
	...
	if (OBD_FAULT_CHECK(OBD_FAIL_DT_CREATE))
		return cfs_fail_err;
                                     ...
                                     struct thandle *th)
{
	...
	if (OBD_FAULT_CHECK(OBD_FAIL_DT_DECLARE_DESTROY))
		return cfs_fail_err;
                             ...
                             struct thandle *th)
{
	...
	if (OBD_FAULT_CHECK(OBD_FAIL_DT_DESTROY))
		return cfs_fail_err;
				      ...
				      struct lustre_capa *capa)
{
	...
	if (OBD_FAULT_CHECK(OBD_FAIL_DT_DECLARE_ATTR_GET))
		return cfs_fail_err;
                              ...
                              struct lu_attr *la, void *arg)
{
	...
	if (OBD_FAULT_CHECK(OBD_FAIL_DT_ATTR_GET))
		return cfs_fail_err;
                                      ...
                                      struct thandle *th)
{
	...
	if (OBD_FAULT_CHECK(OBD_FAIL_DT_DECLARE_ATTR_SET))
		return cfs_fail_err;
                              ...
                              struct lustre_capa *capa)
{
	...
	if (OBD_FAULT_CHECK(OBD_FAIL_DT_ATTR_SET))
		return cfs_fail_err;
                                     ...
                                     struct dt_object *dt, struct thandle *th)
{
	...
	if (OBD_FAULT_CHECK(OBD_FAIL_DT_DECLARE_REF_ADD))
		return cfs_fail_err;
                             ...
                             struct dt_object *dt, struct thandle *th)
{
	...
	if (OBD_FAULT_CHECK(OBD_FAIL_DT_REF_ADD))
		return cfs_fail_err;
                                     ...
                                     struct dt_object *dt, struct thandle *th)
{
	...
	if (OBD_FAULT_CHECK(OBD_FAIL_DT_DECLARE_REF_DEL))
		return cfs_fail_err;
                             ...
                             struct dt_object *dt, struct thandle *th)
{
	...
	if (OBD_FAULT_CHECK(OBD_FAIL_DT_REF_DEL))
		return cfs_fail_err;
                                    ...
                                    struct thandle *th)
{
	...
	if (OBD_FAULT_CHECK(OBD_FAIL_DT_DECLARE_INSERT))
		return cfs_fail_err;
                                    ...
                                    int noquota)
{
	...
	if (OBD_FAULT_CHECK(OBD_FAIL_DT_INSERT))
		return cfs_fail_err;
                                       ...
                                       struct thandle *th)
{
	...
	if (OBD_FAULT_CHECK(OBD_FAIL_DT_DECLARE_XATTR_DEL))
		return cfs_fail_err;
                               ...
                               struct lustre_capa *capa)
{
	...
	if (OBD_FAULT_CHECK(OBD_FAIL_DT_XATTR_DEL))
		return cfs_fail_err;
                                      ...
                                      struct thandle *th)
{
	...
	if (OBD_FAULT_CHECK(OBD_FAIL_DT_DECLARE_XATTR_SET))
		return cfs_fail_err;
                              ...
                              struct lustre_capa *capa)
{
	...
	if (OBD_FAULT_CHECK(OBD_FAIL_DT_XATTR_SET))
		return cfs_fail_err;
				       ...
				       struct lustre_capa *capa)
{
	...
	if (OBD_FAULT_CHECK(OBD_FAIL_DT_DECLARE_XATTR_GET))
		return cfs_fail_err;
                              ...
                              const char *name, struct lustre_capa *capa)
{
	...
	if (OBD_FAULT_CHECK(OBD_FAIL_DT_XATTR_GET))
		return cfs_fail_err;
                               ...
                               struct lustre_capa *capa)
{
	...
	if (OBD_FAULT_CHECK(OBD_FAIL_DT_XATTR_LIST))
		return cfs_fail_err;
                                    ...
                                    struct thandle *th)
{
	...
	if (OBD_FAULT_CHECK(OBD_FAIL_DT_DECLARE_DELETE))
		return cfs_fail_err;
                            ...
                            struct lustre_capa *capa)
{
	...
	if (OBD_FAULT_CHECK(OBD_FAIL_DT_DELETE))
		return cfs_fail_err;
                            ...
                            struct lustre_capa *capa)
{
	...
	if (OBD_FAULT_CHECK(OBD_FAIL_DT_LOOKUP))
		return cfs_fail_err;
