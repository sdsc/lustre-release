...
struct thandle {
	...
	/* The transaciton which is in the layer where the transaction is
	 * created, i.e. the dt_device where the transaction is created.
	 * So there are three kinds of transactions
	 ...
	 *    OSD.
	 * And there are special use cases here
