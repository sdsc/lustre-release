...
struct dt_index_operations {
	 ...
	 * associated values, get key/value size, etc.
		 ...
		 * Release position
		 *
		 * Complimentary method for ::put() above. Some implementation
		 * can increase a reference on the iterator in ::get(). So the
		 * caller should be able to release with with ::put().
		 *
		 * \param[in] env	execution environment for this thread
		 * \param[in] di	iterator
		 */
