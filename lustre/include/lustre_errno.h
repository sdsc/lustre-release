...
#define LUSTRE_ELOOP		40	/* Too many symbolic links
					   encountered */
#define LUSTRE_EWOULDBLOCK	EAGAIN	/* Operation would block */
...
#define LUSTRE_EDEADLOCK	EDEADLK
...
#define LUSTRE_ERFKILL		132	/* Operation not possible due to
					   RF-kill */
#define LUSTRE_EHWPOISON	133	/* Memory page has hardware error */
