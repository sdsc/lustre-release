...
/* Used to be LDLM_FL_FAIL_LOC       0x100000000ULL moved to non-wire flags */
/* Used to be LDLM_FL_SKIPPED        0x200000000ULL moved to non-wire flags */
...
#define LDLM_FL_FAIL_LOC       (0x1ULL << 32)
/* Used while processing the unused list to know that we have already
 * handled this lock and decided to skip it */
#define LDLM_FL_SKIPPED        (0x1ULL << 33)
/* this lock is being destroyed */
#define LDLM_FL_CBPENDING      (0x1ULL << 34)
/* not a real flag, not saved in lock */
#define LDLM_FL_WAIT_NOREPROC  (0x1ULL << 35)
/* cancellation callback already run */
#define LDLM_FL_CANCEL         (0x1ULL << 36)
#define LDLM_FL_LOCAL_ONLY     (0x1ULL << 37)
/* don't run the cancel callback under ldlm_cli_cancel_unused */
#define LDLM_FL_FAILED         (0x1ULL << 38)
/* lock cancel has already been sent */
#define LDLM_FL_CANCELING      (0x1ULL << 39)
/* local lock (ie, no srv/cli split) */
#define LDLM_FL_LOCAL          (0x1ULL << 40)
...
#define LDLM_FL_LVB_READY      (0x1ULL << 41)
 ...
 * list. */
#define LDLM_FL_KMS_IGNORE     (0x1ULL << 42)
/* completion ast to be executed */
#define LDLM_FL_CP_REQD        (0x1ULL << 43)
/* cleanup_resource has already handled the lock */
#define LDLM_FL_CLEANED        (0x1ULL << 44)
/* optimization hint: LDLM can run blocking callback from current context
 * w/o involving separate thread. in order to decrease cs rate */
#define LDLM_FL_ATOMIC_CB      (0x1ULL << 45)
...
#define LDLM_FL_BL_AST          (0x1ULL << 46)
#define LDLM_FL_BL_DONE         (0x1ULL << 47)
...
#define LDLM_FL_NO_LRU		(0x1ULL << 48)
