...
static inline void *
daos_usr_param_body(struct daos_usr_param *uparam)
{
	return &((struct daos_usr_data *)&uparam->up_data[0])->ud_body[0];
}

long daos_eq_ioctl(unsigned int cmd, struct daos_usr_param *uparam);
