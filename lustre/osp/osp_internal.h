				...
				struct ptlrpc_request *req)
{
	 ...
	 * may get stale/invalid information from remote server because of
	 * unfinished recovery. Under such race case, the RPC will be blocked
	 * until the remote server recovery completed or failed. LU-7117. */
	return 0;
}
