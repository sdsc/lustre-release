				 ...
				 struct thandle *th)
{
	...
	osp_update_rpc_pack(env, ref_del, rc, &update->dur_buf,
				 ...
				 struct thandle *th)
{
	...
	osp_update_rpc_pack(env, ref_add, rc, &update->dur_buf,
		    ...
		    struct lustre_capa *capa)
{
	...
	osp_update_rpc_pack(env, attr_set, rc, &update->dur_buf, OUT_ATTR_SET,
			       ...
			       struct lustre_capa *capa)
{
	...
	osp_update_rpc_pack(env, index_lookup, rc, &update->dur_buf,
			       ...
			       int ignore_quota)
{
	...
	osp_update_rpc_pack(env, index_insert, rc, &update->dur_buf,
			    OUT_INDEX_INSERT, lu_object_fid(&dt->do_lu),
			    rec, key, update->dur_batchid);
	if (rc != 0)
		return rc;
			       ...
			       struct lustre_capa *capa)
{
	...
	osp_update_rpc_pack(env, index_delete, rc, &update->dur_buf,
			    ...
			    int ignore_quota)
{
	...
	osp_update_rpc_pack(env, write, rc, &update->dur_buf,
			   ...
			   struct lustre_capa *capa)
{
	...
	osp_update_rpc_pack(env, read, rc, &update->dur_buf, OUT_READ,
