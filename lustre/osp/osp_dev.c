 ...
 *
 * \retval		0 statfs data was retrieved successfully or
 ...
 *
 * \retval		0 if OSP initialization succeeded.
 ...
 *
 * \retval		NULL if cleanup succeeded.
 * \retval		ERR_PTR(errno) if cleanup failed.
 */
 ...
 *                      this function
 *
 * \retval		0 if the connection succeeded.
 * \retval		negative errno if the connection failed.
 */
 ...
 *
 * \retval		0 if the event handling succeeded.
 * \retval		negative errno if the event handling failed.
 */
 ...
 *                      copy_to_user()).
 *
 * \retval		0 if the ioctl handling succeeded.
 * \retval		negative errno if the ioctl handling failed.
 */
 ...
 *                      function.
 *
 * \retval		0 if getting information succeeded.
 * \retval		negative errno if getting information failed.
 */
 ...
 *    Simlar to other FID clients, OSP requests the sequence
 ...
 *
 * \retval		0 FID allocated successfully.
 * \retval		1 FID allocated successfully and new sequence
 *                      requested from seq meta server
 * \retval		negative errno if FID allocation failed.
 */
