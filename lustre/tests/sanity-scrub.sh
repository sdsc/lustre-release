...
test_5() {
	...
	do_nodes $(comma_list $(mdts_nodes)) \
		$LCTL set_param fail_val=3 && $LCTL set_param fail_loc=0x190
	...
	do_nodes $(comma_list $(mdts_nodes)) \
		$LCTL set_param fail_loc=0 && $LCTL set_param fail_val=0
...
test_8() {
	...
	#define OBD_FAIL_OSD_SCRUB_DELAY	 0x190
	do_nodes $(comma_list $(mdts_nodes)) \
		$LCTL set_param fail_val=1 && $LCTL set_param fail_loc=0x190
