...
test_409()
{
	...
	echo "Create 10K hard links, linkEA overflow, but link should succeed"
	for ((i=0;i<10000;i++)) do
		ln $DIR/$tdir/guard \
		$DIR/$tdir/foo/AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA_$i ||
			error "(3) Fail to hard link $i"
	done
