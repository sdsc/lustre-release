...
test_64d() {
	...
	[ $(lustre_version_code ost1) -lt $(version_code 2.8.55) ] &&
		skip "Need OSS version at least 2.8.55" && return
	...
	do_facet ost1 $LCTL set_param  fail_loc=0x411
