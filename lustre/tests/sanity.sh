...
run_test 246a "mount subdir as fileset"
...
run_test 246b "mount subdir that dose not exist"
...
run_test 246c "running fid2path outside root"
...
run_test 246d "running fid2path inside root"
