...
test_102p() { # LU-4703 setxattr did not check ownership
	...
	[ $(lustre_version_code $SINGLEMDS) -lt $(version_code 2.5.1) -o
	  $(lustre_version_code $SINGLEMDS) -ge $(version_code 2.5.50) -a
	  $(lustre_version_code $SINGLEMDS) -lt $(version_code 2.5.56) ] &&
		skip "MDS needs to be at least 2.5.1 or 2.5.56" && return
