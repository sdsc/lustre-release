...
test_300e() {
	...
	mrename $DIR/$tdir/striped_dir/a $DIR/$tdir/striped_dir/b &&
		"cross_MDT rename under striped dir should fail"

	mrename $DIR/$tdir/striped_dir/a $DIR/$tdir/striped_dir/c ||
		"cross_MDT rename under striped dir should succeed"

	$LFS setdirstripe -i 0 -c 2 -t all_char $DIR/$tdir/striped_dir1 ||
		error "set striped dir error"

	mrename $DIR/$tdir/striped_dir/c $DIR/$tdir/striped_dir1/c ||
		"rename under different striped dir fails"

	mrename $DIR/$tdir/striped_dir/b $DIR/$tdir/striped_dir1/b ||
		"rename under different striped dir fails"
