...
test_219() { #LU-325
	...
	count=$((last_id - next_id))
	echo "preallocated objects in MDS is $count ($last_id - $next_id)"
...
run_test 219 "the preallocated objects in MDS still can be used if ENOSPC is returned by OST with enough disk space"
