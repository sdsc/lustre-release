...
test_2a() {
	...
	rm -r $DIR/$tdir
	$CHECKSTAT -a $DIR/$tdir || error "$DIR/$tdir is not removed"
}
...
test_3a() {
	...
	$CHECKSTAT -t file $DIR/$tdir/$tfile || error "$tdir/$tfile not a file"
	rm -r $DIR/$tdir
	$CHECKSTAT -a $DIR/$tdir || error "$tdir/$tfile is not removed"
}
run_test 3c "rm -r .../d3 ======================================"
...
test_20() {
	...
	rm $DIR/$tfile
	log "3 done"
	$CHECKSTAT -a $DIR/f || error "$tfile was not removed"
}
...
test_24a() {
	...
	test_mkdir $DIR/$tdir
	touch $DIR/$tdir/$tfile
	mv $DIR/$tdir/$tfile $DIR/R1/$tfile.2
	$CHECKSTAT -t file $DIR/R1/g || error "R1/$tfile.2 not a file"
}
...
test_24c() {
	test_mkdir $DIR/$tdir
	test_mkdir $DIR/$tdir/d$testnum
	mv $DIR/$tdir/f $DIR/$tdir/d$testnum.2
	$CHECKSTAT -a $DIR/$tdir/d$testnum || error "d$testnum is not removed"
...
test_24d() {
	...
	mrename $DIR/$tdir/d$testnum $DIR/$tdir/d$testnum.2
	$CHECKSTAT -a $DIR/$tdir/d$testnum || error "d$testnum is not removed"
	$CHECKSTAT -t dir $DIR/$tdir/d$testnum.2 || error "d$testnum.2 not dir"
}
