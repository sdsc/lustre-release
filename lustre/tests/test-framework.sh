...
#
# XXX This function is kept for interoprability with old server (< 2.4),
#     it should be removed whenever we drop the interoprability for such
#     server.
quota_save_version() {
...
mdt_quota_type () {
	...
	do_facet mds1 $LCTL get_param -n \
