...
#define flock_call(fd, num, get, label)                                 \
        ...
        printf("%d: %s lock%d ["LPU64", "LPU64"]\n", pid,                       \
               get == FLOCK_GET ? "taking" : "putting",                 \
               num, flocks[num].l_start,                                \
               flocks[num].l_start + flocks[num].l_len);                \
...
int main(int argc, char* argv[])
{
        ...
        for (i = 0; i < 2; i++) {
                ...
                if (pid == 0 && i == 0) {
                        ...
                        printf("%d: taking lock3 ["LPU64", "LPU64"]\n", pid,
                               flocks[3].l_start,
                               flocks[3].l_start + flocks[3].l_len);
