...
run_test 24 "test fileset in nodemap"
...
run_test 25 "check nodemap proc files for LBUGs and Oopses"
...
run_test 26 "test save and reload nodemap config"
...
run_test 27 "test transferring very large nodemap"
