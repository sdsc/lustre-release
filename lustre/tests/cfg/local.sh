...
# MOUNTOPT should contain "-o opts" where opts is a comma-separated option list
MOUNTOPT=${MOUNTOPT:-"-o user_xattr,flock"}
# MOUNT_EXTRA should contain extra mount options like "-n"
MOUNT_EXTRA=${MOUNT_EXTRA:-""}
DIR=${DIR:-$MOUNT}
DIR1=${DIR:-$MOUNT1}
DIR2=${DIR2:-$MOUNT2}
