...
#
# If any OST is "remote", make sure that either a) LOAD_MODULES_REMOTE
# is true or b) modprobe(8) is configured to blacklist the undesired
# (and aliased the other, if it is ofd.ko).
#
USE_OFD=${USE_OFD:-false}
