...
test_22c () {
	...
	# OBD_FAIL_UPDATE_OBJ_NET_REP    0x1501
	do_facet mds$((MDTIDX + 1)) lctl set_param fail_loc=0x1501
	do_node $CLIENT1 $LFS mkdir -i $MDTIDX $MOUNT1/$remote_dir &
	CLIENT_PID=$!
...
test_23c () {
	...
	# OBD_FAIL_UPDATE_OBJ_NET_REP    0x1501
	do_facet mds${MDTIDX} lctl set_param fail_loc=0x1501
	do_node $CLIENT1 rmdir $MOUNT1/$remote_dir &
	CLIENT_PID=$!
...
test_23d () {
	...
	# OBD_FAIL_UPDATE_OBJ_NET    0x1501
	do_facet mds${MDTIDX} lctl set_param fail_loc=0x1501
	do_node $CLIENT1 rmdir $MOUNT1/$remote_dir &
	CLIENT_PID=$!
	do_facet mds${MDTIDX} lctl set_param fail_loc=0
