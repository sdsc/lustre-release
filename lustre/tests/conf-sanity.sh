...
test_74() {
	setup
	local MAX_D_MB_PATH="/proc/fs/$FSNAME/osc/$FSNAME-OST0000-osc-*/max_dirty_mb"
	...
	local CLIENT_PATH="/proc/fs/$FSNAME/obdfilter/$FSNAME-*/client_cache_count"
...
run_test 74 "set permanent params set_param -P"
