...
test_80() {
	start_mds
	start_ost
	uuid=`do_facet ost "cat /proc/fs/lustre/mgc/*/uuid"`
#define OBD_FAIL_MGS_PAUSE_TARGET_CON       0x906
	do_facet ost "lctl set_param fail_val=10"
	do_facet mgs "lctl set_param fail_val=10"
	do_facet ost "lctl set_param fail_loc=0x906"
