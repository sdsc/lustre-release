...
test_41c() {
	...
	load_modules
	do_facet $SINGLEMDS "lsmod | grep -q lustre" || error "MDS does not have lustre module loaded"
	do_facet $SINGLEMDS "lsmod | grep -q libcfs" || error "MDS does not have libcfs module loaded"
