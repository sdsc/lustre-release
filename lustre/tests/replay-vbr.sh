...
run_test 0a "getversion for non existent file should don't cause kernel panic"
...
run_test 0b "getversion for non existent fid should don't cause kernel panic"
