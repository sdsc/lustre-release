...
{
        # disable IR
        do_facet mgs lctl set_param -n mgs.MGS.ir_ctl="fsname=$FSNAME\;status=Disabled"
        ...
        # restore env
        do_facet mgs lctl set_param -n mgs.MGS.ir_ctl="fsname=$FSNAME\;status=Full"
...
test_101()
{
        ...
        do_facet mgs lctl set_param mgs.MGS.ir_ctl="fsname=$FSNAME\;status=Full"
        fail ost1
        lctl set_param fail_loc=0
