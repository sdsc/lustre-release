...
test_1() {
	...
	drop_request     "mcreate $f1"    ||
		error_noexit "Can't create drop req on file '$f1'"
	drop_reint_reply "mcreate $f2"    ||
		error_noexit "Can't create drop rep on file '$f2'"
	drop_request     "tchmod 111 $f2" ||
		error_noexit "Can't chmod drop req on file $f2"
	drop_reint_reply "tchmod 666 $f2" ||
		error_noexit "Can't chmod drop rep on file $f2"
	drop_request     "statone $f2"    ||
		error_noexit "Can't stat drop req on file $f2"
	drop_reply       "statone $f2"    ||
		error_noexit "Can't stat drop rep on file $f2"
}
