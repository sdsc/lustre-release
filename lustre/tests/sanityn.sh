...
test_51b() {
	[ $MDSCOUNT -lt 5 ] && skip "needs lustre version $(lustre_version_code $SINGLEMDS) >=  2.3.59 ( = version $(version_code 2.3.59))" && return

	[[ $(lustre_version_code $SINGLEMDS) -lt $(version_code 2.3.59) ]] ||
