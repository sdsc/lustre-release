...
run_test 77i "check TBF-OPCode NRS policy"

test_77j() {
	[[ $(lustre_version_code ost1) -ge $(version_code 2.8.54) ]] ||
		{ skip "Need OST version at least 2.8.54"; return 0; }
...
run_test 77j "check the extended TBF policy with NID/JobID/OPCode expression"
