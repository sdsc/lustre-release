...
tf_cleanup () {
	...
	# kill and wait in each test only guarentee script finish,
	# but command in script like 'rm' 'chmod' may still be running,
	# wait for all commands to finish otherwise umount below will fail
