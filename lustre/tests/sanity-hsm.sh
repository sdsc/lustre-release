...
init_agt_vars() {
	...
	export HSMTOOL_VERBOSE=${HSMTOOL_VERBOSE:-"-v -vv -vvv"}
	export HSMTOOL_UPDATE_INTERVAL=${HSMTOOL_UPDATE_INTERVAL:="10"}
...
run_test 80 "Archive/restore a file list - test_90"
...
run_test 81 "Archive/restore a file list with make_large_for_cancel"
