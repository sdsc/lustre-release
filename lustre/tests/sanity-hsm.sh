...
test_12q() {
	...
	zconf_mount $(facet_host $SINGLEAGT) /mnt/lustre3 ||
		error "cannot mount '/mnt/lustre3' on $SINGLEAGT"

	# test needs a running copytool
	copytool_setup $SINGLEAGT /mnt/lustre3
	...
	copytool_cleanup
	zconf_umount $(facet_host $SINGLEAGT) /mnt/lustre3 ||
		error "cannot umount '/mnt/lustre3' on $SINGLEAGT"
}
