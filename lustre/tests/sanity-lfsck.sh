...
test_29c()
{
	...
	# Remove 250 hard links, then the linkEA should have space
	# to hold the missed linkEA entries.
	echo "Remove 250 hard links to save space for the missed linkEA entries"
	unlinkmany $DIR/$tdir/foo/t 250 || error "(4) Fail to unlink"
