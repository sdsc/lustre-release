...
wait_all_lfsck_targets()
{
	...
	for k in $(seq $MDSCOUNT); do
		wait_update_facet mds${k} "$LCTL get_param -n \
			mdd.$(facet_svc mds${k}).lfsck_${com} |
			awk '/^status/ { print \\\$2 }'" "$status" $LTIME || {
			do_facet mds${k} \ "$LCTL get_param -n \
				mdd.$(facet_svc mds${k}).lfsck_${com}"
			error "($no) MDS${k} is not the expected '$status'"
		}
	done
}
...
test_2e()
{
	...
	wait_all_lfsck_targets namespace completed 4
...
test_12() {
	...
	wait_all_lfsck_targets namespace scanning-phase1 3
	...
	wait_all_lfsck_targets namespace stopped 5
	...
	wait_all_lfsck_targets namespace completed 7
	...
	echo "All the LFSCK targets should be in 'scanning-phase1' status."
	wait_all_lfsck_targets layout scanning-phase1 9
	...
	echo "All the LFSCK targets should be in 'stopped' status."
	wait_all_lfsck_targets layout stopped 11
	...
	echo "All the LFSCK targets should be in 'completed' status."
	wait_all_lfsck_targets layout completed 14
...
test_15c() {
	...
	wait_all_lfsck_targets layout completed 2
...
test_22a() {
	...
	wait_all_lfsck_targets namespace completed 6
...
test_23a() {
	...
	wait_all_lfsck_targets namespace completed 10
...
test_24() {
	...
	wait_all_lfsck_targets namespace completed 8
...
test_28() {
	...
	wait_all_lfsck_targets namespace completed 9
...
test_30() {
	...
	wait_all_lfsck_targets namespace completed 15
...
test_31c() {
	...
	wait_all_lfsck_targets namespace completed 3
