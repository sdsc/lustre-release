...
test_0() {
	...
	do_facet $SINGLEMDS \
		"$LCTL set_param fail_val=3 && $LCTL set_param fail_loc=0x1600"
...
test_4()
{
	...
	do_facet $SINGLEMDS \
		"$LCTL set_param fail_val=1 && $LCTL set_param fail_loc=0x1601"
...
test_6a() {
	...
	#define OBD_FAIL_LFSCK_DELAY1		0x1600
	do_facet $SINGLEMDS \
		"$LCTL set_param fail_val=1 && $LCTL set_param fail_loc=0x1600"
	$START_NAMESPACE -r || error "(2) Fail to start LFSCK for namespace!"
...
test_7b()
{
	...
	do_facet $SINGLEMDS \
		"$LCTL set_param fail_val=1 && $LCTL set_param fail_loc=0x1602"
	$START_NAMESPACE -r || error "(3) Fail to start LFSCK for namespace!"
	wait_update_facet $SINGLEMDS "$LCTL get_param -n \
		mdd.${MDT_DEV}.lfsck_namespace |
...
test_8()
{
	...
	#define OBD_FAIL_LFSCK_DELAY2		0x1601
	do_facet $SINGLEMDS \
		"$LCTL set_param fail_val=2 && $LCTL set_param fail_loc=0x1601"
	...
	#define OBD_FAIL_LFSCK_DELAY3		0x1602
	do_facet $SINGLEMDS \
		"$LCTL set_param fail_val=2 && $LCTL set_param fail_loc=0x1602"
...
test_11a() {
	...
	do_facet ost1 \
		"$LCTL set_param fail_val=3 && $LCTL set_param fail_loc=0x160e"
	...
	do_facet ost1 \
		"$LCTL set_param fail_val=0 && $LCTL set_param fail_loc=0"
...
test_17() {
	...
	do_facet $SINGLEMDS \
		"$LCTL set_param fail_val=0 && $LCTL set_param fail_loc=0x1614"
...
test_18d() {
	...
	#define OBD_FAIL_LFSCK_DELAY3		0x1602
	do_facet $SINGLEMDS \
		"$LCTL set_param fail_val=5 && $LCTL set_param fail_loc=0x1602"

	echo "Trigger layout LFSCK on all devices to find out orphan OST-object"
	$START_LAYOUT -r -o -c on || error "(2) Fail to start LFSCK for layout!"
...
test_18e() {
	...
	#define OBD_FAIL_LFSCK_DELAY3		0x1602
	do_facet $SINGLEMDS \
		"$LCTL set_param fail_val=10 && $LCTL set_param fail_loc=0x1602"
