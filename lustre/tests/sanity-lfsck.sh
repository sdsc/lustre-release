...
[[ $(lustre_version_code $SINGLEMDS) -lt $(version_code 2.6.50) ]] &&
	ALWAYS_EXCEPT="$ALWAYS_EXCEPT 2d 3 22 23 24 25 26"
...
run_test 26a "LFSCK can add recreate the lost local parent directory as orphan"
...
run_test 26b "LFSCK can add recreate the lost remote parent directory as orphan"
