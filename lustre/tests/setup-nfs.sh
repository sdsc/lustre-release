...
setup_nfs() {
    ...
    do_nodes $LUSTRE_CLIENT "service nfs restart"

    do_nodes $NFS_CLIENTS "service rpcidmapd restart"
...
cleanup_nfs() {
    ...
    do_nodes $NFS_CLIENTS "service rpcidmapd stop"

    do_nodes $LUSTRE_CLIENT "service nfs stop"
