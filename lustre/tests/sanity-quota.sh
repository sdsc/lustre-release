...
setup_quota_test() {
	...
	# This can be remove when LU-2312 lands
...
test_7e() {
	...
	[ $USED -ne 0 ] &&
		error "limit($USED) on $MDTUUID for user $TSTUSR isn't 0."
...
# test migrating old admin quota files (in Linux quota file format v2) into new
