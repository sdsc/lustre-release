                       ...
                       void *capa)
{
        ...
        cfs_list_for_each (pos, &set->set_list) {
                ...
                err = obd_destroy(NULL, lov->lov_tgts[req->rq_idx]->ltd_exp,
                       ...
                       struct obd_info *oinfo)
{
        ...
        cfs_list_for_each (pos, &set->set_list) {
                ...
                rc = obd_getattr(NULL, lov->lov_tgts[req->rq_idx]->ltd_exp,
                                 &req->rq_oi);
                       ...
                       struct obd_info *oinfo, struct obd_trans_info *oti)
{
        ...
        cfs_list_for_each (pos, &set->set_list) {
                ...
                rc = obd_setattr(NULL, lov->lov_tgts[req->rq_idx]->ltd_exp,
                                 &req->rq_oi, NULL);
                     ...
                     struct ptlrpc_request_set *rqset)
{
        ...
        cfs_list_for_each (pos, &set->set_list) {
                ...
                rc = obd_punch(NULL, lov->lov_tgts[req->rq_idx]->ltd_exp,
                    ...
                    struct ptlrpc_request_set *rqset)
{
        ...
        cfs_list_for_each (pos, &set->set_list) {
                ...
                rc = obd_sync(NULL, lov->lov_tgts[req->rq_idx]->ltd_exp,
...
static int lov_iocontrol(const struct lu_env *env, unsigned int cmd,
                         ...
                         void *uarg)
{
        ...
        default: {
                ...
                for (i = 0; i < count; i++) {
                        ...
                        err = obd_iocontrol(NULL, cmd, lov->lov_tgts[i]->ltd_exp,
                                            len, karg, uarg);
             ...
             i++, cur_stripe = (cur_stripe + 1) % lsm->lsm_stripe_count) {
                ...
                do {
                        ...
                        *vallen=fiemap_count_to_size(fm_local->fm_extent_count);
                        rc = obd_get_info(NULL, lov->lov_tgts[ost_index]->ltd_exp,
                        ...
                        struct lov_stripe_md *lsm)
{
        ...
        if (KEY_IS(KEY_LOCK_TO_STRIPE)) {
                ...
                *vallen = sizeof(*stripe);
                ...
                rc = obd_get_info(NULL, tgt->ltd_exp, keylen, key,
                                  &size, info->data, NULL);
                GOTO(out, rc = 0);
                              ...
                              void *val, struct ptlrpc_request_set *set)
{
        ...
        for (i = 0; i < count; i++, val = (char *)val + incr) {
                ...
                if (mds_con) {
                        ...
                        err = obd_set_info_async(NULL, tgt->ltd_exp, keylen,
