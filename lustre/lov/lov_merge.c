                      ...
                      struct ost_lvb *lvb, __u64 *kms_place)
{
        ...
        for (i = 0; i < lsm->lsm_stripe_count; i++) {
                ...
                CDEBUG(D_ERROR, "ino %lu on OST[%d]: "LPU64" "LPU64" "LPU64" "LPU64" "LPU64"\n",
                       lsm->ino, loi->loi_ost_idx, lvb->lvb_size, lvb->lvb_mtime,
                  ...
                  struct lov_stripe_md *lsm, struct ost_lvb *lvb, int kms_only)
{
        ...
        if (kms_only)
                lvb->lvb_size = kms;
        CDEBUG(D_ERROR, "merged for ino %lu: "LPU64" "LPU64" "LPU64" "LPU64" "LPU64"\n",
               lsm->ino, lvb->lvb_size, lvb->lvb_mtime, lvb->lvb_atime,
