                               ...
                               int stripe, loff_t start, loff_t end)
{
	...
	case CIT_LADVISE: {
		io->u.ci_ladvise.li_extent.le_start = start;
		io->u.ci_ladvise.li_extent.le_end = end;
			     ...
			     struct lov_object *obj, struct cl_io *io)
{
	...
	case CIT_LADVISE: {
		lio->lis_pos = io->u.ci_ladvise.li_extent.le_start;
		lio->lis_endpos = io->u.ci_ladvise.li_extent.le_end;
		break;
	}
