...
void proto_register_dcerpc_lustre(void)
{
  static hf_register_info hf[] = {
    ...
    { &hf_lustre_ldlm_lock_desc_l_granted_mode,
      { "L Granted Mode", "lustre.ldlm_lock_desc.l_granted_mode", FT_UINT16, BASE_OCT, VALS(lustre_ldlm_mode_t_vals), 0, "", HFILL }},
    ...
    { &hf_lustre_ldlm_lock_desc_l_req_mode,
      { "L Req Mode", "lustre.ldlm_lock_desc.l_req_mode", FT_UINT16, BASE_OCT, VALS(lustre_ldlm_mode_t_vals), 0, "", HFILL }},
    ...
    { &hf_lustre_seq_range_start,
      { "Seq Range Start", "lustre.seq_range.start", FT_UINT64, BASE_DEC, NULL, 0, "", HFILL } },
    { &hf_lustre_seq_range_end,
      { "Seq Range End", "lustre.seq_range.end", FT_UINT64, BASE_DEC, NULL, 0, "", HFILL } },
