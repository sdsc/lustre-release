...
static int mdc_read_page(void *data, struct page *page0)
{
	...
	if (rp->rp_oinfo != NULL) {
		inode = (struct inode *)rp->rp_oinfo->lmo_root;
		fid = &rp->rp_oinfo->lmo_fid;
	} else {
                        ...
                        struct page **ppage)
{
	...
	*ppage = NULL;
	...
	if (op_data->op_mea1 != NULL) {
		lmo = (struct lmv_oinfo *)op_data->op_mea1;
		dir = (struct inode *)lmo->lmo_root;
	} else {
