...
void mdc_pack_body(struct ptlrpc_request *req, const struct lu_fid *fid,
		   struct obd_capa *oc, __u64 valid, __u32 ea_size,
...
void mdc_getattr_pack(struct ptlrpc_request *req, __u64 valid, __u32 flags,
		      struct md_op_data *data, __u32 ea_size);
void mdc_setattr_pack(struct ptlrpc_request *req, struct md_op_data *op_data,
                     void *ea, __u32 ealen, void *ea2, __u32 ea2len);
void mdc_create_pack(struct ptlrpc_request *req, struct md_op_data *op_data,
		     const void *data, __u32 datalen, __u32 mode, __u32 uid,
...
void mdc_rename_pack(struct ptlrpc_request *req, struct md_op_data *op_data,
		     const char *old, __u32 oldlen, const char *new,
		     __u32 newlen);
