...
static int mdc_max_rpcs_in_flight_seq_show(struct seq_file *m, void *data)
{
...
static ssize_t
mdc_max_rpcs_in_flight_seq_write(struct file *file, const char *buffer,
...
LPROC_SEQ_FOPS_RO_TYPE(mdc, obd_max_pages_per_rpc);
