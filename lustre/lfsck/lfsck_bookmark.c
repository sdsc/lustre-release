...
static void inline lfsck_bookmark_to_cpu(struct lfsck_bookmark *des,
...
static void inline lfsck_bookmark_to_le(struct lfsck_bookmark *des,
					struct lfsck_bookmark *src)
{
			       ...
			       struct lfsck_instance *lfsck)
{
	...
	if (rc == 0) {
		...
		lfsck_bookmark_to_cpu(bm, &lfsck->li_bookmark_disk);
...
int lfsck_bookmark_store(const struct lu_env *env, struct lfsck_instance *lfsck)
{
	...
	lfsck_bookmark_to_le(&lfsck->li_bookmark_disk,
