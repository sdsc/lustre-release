...
again:
	...
	/* It is useless if repair dangling reference after orphan OST-objects
	 * handled, keep the logic there for being compatible with old LFSCK. */
...
/**
 * Repair the MDT-object with dangling reference.
 *
