...
static void inline lfsck_namespace_to_cpu(struct lfsck_namespace *des,
					  struct lfsck_namespace *src)
{
	...
	lfsck_position_to_cpu(&des->ln_pos_latest_start,
				  &src->ln_pos_latest_start);
	lfsck_position_to_cpu(&des->ln_pos_last_checkpoint,
				  &src->ln_pos_last_checkpoint);
	lfsck_position_to_cpu(&des->ln_pos_first_inconsistent,
...
static void inline lfsck_namespace_to_le(struct lfsck_namespace *des,
					 struct lfsck_namespace *src)
{
	...
	lfsck_position_to_le(&des->ln_pos_latest_start,
				 &src->ln_pos_latest_start);
	lfsck_position_to_le(&des->ln_pos_last_checkpoint,
				 &src->ln_pos_last_checkpoint);
	lfsck_position_to_le(&des->ln_pos_first_inconsistent,
				 &src->ln_pos_first_inconsistent);
				 ...
				 struct lfsck_component *com, bool init)
{
	...
	lfsck_namespace_to_le((struct lfsck_namespace *)com->lc_file_disk,
