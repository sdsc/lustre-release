...
again:
	...
	/* This export flag means the server did an extra swab of IR MNE
	 * records (fixed in LU-1252), reverse it here if needed. LU-1634 */
	if (unlikely(req->rq_export->exp_need_mne_swab))
		mne_swab = !mne_swab;
#else
#warning "LU-1634: Remove obsolete OBD_CONNECT_MNE_SWAB fixup"
#endif
