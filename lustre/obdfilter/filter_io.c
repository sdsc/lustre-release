                               ...
                               struct lustre_capa *capa)
{
	 ...
	 * filter truncates are serialized by inode_dio_read, allowing
	 * multiple writes or single truncate. */

	inode_dio_read(dentry->d_inode);
	fsfilt_check_slow(obd, now, "inode_dio_read");
