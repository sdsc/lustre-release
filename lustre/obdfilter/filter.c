                                 ...
                                 obd_seq group, obd_id id)
{
        ...
        if (unlikely(LTIME_S(dentry->d_inode->i_atime) == LU221_BAD_TIME))
                LTIME_S(dentry->d_inode->i_atime) = 0;
        if (unlikely(LTIME_S(dentry->d_inode->i_mtime) == LU221_BAD_TIME))
                LTIME_S(dentry->d_inode->i_mtime) = 0;
        if (unlikely(LTIME_S(dentry->d_inode->i_ctime) == LU221_BAD_TIME))
                LTIME_S(dentry->d_inode->i_ctime) = 0;
