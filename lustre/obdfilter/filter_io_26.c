                          ...
                          int rc)
{
        ...
        int retries = 0;
        bool cap_resource = cfs_cap_raised(CFS_CAP_SYS_RESOURCE) ? true : false;
        ENTRY;
...
cleanup:
        if (cap_resource && !cfs_cap_raised(CFS_CAP_SYS_RESOURCE))
                cfs_cap_raise(CFS_CAP_SYS_RESOURCE);
        else if (!cap_resource && cfs_cap_raised(CFS_CAP_SYS_RESOURCE))
