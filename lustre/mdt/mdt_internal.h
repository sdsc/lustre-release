...
struct coordinator {
	...
	struct mutex		 cdt_restore_lock;    /**< protect restore
						       * list */
	unsigned long		 cdt_loop_period;     /**< llog scan period */
	unsigned long		 cdt_grace_delay;     /**< request grace
						       * delay */
	unsigned long		 cdt_active_req_timeout; /**< request timeout */
...
struct cdt_agent_req {
	...
	unsigned long		 car_req_start;    /**< start time */
	unsigned long		 car_req_update;   /**< last update time */
