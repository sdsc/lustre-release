...
static int __out_tx_create(struct mdt_thread_info *, struct dt_object *,
...
static int __out_tx_attr_set(struct mdt_thread_info *, struct dt_object *,
...
static int __out_tx_xattr_set(struct mdt_thread_info *, struct dt_object *,
...
static int __out_tx_ref_add(struct mdt_thread_info *, struct dt_object *,
			    struct thandle_exec_args *, struct update_reply *,
			    int, char *, int);
#define out_tx_ref_add(info, obj, th, reply, idx) \
	__out_tx_ref_add(info, obj, th, reply, idx, __FILE__, __LINE__)

static int __out_tx_ref_del(struct mdt_thread_info *, struct dt_object *,
			    struct thandle_exec_args *, struct update_reply *,
			    int, char *, int);
#define out_tx_ref_del(info, obj, th, reply, idx) \
	__out_tx_ref_del(info, obj, th, reply, idx, __FILE__, __LINE__)

static int __out_tx_index_insert(struct mdt_thread_info *, struct dt_object *,
				 char *, struct lu_fid *,
...
static int __out_tx_index_delete(struct mdt_thread_info *, struct dt_object *,
