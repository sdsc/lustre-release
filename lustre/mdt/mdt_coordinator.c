...
GENERATE_PROC_METHOD(cdt_dflt_archive_id)
...
static struct lprocfs_vars lprocfs_mdt_hsm_vars[] = {
	...
	{ "default_archive_id",	lprocfs_rd_hsm_cdt_dflt_archive_id,
				lprocfs_wr_hsm_cdt_dflt_archive_id,
				NULL, NULL, 0 },
