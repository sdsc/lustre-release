...
static int mdt_handler2pos(struct mdt_handler *h);
                ...
                if (likely(rc == +1)) {
                        ...
                        if (likely(h != NULL)) {
                                ...
                                if (likely(exp != NULL) &&
                                    ...
                                    supported == mdt_regular_handlers)
                                {
                                        pos = mdt_handler2pos(h);
                                        if (pos >= 0)
...
#define SLICE_INSIDE(s, opc) \
        (s->mos_opc_start <= opc && opc < s->mos_opc_end)
