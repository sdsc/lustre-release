 ...
 * \param[in] fp    User-provided struct to store path information
 *
 ...
 * \retval < 0 negative errno if there was a problem
 */
 ...
 * \param[in] info  Per-thread common data shared by mdt level handlers.
 * \param[in] obj   Object to do path lookup of
 * \param[in] fp    User-provided struct for arguments and
