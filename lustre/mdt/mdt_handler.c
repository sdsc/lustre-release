                        ...
                        struct lu_rdpg *rdpg, int nob)
{
        ...
        for (i = 0, tmpcount = nob;
                ...
                tmpsize = min_t(int, tmpcount, LU_PAGE_SIZE);
...
static int mdt_readpage(struct mdt_thread_info *info)
{
        ...
        rdpg->rp_count  = min_t(unsigned int,
                                reqbody->nlink,
                                PTLRPC_MAX_BRW_PAGES * LU_PAGE_SIZE);
        rdpg->rp_npages = min_t(unsigned int,
                                (rdpg->rp_count + LU_PAGE_SIZE - 1) >>
                                        LU_PAGE_SHIFT,
