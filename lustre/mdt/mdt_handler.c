...
LU_TYPE_INIT_FINI(mds, &mdt_thread_key, &mdt_txn_key);
...
static int mds_start_ptlrpc_service(struct mds_device *m)
{
        ...
        procfs_entry = m->mds_md_dev.md_lu_dev.ld_obd->obd_proc_entry;
        ...
        m->mds_readpage_service =
                ptlrpc_init_svc_conf(&conf, mdt_readpage_handle,
                                     ...
                                     procfs_entry, target_print_req,"mds_rdpg");
        ...
        m->mds_setattr_service =
                ptlrpc_init_svc_conf(&conf, mdt_regular_handle,
                                     ...
                                     procfs_entry, target_print_req,"mds_attr");
        ...
        m->mds_mdsc_service =
                ptlrpc_init_svc_conf(&conf, mdt_mdsc_handle,
                                     ...
                                     procfs_entry, target_print_req,"mds_mdsc");
        ...
        m->mds_mdss_service =
                ptlrpc_init_svc_conf(&conf, mdt_mdss_handle,
                                     ...
                                     procfs_entry, target_print_req,"mds_mdss");
        ...
        m->mds_dtss_service =
                ptlrpc_init_svc_conf(&conf, mdt_dtss_handle,
                                     ...
                                     procfs_entry, target_print_req,"mds_dtss");
        ...
        m->mds_fld_service =
                ptlrpc_init_svc_conf(&conf, mdt_fld_handle,
                                     ...
                                     procfs_entry, target_print_req, "mds_fld");
