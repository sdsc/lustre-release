...
static int mdt_device_sync(const struct lu_env *env, struct mdt_device *mdt)
{
	...
	/* XXX: shouldn't it do sync via LOD instead of just bottom device? */
 ...
 * forr now. This will be removed along with converting rest of MDT code
...
TGT_MDT_HDL(HABEO_CORPUS| HABEO_REFERO, MDS_HSM_PROGRESS,
							mdt_hsm_progress),
TGT_MDT_HDL(HABEO_CORPUS| HABEO_REFERO, MDS_HSM_CT_REGISTER,
							mdt_hsm_ct_register),
TGT_MDT_HDL(HABEO_CORPUS| HABEO_REFERO, MDS_HSM_CT_UNREGISTER,
							mdt_hsm_ct_unregister),
TGT_MDT_HDL(HABEO_CORPUS| HABEO_REFERO, MDS_HSM_STATE_GET,
							mdt_hsm_state_get),
TGT_MDT_HDL(HABEO_CORPUS| HABEO_REFERO, MDS_HSM_STATE_SET,
							mdt_hsm_state_set),
TGT_MDT_HDL(HABEO_CORPUS| HABEO_REFERO, MDS_HSM_ACTION,	mdt_hsm_action),
TGT_MDT_HDL(HABEO_CORPUS| HABEO_REFERO, MDS_HSM_REQUEST,
							mdt_hsm_request),
TGT_MDT_HDL(HABEO_CORPUS|HABEO_REFERO,	MDS_SWAP_LAYOUTS,
							mdt_swap_layouts)
};
