...
static char *mds_rdpg_cpts;
CFS_MODULE_PARM(mds_rdpg_cpts, "c", charp, 0444,
...
static char *mds_attr_cpts;
CFS_MODULE_PARM(mds_attr_cpts, "c", charp, 0444,
