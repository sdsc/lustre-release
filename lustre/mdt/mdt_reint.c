...
static int mdt_md_create(struct mdt_thread_info *info)
{
	...
	/*
	 * if this is mkdir, fake this to be a distributed transaction to make
	 * sure any previous modification on parent is committed to disk,
	 * because this may create a striped directory, which can be recovered
	 * from update log.
	 */
