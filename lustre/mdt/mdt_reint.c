...
/**
 * mdt_remote_operation_check_permission: Check whether the remote operation is
 * permitted,
 * @parent:	the directory of this operation.
 * @child:	the child of this operation.
 *
				      ...
				      struct mdt_lock_handle *lhc)
{
	...
	rc = mdt_remote_operation_check_permission(info, msrcdir, mold);
	if (rc != 0)
		GOTO(out_put_child, rc);
