...
/**
 * Drop FMD reference and free it if reference is dropped to zero.
 *
...
/**
 * Wrapper to drop FMD reference with locking.
 *
 * \param[in] exp	OBD export
 * \param[in] fmd	FMD to put
 */
 ...
 * parameter is used by ofd_fmd_find_nolock() to prohibit expire
 * a just found FMD.
 *
 * \param[in] exp	OBD export
