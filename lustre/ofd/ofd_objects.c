 ...
 * contains the MDT parent object FID and save it in ofd_object::ofo_pfid
 *
 * \param[in] env	execution environment
 * \param[in] fo	OFD object
 *
 ...
 * The precreation starts from \a id and create \a nr objects sequentionally.
 * If is allowed to create not whole requested amount of objects but less.
 *
 * \param[in] env	execution environment
 * \param[in] ofd	OFD device
