 ...
 *
 * This file contains OFD LDLM-related code which is just intent handling
 * for glimpse lock.
 *
 ...
 *
 * The interval_callback_t in part of interval_iterate_reverse() and is called
 ...
 * \param[in] arg	intent arguments
 *
 * \retval		INTERVAL_ITER_STOP if the interval is lower than file size
 *			INTERVAL_ITER_COUNT
 */
