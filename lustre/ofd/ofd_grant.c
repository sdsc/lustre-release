...
#define OFD_GRANT_CHUNK(rexp) (2ULL * exp_max_brw_size((rexp)))
#define OFD_GRANT_SHRINK_LIMIT(rexp) (16ULL * OFD_GRANT_CHUNK((rexp)))
		       ...
		       obd_size want)
{
	...
	if ((exp->exp_connect_data.ocd_connect_flags & OBD_CONNECT_RDONLY) ||
