 ...
 *
 * This file provides functions for OFD transaction management.
 *
 ...
 *
 * This function adds extra functionality to dt_trans_create(), it cause
 * synchronous update if export state requires so.
 *
 ...
 * and calls dt_trans_stop(). The th_result will be written into the
 * last_rcvd file.
 *
 * \param[in] env	execution environment
 * \param[in] ofd	OFD device
