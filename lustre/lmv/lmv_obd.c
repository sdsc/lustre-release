 ...
 *
 * A lu_dirpage is laid out as follows, where e = ldp_hash_end,
 * f = ldp_flags, and each "ent" is a struct lu_dirent. It has size up
 * to LU_PAGE_SIZE. The ldp_hash_end value is used to request the next
 * lu_dirpage in a directory listing that spans multiple pages (two in
 * this example):
 *
 * .-----------------   -----.
 * |s|e|f|p|ent|ent| ... |ent|
 ...
 * larger than LU_PAGE_SIZE, a single host page is filled with multiple
 * lu_dirpages. After reading the lu_dirpages from the MDS, the
 * ldp_hash_end of the first lu_dirpage refers to the one immediately
 * after it in the same CFS_PAGE:
 *
 * .-------------------   -----.
 * |s|e0|f0|p|ent|ent| ... |ent|
 * |--v----------------   -----|
 * |s|e1|f1|p|ent|ent| ... |ent|
 ...
 *
 * - Copy the LDF_COLLIDE flag from f' to f0 to accurately reflect whether
