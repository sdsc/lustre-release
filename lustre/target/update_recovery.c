 ...
 *
 * For each operation (struct each update_recovery_header), if updates on one MDT
 * have been committed to disk, the update_recovery will be added to the
 ...
 * this function.
 *
 * \param[in] urd	update_recovery_data, which holds the update replay list.
