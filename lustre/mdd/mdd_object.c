...
static int mdd_xattr_invalidate(const struct lu_env *env, struct md_object *obj)
{
	return mdo_xattr_invalidate(env, md2mdd_obj(obj));
}
...
const struct md_object_operations mdd_obj_ops = {
	...
	.moo_xattr_invalidate	= mdd_xattr_invalidate,
