...
#define LFSCK_NAMESPACE_MAGIC	0xA0629D0319B0286CULL
...
struct lfsck_namespace {
	...
	/* How many name entries have been added back to namespace. */
	__u64	ln_ents_added;
