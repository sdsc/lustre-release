...
static int mdd_changelog_estimate_size(const struct lu_env *env,
				       ...
				       const struct lu_name *sname)
{
	...
	return llog_data_len(changelog_rec_offset(crf) +
				...
				struct thandle *handle)
{
	...
	reclen = mdd_changelog_estimate_size(env, tname, sname);
