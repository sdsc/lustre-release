 ...
 * checks if the link count reach the maxim limit. Note: for ldiskfs, the
 * directory nlink count might exceed the maxim link count(see
 ...
 *
 * retva:		= 0 create the child under this dir is allowed.
 *                      < 0 create the child under this dir is not allowed.
 */
...
/**
 * This function checks whether it can create the link file(linked to
 * @src_obj) under the target directory(@tgt_obj), and src_obj has been
 * locked by mdd_write_lock.
 *
 * param[in] env:	execution environment.
 ...
 *                      < 0 it is not allowed to create the link file.
 */
 ...
 *                      the directory.
 *                      < 0 it is not allowed to create file/dir
 *                      under the directory.
 */
