...
static struct lu_local_obj_desc llod_lfsck_it_key = {
	.llod_name      = lfsck_it_name,
	.llod_oid       = LFSCK_IT_OID,
	.llod_is_index  = 0,
};
...
static int __init mdd_mod_init(void)
{
	...
	llo_local_obj_register(&llod_lfsck_it_key);
...
static void __exit mdd_mod_exit(void)
{
	...
	llo_local_obj_unregister(&llod_lfsck_it_key);
