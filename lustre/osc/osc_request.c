                                ...
                                int resend)
{
        ...
        for (requested_nob = i = 0; i < page_count; i++, niobuf++) {
                ...
                int poff = OSC_FILE2MEM_OFF(pg->off, pshift) & ~CFS_PAGE_MASK;
                ...
                LASSERTF(page_count == 1 ||
                         ...
                         "i: %d/%d pg: %p off: "LPU64", count: %u, shift: %d\n",
                         i, page_count, pg, pg->off, pg->count, pshift);
#ifdef __linux__
...
restart_bulk:
        rc = osc_brw_prep_request(cmd, &exp->exp_obd->u.cli, oa, pshift,
                         ...
                         struct osc_brw_async_args *aa)
{
        ...
        rc = osc_brw_prep_request(lustre_msg_get_opc(request->rq_reqmsg) ==
                                  ...
                                  aa->aa_cli, aa->aa_oa, aa->aa_pshift,
                                  aa->aa_page_count, aa->aa_ppga,
                   ...
                   struct obd_trans_info *oti)
{
        ...
        while (page_count) {
                ...
                rc = osc_brw_internal(cmd, exp, oinfo->oi_oa, pshift,
                                            ...
                                            int page_count, int cmd)
{
        ...
        rc = osc_brw_prep_request(cmd, cli, oa, 0, page_count,
