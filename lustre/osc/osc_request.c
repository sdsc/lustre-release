                       ...
                       void *capa)
{
	...
	/* If osc_destory is for destroying the unlink orphan, sent
 	 * from MDT to OST, it should not be blocked here, because
 	 * the process might be triggered by ptlrpcd (Bug 16006).
 	 * It is not good to block ptlrpcd */
