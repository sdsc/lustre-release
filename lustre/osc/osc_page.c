                          ...
                          void *cookie, lu_printer_t printer)
{
	...
	return (*printer)(env, cookie, LUSTRE_OSC_NAME"-page@%p %lu: "
			  ...
			  class ? osc_list(&class->oc_obj_ready_list) : " ",
			  class ? osc_list(&class->oc_obj_hp_ready_list) : " ",
			  class ? osc_list(&class->oc_obj_write_list) : " ",
			  class ? osc_list(&class->oc_obj_read_list) : " ",
			  /* 5 */
