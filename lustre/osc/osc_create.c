                                ...
                                struct ptlrpc_request *req, void *data, int rc)
{
        ...
        case 0: {
                if (body) {
                         ...
                         * grow_count in rq_async_args.space[1].
                        ...
                        if (diff < (int)req->rq_async_args.space[1]) {
...
static int oscc_internal_create(struct osc_creator *oscc)
{
        ...
        /* NB: rq_async_args is union so please make sure it wouldn't be
         * overwritten while using ptlrpc_async_args::pointer_arg */
        request->rq_async_args.space[1] = oscc->oscc_grow_count;
        cfs_spin_unlock(&oscc->oscc_lock);
