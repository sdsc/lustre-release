...
command_t cmdlist[] = {
	...
	{"replace_nids", jt_replace_nids, 0,
	 ...
	 "  -p  If there are multiple matches, spawn threads and set the\n"
	 "      parameters in parallel.  If this option is not given, the\n"
	 "      parameters will not be set in parallel.\n"
#endif
	},
