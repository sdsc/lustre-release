...
struct option long_opts[] = {
	{ .name = "statuslog",	     .has_arg = required_argument, .val = 'l' },
	{ .name = "mdt",	     .has_arg = required_argument, .val = 'm' },
	{ .name = "source",	     .has_arg = required_argument, .val = 's' },
	{ .name = "target",	     .has_arg = required_argument, .val = 't' },
	{ .name = "user",	     .has_arg = required_argument, .val = 'u' },
	{ .name = "verbose",	     .has_arg = no_argument,	   .val = 'v' },
	{ .name = "xattr",	     .has_arg = required_argument, .val = 'x' },
	{ .name = "dry-run",	     .has_arg = no_argument,	   .val = 'z' },
	/* Undocumented options follow */
	{ .name = "abort-on-err",    .has_arg = no_argument,	   .val = 'a' },
	{ .name = "cl-clear",	     .has_arg = required_argument, .val = 'c' },
	{ .name = "debug",	     .has_arg = required_argument, .val = 'd' },
	{ .name = "debuglog",	     .has_arg = required_argument, .val = 'D' },
	{ .name = "start-recno",     .has_arg = required_argument, .val = 'n' },
	{ .name = "use-rsync",	     .has_arg = no_argument,	   .val = 'r' },
	{ .name = "rsync-threshold", .has_arg = required_argument, .val = 'y' },
	{ .name = NULL }
};
