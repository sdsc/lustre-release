...
void lustre_assert_wire_constants(void)
{
         ...
         * running on Linux widow-mgmt2.ccs.ornl.gov 2.6.32-220.7.1.el6.x86_64 #1 SMP Fri Feb 10 15:2
        ...
        LASSERTF(OBD_CONNECT_PACKAGED_XATTR == 0x200000000000ULL, "found 0x%.16llxULL\n",
        ...
        LASSERTF((int)offsetof(struct mdt_body, mb_pxattr) == 152, "found %lld\n",
                 (long long)(int)offsetof(struct mdt_body, mb_pxattr));
        LASSERTF((int)sizeof(((struct mdt_body *)0)->mb_pxattr) == 4, "found %lld\n",
                 (long long)(int)sizeof(((struct mdt_body *)0)->mb_pxattr));
