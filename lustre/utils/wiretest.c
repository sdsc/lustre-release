...
void lustre_assert_wire_constants(void)
{
	 ...
	 * running on Linux ieel-build6.ieel.utopiabound.net 2.6.32-642.1.1.el6_lustre.x86_64 #1 SMP
...
void lustre_assert_ioctl_constants(void)
{
	...
	/* FSFILT IOCTL */
	LASSERTF(FSFILT_IOC_GETFLAGS == 2148034049, "found %lld\n",
		 (long long)FSFILT_IOC_GETFLAGS);
	LASSERTF(FSFILT_IOC_SETFLAGS == 1074292226, "found %lld\n",
		 (long long)FSFILT_IOC_SETFLAGS);
	LASSERTF(FSFILT_IOC_GETVERSION == 2148034051, "found %lld\n",
		 (long long)FSFILT_IOC_GETVERSION);
	LASSERTF(FSFILT_IOC_SETVERSION == 1074292228, "found %lld\n",
		 (long long)FSFILT_IOC_SETVERSION);
	LASSERTF(FSFILT_IOC_GETVERSION_OLD == 2148038145, "found %lld\n",
		 (long long)FSFILT_IOC_GETVERSION_OLD);
	LASSERTF(FSFILT_IOC_SETVERSION_OLD == 1074296322, "found %lld\n",
		 (long long)FSFILT_IOC_SETVERSION_OLD);

	/* LL IOCTL */
	LASSERTF(LL_IOC_GETFLAGS == 2148034199, "found %lld\n",
		 (long long)LL_IOC_GETFLAGS);
	LASSERTF(LL_IOC_SETFLAGS == 1074292376, "found %lld\n",
		 (long long)LL_IOC_SETFLAGS);
	LASSERTF(LL_IOC_CLRFLAGS == 1074292377, "found %lld\n",
		 (long long)LL_IOC_CLRFLAGS);
	LASSERTF(LL_IOC_LOV_SETSTRIPE == 1074292378, "found %lld\n",
		 (long long)LL_IOC_LOV_SETSTRIPE);
	LASSERTF(LL_IOC_LOV_GETSTRIPE == 1074292379, "found %lld\n",
		 (long long)LL_IOC_LOV_GETSTRIPE);
	LASSERTF(LL_IOC_LOV_SETEA == 1074292380, "found %lld\n",
		 (long long)LL_IOC_LOV_SETEA);
	LASSERTF(LL_IOC_GROUP_LOCK == 1074292382, "found %lld\n",
		 (long long)LL_IOC_GROUP_LOCK);
	LASSERTF(LL_IOC_GROUP_UNLOCK == 1074292383, "found %lld\n",
		 (long long)LL_IOC_GROUP_UNLOCK);
	LASSERTF(LL_IOC_FLUSHCTX == 1074292390, "found %lld\n",
		 (long long)LL_IOC_FLUSHCTX);
	LASSERTF(LL_IOC_GETOBDCOUNT == 2148034216, "found %lld\n",
		 (long long)LL_IOC_GETOBDCOUNT);
	LASSERTF(LL_IOC_LLOOP_ATTACH == 3221776041, "found %lld\n",
		 (long long)LL_IOC_LLOOP_ATTACH);
	LASSERTF(LL_IOC_LLOOP_DETACH == 3221776042, "found %lld\n",
		 (long long)LL_IOC_LLOOP_DETACH);
	LASSERTF(LL_IOC_LLOOP_INFO == 3222300331, "found %lld\n",
		 (long long)LL_IOC_LLOOP_INFO);
	LASSERTF(LL_IOC_LLOOP_DETACH_BYDEV == 3221776044, "found %lld\n",
		 (long long)LL_IOC_LLOOP_DETACH_BYDEV);
	LASSERTF(LL_IOC_PATH2FID == 2148034221, "found %lld\n",
		 (long long)LL_IOC_PATH2FID);
	LASSERTF(LL_IOC_GET_CONNECT_FLAGS == 3221776046, "found %lld\n",
		 (long long)LL_IOC_GET_CONNECT_FLAGS);
	LASSERTF(LL_IOC_GET_MDTIDX == 2147772079, "found %lld\n",
		 (long long)LL_IOC_GET_MDTIDX);
	LASSERTF(LL_IOC_FUTIMES_3 == 3224397488, "found %lld\n",
		 (long long)LL_IOC_FUTIMES_3);
	LASSERTF(LL_IOC_HSM_STATE_GET == 2149607123, "found %lld\n",
		 (long long)LL_IOC_HSM_STATE_GET);
	LASSERTF(LL_IOC_HSM_STATE_SET == 1075341012, "found %lld\n",
		 (long long)LL_IOC_HSM_STATE_SET);
	LASSERTF(LL_IOC_HSM_CT_START == 1075341013, "found %lld\n",
		 (long long)LL_IOC_HSM_CT_START);
	LASSERTF(LL_IOC_HSM_COPY_START == 1074292438, "found %lld\n",
		 (long long)LL_IOC_HSM_COPY_START);
	LASSERTF(LL_IOC_HSM_COPY_END == 1074292439, "found %lld\n",
		 (long long)LL_IOC_HSM_COPY_END);
	LASSERTF(LL_IOC_HSM_PROGRESS == 1075341016, "found %lld\n",
		 (long long)LL_IOC_HSM_PROGRESS);
	LASSERTF(LL_IOC_HSM_REQUEST == 1075341017, "found %lld\n",
		 (long long)LL_IOC_HSM_REQUEST);
	LASSERTF(LL_IOC_DATA_VERSION == 2148558554, "found %lld\n",
		 (long long)LL_IOC_DATA_VERSION);
	LASSERTF(LL_IOC_LOV_SWAP_LAYOUTS == 1075865307, "found %lld\n",
		 (long long)LL_IOC_LOV_SWAP_LAYOUTS);
	LASSERTF(LL_IOC_HSM_ACTION == 2149082844, "found %lld\n",
		 (long long)LL_IOC_HSM_ACTION);
	LASSERTF(LL_IOC_LMV_SETSTRIPE == 3224397552, "found %lld\n",
		 (long long)LL_IOC_LMV_SETSTRIPE);
	LASSERTF(LL_IOC_LMV_GETSTRIPE == 3224397553, "found %lld\n",
		 (long long)LL_IOC_LMV_GETSTRIPE);
	LASSERTF(LL_IOC_REMOVE_ENTRY == 3221776114, "found %lld\n",
		 (long long)LL_IOC_REMOVE_ENTRY);
	LASSERTF(LL_IOC_SET_LEASE == 3221776115, "found %lld\n",
		 (long long)LL_IOC_SET_LEASE);
	LASSERTF(LL_IOC_GET_LEASE == 26356, "found %lld\n",
		 (long long)LL_IOC_GET_LEASE);
	LASSERTF(LL_IOC_HSM_IMPORT == 3224397557, "found %lld\n",
		 (long long)LL_IOC_HSM_IMPORT);
	LASSERTF(LL_IOC_LMV_SET_DEFAULT_STRIPE == 3224397558, "found %lld\n",
		 (long long)LL_IOC_LMV_SET_DEFAULT_STRIPE);
	LASSERTF(LL_IOC_MIGRATE == 2147772151, "found %lld\n",
		 (long long)LL_IOC_MIGRATE);
	LASSERTF(LL_IOC_FID2MDTIDX == 3222300408, "found %lld\n",
		 (long long)LL_IOC_FID2MDTIDX);
	LASSERTF(LL_IOC_GETPARENT == 3222824697, "found %lld\n",
		 (long long)LL_IOC_GETPARENT);
	LASSERTF(LL_IOC_LADVISE == 2149607162, "found %lld\n",
		 (long long)LL_IOC_LADVISE);
	LASSERTF(LL_IOC_MDC_GETINFO == 3221776663, "found %lld\n",
		 (long long)LL_IOC_MDC_GETINFO);

	/* OBD IOCTL */
	LASSERTF(OBD_IOC_CREATE == 3221775973, "found %lld\n",
		 (long long)OBD_IOC_CREATE);
	LASSERTF(OBD_IOC_DESTROY == 1074292328, "found %lld\n",
		 (long long)OBD_IOC_DESTROY);
	LASSERTF(OBD_IOC_SETATTR == 1074292331, "found %lld\n",
		 (long long)OBD_IOC_SETATTR);
	LASSERTF(OBD_IOC_GETATTR == 3221775980, "found %lld\n",
		 (long long)OBD_IOC_GETATTR);
	LASSERTF(OBD_IOC_READ == 3221775981, "found %lld\n",
		 (long long)OBD_IOC_READ);
	LASSERTF(OBD_IOC_WRITE == 3221775982, "found %lld\n",
		 (long long)OBD_IOC_WRITE);
	LASSERTF(OBD_IOC_STATFS == 3221775985, "found %lld\n",
		 (long long)OBD_IOC_STATFS);
	LASSERTF(OBD_IOC_SYNC == 1074292338, "found %lld\n",
		 (long long)OBD_IOC_SYNC);
	LASSERTF(OBD_IOC_BRW_READ == 3221775997, "found %lld\n",
		 (long long)OBD_IOC_BRW_READ);
	LASSERTF(OBD_IOC_BRW_WRITE == 3221775998, "found %lld\n",
		 (long long)OBD_IOC_BRW_WRITE);
	LASSERTF(OBD_IOC_NAME2DEV == 3221775999, "found %lld\n",
		 (long long)OBD_IOC_NAME2DEV);
	LASSERTF(OBD_IOC_UUID2DEV == 3221776002, "found %lld\n",
		 (long long)OBD_IOC_UUID2DEV);
	LASSERTF(OBD_IOC_GETNAME == 3221776003, "found %lld\n",
		 (long long)OBD_IOC_GETNAME);
	LASSERTF(OBD_IOC_GETMDNAME == 2155898499, "found %lld\n",
		 (long long)OBD_IOC_GETMDNAME);
	LASSERTF(OBD_IOC_GETDTNAME == 3221776003, "found %lld\n",
		 (long long)OBD_IOC_GETDTNAME);
	LASSERTF(OBD_IOC_LOV_GET_CONFIG == 3221776004, "found %lld\n",
		 (long long)OBD_IOC_LOV_GET_CONFIG);
	LASSERTF(OBD_IOC_CLIENT_RECOVER == 1074292357, "found %lld\n",
		 (long long)OBD_IOC_CLIENT_RECOVER);
	LASSERTF(OBD_IOC_PING_TARGET == 1074292360, "found %lld\n",
		 (long long)OBD_IOC_PING_TARGET);
	LASSERTF(OBD_IOC_NO_TRANSNO == 1074292364, "found %lld\n",
		 (long long)OBD_IOC_NO_TRANSNO);
	LASSERTF(OBD_IOC_SET_READONLY == 1074292365, "found %lld\n",
		 (long long)OBD_IOC_SET_READONLY);
	LASSERTF(OBD_IOC_ABORT_RECOVERY == 2148034190, "found %lld\n",
		 (long long)OBD_IOC_ABORT_RECOVERY);
	LASSERTF(OBD_GET_VERSION == 3221776016, "found %lld\n",
		 (long long)OBD_GET_VERSION);
	LASSERTF(OBD_IOC_CHANGELOG_SEND == 1074292372, "found %lld\n",
		 (long long)OBD_IOC_CHANGELOG_SEND);
	LASSERTF(OBD_IOC_GETDEVICE == 3221776021, "found %lld\n",
		 (long long)OBD_IOC_GETDEVICE);
	LASSERTF(OBD_IOC_FID2PATH == 3221776022, "found %lld\n",
		 (long long)OBD_IOC_FID2PATH);
	LASSERTF(OBD_IOC_QUOTACTL == 3232786082, "found %lld\n",
		 (long long)OBD_IOC_QUOTACTL);
	LASSERTF(OBD_IOC_CHANGELOG_REG == 1111516849, "found %lld\n",
		 (long long)OBD_IOC_CHANGELOG_REG);
	LASSERTF(OBD_IOC_CHANGELOG_DEREG == 1111516850, "found %lld\n",
		 (long long)OBD_IOC_CHANGELOG_DEREG);
	LASSERTF(OBD_IOC_CHANGELOG_CLEAR == 1111516851, "found %lld\n",
		 (long long)OBD_IOC_CHANGELOG_CLEAR);
	LASSERTF(OBD_IOC_PROCESS_CFG == 3221776056, "found %lld\n",
		 (long long)OBD_IOC_PROCESS_CFG);
	LASSERTF(OBD_IOC_PARAM == 1074292411, "found %lld\n",
		 (long long)OBD_IOC_PARAM);
	LASSERTF(OBD_IOC_POOL == 3221776060, "found %lld\n",
		 (long long)OBD_IOC_POOL);
	LASSERTF(OBD_IOC_REPLACE_NIDS == 3221776061, "found %lld\n",
		 (long long)OBD_IOC_REPLACE_NIDS);
	LASSERTF(OBD_IOC_CATLOGLIST == 3221776062, "found %lld\n",
		 (long long)OBD_IOC_CATLOGLIST);
	LASSERTF(OBD_IOC_LLOG_INFO == 3221776063, "found %lld\n",
		 (long long)OBD_IOC_LLOG_INFO);
	LASSERTF(OBD_IOC_LLOG_PRINT == 3221776064, "found %lld\n",
		 (long long)OBD_IOC_LLOG_PRINT);
	LASSERTF(OBD_IOC_LLOG_CANCEL == 3221776065, "found %lld\n",
		 (long long)OBD_IOC_LLOG_CANCEL);
	LASSERTF(OBD_IOC_LLOG_REMOVE == 3221776066, "found %lld\n",
		 (long long)OBD_IOC_LLOG_REMOVE);
	LASSERTF(OBD_IOC_LLOG_CHECK == 3221776067, "found %lld\n",
		 (long long)OBD_IOC_LLOG_CHECK);
	LASSERTF(OBD_IOC_NODEMAP == 3221776069, "found %lld\n",
		 (long long)OBD_IOC_NODEMAP);
	LASSERTF(OBD_IOC_GET_OBJ_VERSION == 2148034258, "found %lld\n",
		 (long long)OBD_IOC_GET_OBJ_VERSION);
	LASSERTF(OBD_IOC_GET_MNTOPT == 1074292444, "found %lld\n",
		 (long long)OBD_IOC_GET_MNTOPT);
	LASSERTF(OBD_IOC_ECHO_MD == 2185258717, "found %lld\n",
		 (long long)OBD_IOC_ECHO_MD);
	LASSERTF(OBD_IOC_ECHO_ALLOC_SEQ == 3259000542, "found %lld\n",
		 (long long)OBD_IOC_ECHO_ALLOC_SEQ);
	LASSERTF(OBD_IOC_START_LFSCK == 3221776102, "found %lld\n",
		 (long long)OBD_IOC_START_LFSCK);
	LASSERTF(OBD_IOC_STOP_LFSCK == 1074292455, "found %lld\n",
		 (long long)OBD_IOC_STOP_LFSCK);
	LASSERTF(OBD_IOC_QUERY_LFSCK == 2185258728, "found %lld\n",
		 (long long)OBD_IOC_QUERY_LFSCK);
}
