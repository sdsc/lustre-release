...
void lustre_assert_wire_constants(void)
{
	  ...
	  * running on Linux c65 2.6.32-431.20.3.el6_lustre.x86_64
	...
	/* Checks for struct hsm_migrate_param */
	LASSERTF((int)sizeof(struct hsm_migrate_param) == 48, "found %lld\n",
		 (long long)(int)sizeof(struct hsm_migrate_param));
	LASSERTF((int)offsetof(struct hsm_migrate_param, lsp_pool) == 0, "found %lld\n",
		 (long long)(int)offsetof(struct hsm_migrate_param, lsp_pool));
	LASSERTF((int)sizeof(((struct hsm_migrate_param *)0)->lsp_pool) == 16, "found %lld\n",
		 (long long)(int)sizeof(((struct hsm_migrate_param *)0)->lsp_pool));
	LASSERTF((int)offsetof(struct hsm_migrate_param, lsp_stripe_size) == 16, "found %lld\n",
		 (long long)(int)offsetof(struct hsm_migrate_param, lsp_stripe_size));
	LASSERTF((int)sizeof(((struct hsm_migrate_param *)0)->lsp_stripe_size) == 8, "found %lld\n",
		 (long long)(int)sizeof(((struct hsm_migrate_param *)0)->lsp_stripe_size));
	LASSERTF((int)offsetof(struct hsm_migrate_param, mdt_index) == 24, "found %lld\n",
		 (long long)(int)offsetof(struct hsm_migrate_param, mdt_index));
	LASSERTF((int)sizeof(((struct hsm_migrate_param *)0)->mdt_index) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct hsm_migrate_param *)0)->mdt_index));
	LASSERTF((int)offsetof(struct hsm_migrate_param, lsp_stripe_offset) == 28, "found %lld\n",
		 (long long)(int)offsetof(struct hsm_migrate_param, lsp_stripe_offset));
	LASSERTF((int)sizeof(((struct hsm_migrate_param *)0)->lsp_stripe_offset) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct hsm_migrate_param *)0)->lsp_stripe_offset));
	LASSERTF((int)offsetof(struct hsm_migrate_param, lsp_stripe_pattern) == 32, "found %lld\n",
		 (long long)(int)offsetof(struct hsm_migrate_param, lsp_stripe_pattern));
	LASSERTF((int)sizeof(((struct hsm_migrate_param *)0)->lsp_stripe_pattern) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct hsm_migrate_param *)0)->lsp_stripe_pattern));
	LASSERTF((int)offsetof(struct hsm_migrate_param, lsp_stripe_count) == 36, "found %lld\n",
		 (long long)(int)offsetof(struct hsm_migrate_param, lsp_stripe_count));
	LASSERTF((int)sizeof(((struct hsm_migrate_param *)0)->lsp_stripe_count) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct hsm_migrate_param *)0)->lsp_stripe_count));
	LASSERTF((int)offsetof(struct hsm_migrate_param, lsp_osts_count) == 40, "found %lld\n",
		 (long long)(int)offsetof(struct hsm_migrate_param, lsp_osts_count));
	LASSERTF((int)sizeof(((struct hsm_migrate_param *)0)->lsp_osts_count) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct hsm_migrate_param *)0)->lsp_osts_count));
	LASSERTF((int)offsetof(struct hsm_migrate_param, lsp_osts[0]) == 44, "found %lld\n",
		 (long long)(int)offsetof(struct hsm_migrate_param, lsp_osts[0]));
	LASSERTF((int)sizeof(((struct hsm_migrate_param *)0)->lsp_osts[0]) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct hsm_migrate_param *)0)->lsp_osts[0]));
