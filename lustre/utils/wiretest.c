...
void lustre_assert_wire_constants(void)
{
	 ...
	 * running on Linux ieel-build6-32.ieel.utopiabound.net 2.6.32-642.el6.i686 #1 SMP Tue May 10
	 * with gcc version 4.4.7 20120313 (Red Hat 4.4.7-17) (GCC)  */
...
void lustre_assert_ioctl_constants(void)
{
	...
	/* FSFILT IOCTL */
	LASSERTF(FSFILT_IOC_GETFLAGS == 0x80046601UL, "found 0x%.8xUL\n",
		(unsigned)FSFILT_IOC_GETFLAGS);
	LASSERTF(FSFILT_IOC_SETFLAGS == 0x40046602UL, "found 0x%.8xUL\n",
		(unsigned)FSFILT_IOC_SETFLAGS);
	LASSERTF(FSFILT_IOC_GETVERSION == 0x80046603UL, "found 0x%.8xUL\n",
		(unsigned)FSFILT_IOC_GETVERSION);
	LASSERTF(FSFILT_IOC_SETVERSION == 0x40046604UL, "found 0x%.8xUL\n",
		(unsigned)FSFILT_IOC_SETVERSION);
	LASSERTF(FSFILT_IOC_GETVERSION_OLD == 0x80047601UL, "found 0x%.8xUL\n",
		(unsigned)FSFILT_IOC_GETVERSION_OLD);
	LASSERTF(FSFILT_IOC_SETVERSION_OLD == 0x40047602UL, "found 0x%.8xUL\n",
		(unsigned)FSFILT_IOC_SETVERSION_OLD);

	/* LL IOCTL */
	LASSERTF(LL_IOC_GETFLAGS == 0x80046697UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_GETFLAGS);
	LASSERTF(LL_IOC_SETFLAGS == 0x40046698UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_SETFLAGS);
	LASSERTF(LL_IOC_CLRFLAGS == 0x40046699UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_CLRFLAGS);
	LASSERTF(LL_IOC_LOV_SETSTRIPE == 0x4004669aUL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_LOV_SETSTRIPE);
	LASSERTF(LL_IOC_LOV_GETSTRIPE == 0x4004669bUL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_LOV_GETSTRIPE);
	LASSERTF(LL_IOC_LOV_SETEA == 0x4004669cUL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_LOV_SETEA);
	LASSERTF(LL_IOC_GROUP_LOCK == 0x4004669eUL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_GROUP_LOCK);
	LASSERTF(LL_IOC_GROUP_UNLOCK == 0x4004669fUL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_GROUP_UNLOCK);
	LASSERTF(LL_IOC_FLUSHCTX == 0x400466a6UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_FLUSHCTX);
	LASSERTF(LL_IOC_GETOBDCOUNT == 0x800466a8UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_GETOBDCOUNT);
	LASSERTF(LL_IOC_LLOOP_ATTACH == 0xc00466a9UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_LLOOP_ATTACH);
	LASSERTF(LL_IOC_LLOOP_DETACH == 0xc00466aaUL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_LLOOP_DETACH);
	LASSERTF(LL_IOC_LLOOP_INFO == 0xc01066abUL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_LLOOP_INFO);
	LASSERTF(LL_IOC_LLOOP_DETACH_BYDEV == 0xc00466acUL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_LLOOP_DETACH_BYDEV);
	LASSERTF(LL_IOC_PATH2FID == 0x800466adUL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_PATH2FID);
	LASSERTF(LL_IOC_GET_CONNECT_FLAGS == 0xc00466aeUL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_GET_CONNECT_FLAGS);
	LASSERTF(LL_IOC_GET_MDTIDX == 0x800466afUL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_GET_MDTIDX);
	LASSERTF(LL_IOC_FUTIMES_3 == 0xc03066b0UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_FUTIMES_3);
	LASSERTF(LL_IOC_HSM_STATE_GET == 0x802066d3UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_HSM_STATE_GET);
	LASSERTF(LL_IOC_HSM_STATE_SET == 0x401866d4UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_HSM_STATE_SET);
	LASSERTF(LL_IOC_HSM_CT_START == 0x401866d5UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_HSM_CT_START);
	LASSERTF(LL_IOC_HSM_COPY_START == 0x400466d6UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_HSM_COPY_START);
	LASSERTF(LL_IOC_HSM_COPY_END == 0x400466d7UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_HSM_COPY_END);
	LASSERTF(LL_IOC_HSM_PROGRESS == 0x401866d8UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_HSM_PROGRESS);
	LASSERTF(LL_IOC_HSM_REQUEST == 0x401866d9UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_HSM_REQUEST);
	LASSERTF(LL_IOC_DATA_VERSION == 0x801066daUL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_DATA_VERSION);
	LASSERTF(LL_IOC_LOV_SWAP_LAYOUTS == 0x402066dbUL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_LOV_SWAP_LAYOUTS);
	LASSERTF(LL_IOC_HSM_ACTION == 0x801866dcUL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_HSM_ACTION);
	LASSERTF(LL_IOC_LMV_SETSTRIPE == 0xc03066f0UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_LMV_SETSTRIPE);
	LASSERTF(LL_IOC_LMV_GETSTRIPE == 0xc03066f1UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_LMV_GETSTRIPE);
	LASSERTF(LL_IOC_REMOVE_ENTRY == 0xc00866f2UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_REMOVE_ENTRY);
	LASSERTF(LL_IOC_SET_LEASE == 0xc00466f3UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_SET_LEASE);
	LASSERTF(LL_IOC_GET_LEASE == 0x000066f4UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_GET_LEASE);
	LASSERTF(LL_IOC_HSM_IMPORT == 0xc03066f5UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_HSM_IMPORT);
	LASSERTF(LL_IOC_LMV_SET_DEFAULT_STRIPE == 0xc03066f6UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_LMV_SET_DEFAULT_STRIPE);
	LASSERTF(LL_IOC_MIGRATE == 0x800466f7UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_MIGRATE);
	LASSERTF(LL_IOC_FID2MDTIDX == 0xc01066f8UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_FID2MDTIDX);
	LASSERTF(LL_IOC_GETPARENT == 0xc01866f9UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_GETPARENT);
	LASSERTF(LL_IOC_LADVISE == 0x802066faUL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_LADVISE);
	LASSERTF(LL_IOC_MDC_GETINFO == 0xc0046917UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_MDC_GETINFO);

	/* OBD IOCTL */
	LASSERTF(OBD_IOC_CREATE == 0xc0046665UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_CREATE);
	LASSERTF(OBD_IOC_DESTROY == 0x40046668UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_DESTROY);
	LASSERTF(OBD_IOC_SETATTR == 0x4004666bUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_SETATTR);
	LASSERTF(OBD_IOC_GETATTR == 0xc004666cUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_GETATTR);
	LASSERTF(OBD_IOC_READ == 0xc004666dUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_READ);
	LASSERTF(OBD_IOC_WRITE == 0xc004666eUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_WRITE);
	LASSERTF(OBD_IOC_STATFS == 0xc0046671UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_STATFS);
	LASSERTF(OBD_IOC_SYNC == 0x40046672UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_SYNC);
	LASSERTF(OBD_IOC_BRW_READ == 0xc004667dUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_BRW_READ);
	LASSERTF(OBD_IOC_BRW_WRITE == 0xc004667eUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_BRW_WRITE);
	LASSERTF(OBD_IOC_NAME2DEV == 0xc004667fUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_NAME2DEV);
	LASSERTF(OBD_IOC_UUID2DEV == 0xc0046682UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_UUID2DEV);
	LASSERTF(OBD_IOC_GETNAME == 0xc0046683UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_GETNAME);
	LASSERTF(OBD_IOC_GETMDNAME == 0x80806683UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_GETMDNAME);
	LASSERTF(OBD_IOC_GETDTNAME == 0xc0046683UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_GETDTNAME);
	LASSERTF(OBD_IOC_LOV_GET_CONFIG == 0xc0046684UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_LOV_GET_CONFIG);
	LASSERTF(OBD_IOC_CLIENT_RECOVER == 0x40046685UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_CLIENT_RECOVER);
	LASSERTF(OBD_IOC_PING_TARGET == 0x40046688UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_PING_TARGET);
	LASSERTF(OBD_IOC_NO_TRANSNO == 0x4004668cUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_NO_TRANSNO);
	LASSERTF(OBD_IOC_SET_READONLY == 0x4004668dUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_SET_READONLY);
	LASSERTF(OBD_IOC_ABORT_RECOVERY == 0x8004668eUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_ABORT_RECOVERY);
	LASSERTF(OBD_GET_VERSION == 0xc0046690UL, "found 0x%.8xUL\n",
		(unsigned)OBD_GET_VERSION);
	LASSERTF(OBD_IOC_CHANGELOG_SEND == 0x40046694UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_CHANGELOG_SEND);
	LASSERTF(OBD_IOC_GETDEVICE == 0xc0046695UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_GETDEVICE);
	LASSERTF(OBD_IOC_FID2PATH == 0xc0046696UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_FID2PATH);
	LASSERTF(OBD_IOC_QUOTACTL == 0xc0b066a2UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_QUOTACTL);
	LASSERTF(OBD_IOC_CHANGELOG_REG == 0x421066b1UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_CHANGELOG_REG);
	LASSERTF(OBD_IOC_CHANGELOG_DEREG == 0x421066b2UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_CHANGELOG_DEREG);
	LASSERTF(OBD_IOC_CHANGELOG_CLEAR == 0x421066b3UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_CHANGELOG_CLEAR);
	LASSERTF(OBD_IOC_PROCESS_CFG == 0xc00466b8UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_PROCESS_CFG);
	LASSERTF(OBD_IOC_PARAM == 0x400466bbUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_PARAM);
	LASSERTF(OBD_IOC_POOL == 0xc00466bcUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_POOL);
	LASSERTF(OBD_IOC_REPLACE_NIDS == 0xc00466bdUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_REPLACE_NIDS);
	LASSERTF(OBD_IOC_CATLOGLIST == 0xc00466beUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_CATLOGLIST);
	LASSERTF(OBD_IOC_LLOG_INFO == 0xc00466bfUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_LLOG_INFO);
	LASSERTF(OBD_IOC_LLOG_PRINT == 0xc00466c0UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_LLOG_PRINT);
	LASSERTF(OBD_IOC_LLOG_CANCEL == 0xc00466c1UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_LLOG_CANCEL);
	LASSERTF(OBD_IOC_LLOG_REMOVE == 0xc00466c2UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_LLOG_REMOVE);
	LASSERTF(OBD_IOC_LLOG_CHECK == 0xc00466c3UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_LLOG_CHECK);
	LASSERTF(OBD_IOC_NODEMAP == 0xc00466c5UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_NODEMAP);
	LASSERTF(OBD_IOC_GET_OBJ_VERSION == 0x800466d2UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_GET_OBJ_VERSION);
	LASSERTF(OBD_IOC_ECHO_MD == 0x821066ddUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_ECHO_MD);
	LASSERTF(OBD_IOC_ECHO_ALLOC_SEQ == 0xc21066deUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_ECHO_ALLOC_SEQ);
	LASSERTF(OBD_IOC_START_LFSCK == 0xc00466e6UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_START_LFSCK);
	LASSERTF(OBD_IOC_STOP_LFSCK == 0x400466e7UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_STOP_LFSCK);
	LASSERTF(OBD_IOC_QUERY_LFSCK == 0x821066e8UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_QUERY_LFSCK);
}
