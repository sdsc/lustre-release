...
void lustre_assert_wire_constants(void)
{
         ...
         * running on Linux vivaldi 2.6.18-prep #3 SMP Wed May 18 19:29:18 PDT 2011 x86_64 x86_64 x86
        ...
        LASSERTF((int)offsetof(struct mds_rec_create, cr_umask) == 76, " found %lld\n",
                 (long long)(int)offsetof(struct mds_rec_create, cr_umask));
        LASSERTF((int)sizeof(((struct mds_rec_create *)0)->cr_umask) == 4, " found %lld\n",
                 (long long)(int)sizeof(((struct mds_rec_create *)0)->cr_umask));
