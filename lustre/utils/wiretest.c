...
void lustre_assert_wire_constants(void)
{
        ...
        LASSERTF((int)offsetof(struct obd_connect_data, ocd_grant_frag) == 34, " found %lld\n",
                 (long long)(int)offsetof(struct obd_connect_data, ocd_grant_frag));
        LASSERTF((int)sizeof(((struct obd_connect_data *)0)->ocd_grant_frag) == 2, " found %lld\n",
                 (long long)(int)sizeof(((struct obd_connect_data *)0)->ocd_grant_frag));
        ...
        CLASSERT(OBD_CONNECT_GRANT_PARAM == 0x40000000000ULL);
