...
void lustre_assert_wire_constants(void)
{
	...
	LASSERTF((int)offsetof(struct lfsck_start, ls_index) == 14, "found %lld\n",
		 (long long)(int)offsetof(struct lfsck_start, ls_index));
	LASSERTF((int)sizeof(((struct lfsck_start *)0)->ls_index) == 2, "found %lld\n",
		 (long long)(int)sizeof(((struct lfsck_start *)0)->ls_index));
	LASSERTF((int)offsetof(struct lfsck_control_request, lcr_type) == 16, "found %lld\n",
		 (long long)(int)offsetof(struct lfsck_control_request, lcr_type));
	LASSERTF((int)sizeof(((struct lfsck_control_request *)0)->lcr_type) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct lfsck_control_request *)0)->lcr_type));
