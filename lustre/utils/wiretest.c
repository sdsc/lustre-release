...
void lustre_assert_wire_constants(void)
{
        ...
        CLASSERT(OBD_FL_INLINEDATA == OBD_FL_INLINEDATA);
        CLASSERT(OBD_FL_OBDMDEXISTS == OBD_FL_OBDMDEXISTS);
        CLASSERT(OBD_FL_DELORPHAN == OBD_FL_DELORPHAN);
        CLASSERT(OBD_FL_NORPC == OBD_FL_NORPC);
        CLASSERT(OBD_FL_IDONLY == OBD_FL_IDONLY);
        CLASSERT(OBD_FL_RECREATE_OBJS == OBD_FL_RECREATE_OBJS);
        CLASSERT(OBD_FL_DEBUG_CHECK == OBD_FL_DEBUG_CHECK);
        CLASSERT(OBD_FL_NO_USRQUOTA == OBD_FL_NO_USRQUOTA);
        CLASSERT(OBD_FL_NO_GRPQUOTA == OBD_FL_NO_GRPQUOTA);
        CLASSERT(OBD_FL_CREATE_CROW == OBD_FL_CREATE_CROW);
        CLASSERT(OBD_FL_TRUNCLOCK == OBD_FL_TRUNCLOCK);
        CLASSERT(OBD_FL_CKSUM_CRC32 == OBD_FL_CKSUM_CRC32);
        CLASSERT(OBD_FL_CKSUM_ADLER == OBD_FL_CKSUM_ADLER);
        CLASSERT(OBD_FL_SHRINK_GRANT == OBD_FL_SHRINK_GRANT);
        CLASSERT(OBD_FL_MMAP == OBD_FL_MMAP);
        CLASSERT(OBD_FL_RECOV_RESEND == OBD_FL_RECOV_RESEND);
