...
void lustre_assert_wire_constants(void)
{
	...
	LASSERTF((int)offsetof(struct ptlrpc_body_v3, pb_tag) == 24, "found %lld\n",
		 (long long)(int)offsetof(struct ptlrpc_body_v3, pb_tag));
	LASSERTF((int)sizeof(((struct ptlrpc_body_v3 *)0)->pb_tag) == 8, "found %lld\n",
	...
	LASSERTF((int)offsetof(struct obd_connect_data, ocd_maxslots) == 72, "found %lld\n",
		 (long long)(int)offsetof(struct obd_connect_data, ocd_maxslots));
	LASSERTF((int)sizeof(((struct obd_connect_data *)0)->ocd_maxslots) == 2, "found %lld\n",
		 (long long)(int)sizeof(((struct obd_connect_data *)0)->ocd_maxslots));
