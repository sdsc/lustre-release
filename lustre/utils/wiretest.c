...
void lustre_assert_wire_constants(void)
{
	  ...
	  * running on Linux panda 2.6.32-379.14.1.lve1.1.9.9.el6.x86_64 #1 SMP Thu Dec 6 07:12:24 EST
	  * with gcc version 4.4.5 20110214 (Red Hat 4.4.5-6) (GCC)  */
	...
	LASSERTF((int)offsetof(struct obd_connect_data, ocd_ichunk_size) == 36, "found %lld\n",
		 (long long)(int)offsetof(struct obd_connect_data, ocd_ichunk_size));
	LASSERTF((int)sizeof(((struct obd_connect_data *)0)->ocd_ichunk_size) == 1, "found %lld\n",
		 (long long)(int)sizeof(((struct obd_connect_data *)0)->ocd_ichunk_size));
	...
	CLASSERT(OBD_FL_CKSUM_T10A == 0x00008000);
	CLASSERT(OBD_FL_CKSUM_T10B == 0x00010000);
