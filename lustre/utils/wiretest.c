...
void lustre_assert_wire_constants(void)
{
	...
	LASSERTF((int)offsetof(struct obd_connect_data, ocd_grant_extent_kb) == 34, "found %lld\n",
		 (long long)(int)offsetof(struct obd_connect_data, ocd_grant_extent_kb));
	LASSERTF((int)sizeof(((struct obd_connect_data *)0)->ocd_grant_extent_kb) == 2, "found %lld\n",
		 (long long)(int)sizeof(((struct obd_connect_data *)0)->ocd_grant_extent_kb));
	...
	LASSERTF(OBD_BRW_FROM_GRANT == 0x20, "found 0x%.8x\n",
		OBD_BRW_FROM_GRANT);
	LASSERTF(OBD_BRW_UNGRANTED == 0x40, "found 0x%.8x\n",
		OBD_BRW_UNGRANTED);
