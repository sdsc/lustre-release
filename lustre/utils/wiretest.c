...
void lustre_assert_wire_constants(void)
{
	...
	LASSERTF((int)offsetof(struct object_update, ou_count) == 2, "found %lld\n",
		 (long long)(int)offsetof(struct object_update, ou_count));
	LASSERTF((int)sizeof(((struct object_update *)0)->ou_count) == 2, "found %lld\n",
		 (long long)(int)sizeof(((struct object_update *)0)->ou_count));
	...
	LASSERTF((int)offsetof(struct object_update, ou_bufs) == 54, "found %lld\n",
