...
void lustre_assert_wire_constants(void)
{
	...
	LASSERTF((int)sizeof(((struct ldlm_intent *)0)->opc) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct ldlm_intent *)0)->opc));
	LASSERTF((int)offsetof(struct ldlm_intent, padding) == 4, "found %lld\n",
		 (long long)(int)offsetof(struct ldlm_intent, padding));
	LASSERTF((int)sizeof(((struct ldlm_intent *)0)->padding) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct ldlm_intent *)0)->padding));
