...
void lustre_assert_wire_constants(void)
{
	  ...
	  * running on Linux mercury 2.6.32-431.20.3.el6_lustre.ge236be3.x86_64 #1 SMP Wed Jul 2 13:49
	...
	LASSERTF(OBD_MD_FLRELEASED == (0x0020000000000000ULL), "found 0x%.16llxULL\n",
		 OBD_MD_FLRELEASED);
	LASSERTF(OBD_MD_FLREMOVED == (0x0080000000000000ULL), "found 0x%.16llxULL\n",
		 OBD_MD_FLREMOVED);
