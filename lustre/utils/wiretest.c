...
void lustre_assert_wire_constants(void)
{
	...
	LASSERTF(LUSTRE_SYNC_FL == LUSTRE_SYNC_FL, "found 0x%.8x\n",
		LUSTRE_SYNC_FL);
	LASSERTF(LUSTRE_IMMUTABLE_FL == LUSTRE_IMMUTABLE_FL, "found 0x%.8x\n",
		LUSTRE_IMMUTABLE_FL);
	LASSERTF(LUSTRE_APPEND_FL == LUSTRE_APPEND_FL, "found 0x%.8x\n",
		LUSTRE_APPEND_FL);
	LASSERTF(LUSTRE_NODUMP_FL == LUSTRE_NODUMP_FL, "found 0x%.8x\n",
		LUSTRE_NODUMP_FL);
	LASSERTF(LUSTRE_NOATIME_FL == LUSTRE_NOATIME_FL, "found 0x%.8x\n",
		LUSTRE_NOATIME_FL);
	LASSERTF(LUSTRE_INDEX_FL == LUSTRE_INDEX_FL, "found 0x%.8x\n",
		LUSTRE_INDEX_FL);
	LASSERTF(LUSTRE_DIRSYNC_FL == LUSTRE_DIRSYNC_FL, "found 0x%.8x\n",
		LUSTRE_DIRSYNC_FL);
	LASSERTF(LUSTRE_TOPDIR_FL == LUSTRE_TOPDIR_FL, "found 0x%.8x\n",
		LUSTRE_TOPDIR_FL);
	LASSERTF(LUSTRE_DIRECTIO_FL == LUSTRE_DIRECTIO_FL, "found 0x%.8x\n",
		LUSTRE_DIRECTIO_FL);
	LASSERTF(LUSTRE_INLINE_DATA_FL == LUSTRE_INLINE_DATA_FL, "found 0x%.8x\n",
