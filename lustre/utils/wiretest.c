...
void lustre_assert_wire_constants(void)
{
	...
	LASSERTF((int)offsetof(struct ptlrpc_body_v3, pb_padding0) == 26, "found %lld\n",
	...
	LASSERTF((int)offsetof(struct ptlrpc_body_v3, pb_padding1) == 28, "found %lld\n",
	...
	LASSERTF(OBD_CONNECT_MULTISLOT == 0x200000000000000ULL, "found 0x%.16llxULL\n",
