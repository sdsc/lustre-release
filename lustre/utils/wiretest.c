...
void lustre_assert_wire_constants(void)
{
	...
	LASSERTF((int)sizeof(union lquota_id) == 16, "found %lld\n",
        ...
        /* Checks for struct idx_container */
        LASSERTF((int)sizeof(struct idx_container) == 16, "found %lld\n",
                 (long long)(int)sizeof(struct idx_container));
        LASSERTF((int)offsetof(struct idx_container, ic_magic) == 0, "found %lld\n",
                 (long long)(int)offsetof(struct idx_container, ic_magic));
        LASSERTF((int)sizeof(((struct idx_container *)0)->ic_magic) == 4, "found %lld\n",
                 (long long)(int)sizeof(((struct idx_container *)0)->ic_magic));
        LASSERTF((int)offsetof(struct idx_container, ic_flags) == 4, "found %lld\n",
                 (long long)(int)offsetof(struct idx_container, ic_flags));
        LASSERTF((int)sizeof(((struct idx_container *)0)->ic_flags) == 2, "found %lld\n",
                 (long long)(int)sizeof(((struct idx_container *)0)->ic_flags));
        LASSERTF((int)offsetof(struct idx_container, ic_nr) == 6, "found %lld\n",
                 (long long)(int)offsetof(struct idx_container, ic_nr));
        LASSERTF((int)sizeof(((struct idx_container *)0)->ic_nr) == 2, "found %lld\n",
                 (long long)(int)sizeof(((struct idx_container *)0)->ic_nr));
        LASSERTF((int)offsetof(struct idx_container, ic_pad0) == 8, "found %lld\n",
                 (long long)(int)offsetof(struct idx_container, ic_pad0));
        LASSERTF((int)sizeof(((struct idx_container *)0)->ic_pad0) == 8, "found %lld\n",
                 (long long)(int)sizeof(((struct idx_container *)0)->ic_pad0));
        CLASSERT(IDX_CT_MAGIC == 0x8A6D6B6C);
        LASSERTF(IDX_CT_HDR_SIZE == 16, "found %lld\n",
                 (long long)IDX_CT_HDR_SIZE);
        LASSERTF(II_FL_LAST == 1, "found %lld\n",
                 (long long)II_FL_LAST);
