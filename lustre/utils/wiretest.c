...
void lustre_assert_wire_constants(void)
{
        ...
        LASSERTF((int)offsetof(struct mgs_target_info, mti_padding) == 20, "found %lld\n",
                 (long long)(int)offsetof(struct mgs_target_info, mti_padding));
        LASSERTF((int)sizeof(((struct mgs_target_info *)0)->mti_padding) == 4, "found %lld\n",
                 (long long)(int)sizeof(((struct mgs_target_info *)0)->mti_padding));
