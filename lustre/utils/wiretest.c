...
void lustre_assert_wire_constants(void)
{
	...
	LASSERTF((int)offsetof(struct llog_setattr64_rec, lsr_seq) == 48, "found %lld\n",
		 (long long)(int)offsetof(struct llog_setattr64_rec, lsr_seq));
	LASSERTF((int)sizeof(((struct llog_setattr64_rec *)0)->lsr_seq) == 8, "found %lld\n",
		 (long long)(int)sizeof(((struct llog_setattr64_rec *)0)->lsr_seq));
	...
	LASSERTF((int)offsetof(struct lfsck_event_request, ler_event) == 16, "found %lld\n",
		 (long long)(int)offsetof(struct lfsck_event_request, ler_event));
	LASSERTF((int)sizeof(((struct lfsck_event_request *)0)->ler_event) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct lfsck_event_request *)0)->ler_event));
	LASSERTF((int)offsetof(struct lfsck_event_request, ler_padding) == 20, "found %lld\n",
