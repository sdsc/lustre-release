...
void lustre_assert_wire_constants(void)
{
	...
	LASSERTF((int)offsetof(struct obd_connect_data, ocd_maxmdrpcs) == 72, "found %lld\n",
		 (long long)(int)offsetof(struct obd_connect_data, ocd_maxmdrpcs));
	LASSERTF((int)sizeof(((struct obd_connect_data *)0)->ocd_maxmdrpcs) == 2, "found %lld\n",
		 (long long)(int)sizeof(((struct obd_connect_data *)0)->ocd_maxmdrpcs));
	...
	LASSERTF(OBD_CONNECT_MULTIMDRPCS == 0x200000000000000ULL, "found 0x%.16llxULL\n",
		 OBD_CONNECT_MULTIMDRPCS);
