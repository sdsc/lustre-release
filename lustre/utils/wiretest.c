...
void lustre_assert_wire_constants(void)
{
         ...
         * running on Linux RHEL6-nasf-CSW 2.6.32-279.el6-lustre #3 SMP Sun Aug 12 03:11:50 CST 2012
	...
	LASSERTF((int)sizeof(((struct ptlrpc_body_v3 *)0)->pb_padding) == (int)sizeof(((struct ptlrpc_body_v2 *)0)->pb_padding), "%d != %d\n",
        ...
        LASSERTF(OBD_CONNECT_LVB_TYPE == 0x200000000000ULL, "found 0x%.16llxULL\n",
