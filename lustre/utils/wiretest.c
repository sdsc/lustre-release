...
void lustre_assert_wire_constants(void)
{
	...
	LASSERTF(OBJECT_UPDATE == 1000, "found %lld\n",
		 (long long)OBJECT_UPDATE);
	LASSERTF(OBJECT_UPDATE_LAST_OPC == 1001, "found %lld\n",
		 (long long)OBJECT_UPDATE_LAST_OPC);
	...
	LASSERTF((int)sizeof(struct object_update) == 72, "found %lld\n",
	...
	LASSERTF((int)offsetof(struct object_update, ou_padding1) == 2, "found %lld\n",
	...
	LASSERTF((int)offsetof(struct object_update, ou_padding2) == 12, "found %lld\n",
		 (long long)(int)offsetof(struct object_update, ou_padding2));
	LASSERTF((int)sizeof(((struct object_update *)0)->ou_padding2) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct object_update *)0)->ou_padding2));
	...
	LASSERTF((int)offsetof(struct object_update, ou_lens) == 40, "found %lld\n",
		 (long long)(int)offsetof(struct object_update, ou_lens));
	LASSERTF((int)sizeof(((struct object_update *)0)->ou_lens) == 32, "found %lld\n",
		 (long long)(int)sizeof(((struct object_update *)0)->ou_lens));
	LASSERTF((int)offsetof(struct object_update, ou_bufs) == 72, "found %lld\n",
		 (long long)(int)offsetof(struct object_update, ou_bufs));
	LASSERTF((int)sizeof(((struct object_update *)0)->ou_bufs) == 0, "found %lld\n",
		 (long long)(int)sizeof(((struct object_update *)0)->ou_bufs));
	...
	LASSERTF((int)sizeof(((struct object_update_request *)0)->ourq_count) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct object_update_request *)0)->ourq_count));
	LASSERTF((int)offsetof(struct object_update_request, ourq_bufs) == 8, "found %lld\n",
		 (long long)(int)offsetof(struct object_update_request, ourq_bufs));
	LASSERTF((int)sizeof(((struct object_update_request *)0)->ourq_bufs) == 0, "found %lld\n",
		 (long long)(int)sizeof(((struct object_update_request *)0)->ourq_bufs));
	...
	LASSERTF((int)sizeof(((struct object_update_result *)0)->our_datalen) == 4, "found %lld\n",
	...
	LASSERTF((int)sizeof(((struct object_update_reply *)0)->ourp_count) == 4, "found %lld\n",
