...
void lustre_assert_wire_constants(void)
{
	 ...
	 * running on Linux lustre1.localdomain 2.6.32-220.17.1.el6_lustre.x86_64 #1 SMP Mon May 28 2
	...
	LASSERTF(FID_OID_DOT_LUSTRE == 1, "found %lld\n",
		 (long long)FID_OID_DOT_LUSTRE);
	LASSERTF(FID_OID_DOT_LUSTRE_OBF == 2, "found %lld\n",
		 (long long)FID_OID_DOT_LUSTRE_OBF);
	...
	LASSERTF(OBD_CONNECT_NANOSECOND_TIMES == 0x200000000000ULL, "found 0x%.16llxULL\n",
	...
	LASSERTF((int)offsetof(struct obdo, o_mtime_ns) == 184, "found %lld\n",
		 (long long)(int)offsetof(struct obdo, o_mtime_ns));
	LASSERTF((int)sizeof(((struct obdo *)0)->o_mtime_ns) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct obdo *)0)->o_mtime_ns));
	LASSERTF((int)offsetof(struct obdo, o_atime_ns) == 188, "found %lld\n",
		 (long long)(int)offsetof(struct obdo, o_atime_ns));
	LASSERTF((int)sizeof(((struct obdo *)0)->o_atime_ns) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct obdo *)0)->o_atime_ns));
	LASSERTF((int)offsetof(struct obdo, o_ctime_ns) == 192, "found %lld\n",
		 (long long)(int)offsetof(struct obdo, o_ctime_ns));
	LASSERTF((int)sizeof(((struct obdo *)0)->o_ctime_ns) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct obdo *)0)->o_ctime_ns));
	...
	LASSERTF((int)offsetof(struct mdt_body, mtime_ns) == 172, "found %lld\n",
		 (long long)(int)offsetof(struct mdt_body, mtime_ns));
	LASSERTF((int)sizeof(((struct mdt_body *)0)->mtime_ns) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct mdt_body *)0)->mtime_ns));
	LASSERTF((int)offsetof(struct mdt_body, atime_ns) == 176, "found %lld\n",
		 (long long)(int)offsetof(struct mdt_body, atime_ns));
	LASSERTF((int)sizeof(((struct mdt_body *)0)->atime_ns) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct mdt_body *)0)->atime_ns));
	LASSERTF((int)offsetof(struct mdt_body, ctime_ns) == 180, "found %lld\n",
		 (long long)(int)offsetof(struct mdt_body, ctime_ns));
	LASSERTF((int)sizeof(((struct mdt_body *)0)->ctime_ns) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct mdt_body *)0)->ctime_ns));
	...
	LASSERTF((int)offsetof(struct mdt_rec_setattr, sa_ctime_ns) == 124, "found %lld\n",
		 (long long)(int)offsetof(struct mdt_rec_setattr, sa_ctime_ns));
	LASSERTF((int)sizeof(((struct mdt_rec_setattr *)0)->sa_ctime_ns) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct mdt_rec_setattr *)0)->sa_ctime_ns));
	LASSERTF((int)offsetof(struct mdt_rec_setattr, sa_atime_ns) == 128, "found %lld\n",
		 (long long)(int)offsetof(struct mdt_rec_setattr, sa_atime_ns));
	LASSERTF((int)sizeof(((struct mdt_rec_setattr *)0)->sa_atime_ns) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct mdt_rec_setattr *)0)->sa_atime_ns));
	LASSERTF((int)offsetof(struct mdt_rec_setattr, sa_mtime_ns) == 132, "found %lld\n",
		 (long long)(int)offsetof(struct mdt_rec_setattr, sa_mtime_ns));
	LASSERTF((int)sizeof(((struct mdt_rec_setattr *)0)->sa_mtime_ns) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct mdt_rec_setattr *)0)->sa_mtime_ns));
	...
	LASSERTF((int)offsetof(struct mdt_rec_create, cr_time_ns) == 132, "found %lld\n",
		 (long long)(int)offsetof(struct mdt_rec_create, cr_time_ns));
	LASSERTF((int)sizeof(((struct mdt_rec_create *)0)->cr_time_ns) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct mdt_rec_create *)0)->cr_time_ns));
	...
	LASSERTF((int)offsetof(struct mdt_rec_link, lk_time_ns) == 132, "found %lld\n",
		 (long long)(int)offsetof(struct mdt_rec_link, lk_time_ns));
	LASSERTF((int)sizeof(((struct mdt_rec_link *)0)->lk_time_ns) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct mdt_rec_link *)0)->lk_time_ns));
	...
	LASSERTF((int)offsetof(struct mdt_rec_unlink, ul_time_ns) == 132, "found %lld\n",
		 (long long)(int)offsetof(struct mdt_rec_unlink, ul_time_ns));
	LASSERTF((int)sizeof(((struct mdt_rec_unlink *)0)->ul_time_ns) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct mdt_rec_unlink *)0)->ul_time_ns));
	...
	LASSERTF((int)offsetof(struct mdt_rec_rename, rn_time_ns) == 132, "found %lld\n",
		 (long long)(int)offsetof(struct mdt_rec_rename, rn_time_ns));
	LASSERTF((int)sizeof(((struct mdt_rec_rename *)0)->rn_time_ns) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct mdt_rec_rename *)0)->rn_time_ns));
	...
	LASSERTF((int)offsetof(struct mdt_rec_setxattr, sx_time_ns) == 132, "found %lld\n",
		 (long long)(int)offsetof(struct mdt_rec_setxattr, sx_time_ns));
	LASSERTF((int)sizeof(((struct mdt_rec_setxattr *)0)->sx_time_ns) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct mdt_rec_setxattr *)0)->sx_time_ns));
	...
	LASSERTF((int)offsetof(struct mdt_rec_reint, rr_ctime_ns) == 124, "found %lld\n",
		 (long long)(int)offsetof(struct mdt_rec_reint, rr_ctime_ns));
	LASSERTF((int)sizeof(((struct mdt_rec_reint *)0)->rr_ctime_ns) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct mdt_rec_reint *)0)->rr_ctime_ns));
	LASSERTF((int)offsetof(struct mdt_rec_reint, rr_atime_ns) == 128, "found %lld\n",
		 (long long)(int)offsetof(struct mdt_rec_reint, rr_atime_ns));
	LASSERTF((int)sizeof(((struct mdt_rec_reint *)0)->rr_atime_ns) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct mdt_rec_reint *)0)->rr_atime_ns));
	LASSERTF((int)offsetof(struct mdt_rec_reint, rr_mtime_ns) == 132, "found %lld\n",
		 (long long)(int)offsetof(struct mdt_rec_reint, rr_mtime_ns));
	LASSERTF((int)sizeof(((struct mdt_rec_reint *)0)->rr_mtime_ns) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct mdt_rec_reint *)0)->rr_mtime_ns));
