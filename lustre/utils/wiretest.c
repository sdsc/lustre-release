...
void lustre_assert_wire_constants(void)
{
	...
	LASSERTF((int)offsetof(struct som_attrs, som_pad) == 4, "found %lld\n",
		 (long long)(int)offsetof(struct som_attrs, som_pad));
	LASSERTF((int)sizeof(((struct som_attrs *)0)->som_pad) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct som_attrs *)0)->som_pad));
