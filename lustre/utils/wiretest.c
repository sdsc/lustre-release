...
void lustre_assert_wire_constants(void)
{
	...
	LASSERTF((int)sizeof(struct object_update) == 56, "found %lld\n",
	...
	LASSERTF((int)offsetof(struct object_update, ou_lens) == 42, "found %lld\n",
		 (long long)(int)offsetof(struct object_update, ou_lens));
	LASSERTF((int)sizeof(((struct object_update *)0)->ou_lens) == 14, "found %lld\n",
		 (long long)(int)sizeof(((struct object_update *)0)->ou_lens));
	LASSERTF((int)offsetof(struct object_update, ou_bufs) == 56, "found %lld\n",
