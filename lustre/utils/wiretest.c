...
void lustre_assert_wire_constants(void)
{
        ...
        LASSERTF(MDS_LAST_OPC == 56, "found %lld\n",
        ...
        LASSERTF((int)sizeof(struct hsm_attrs) == 32, "found %lld\n",
	...
	LASSERTF((int)sizeof(((struct ptlrpc_body_v3 *)0)->pb_padding) == (int)sizeof(((struct ptlrpc_body_v2 *)0)->pb_padding), "%d != %d\n",
        ...
        LASSERTF((int)offsetof(struct hsm_state_set, hss_archive_num) == 4, "found %lld\n",
