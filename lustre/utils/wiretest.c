...
void lustre_assert_wire_constants(void)
{
        ...
        LASSERTF((int)offsetof(struct changelog_rec, cr_spfid) == 64, "found %lld\n",
                 (long long)(int)offsetof(struct changelog_rec, cr_spfid));
        LASSERTF((int)sizeof(((struct changelog_rec *)0)->cr_spfid) == 16, "found %lld\n",
                 (long long)(int)sizeof(((struct changelog_rec *)0)->cr_spfid));
