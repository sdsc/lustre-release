...
void lustre_assert_wire_constants(void)
{
        ...
        LASSERTF((int)offsetof(struct obdo, o_layout_gen) == 176, " found %lld\n",
                 (long long)(int)offsetof(struct obdo, o_layout_gen));
        LASSERTF((int)sizeof(((struct obdo *)0)->o_layout_gen) == 2, " found %lld\n",
                 (long long)(int)sizeof(((struct obdo *)0)->o_layout_gen));
        LASSERTF((int)offsetof(struct obdo, o_padding_1) == 178, " found %lld\n",
                 (long long)(int)offsetof(struct obdo, o_padding_1));
        LASSERTF((int)sizeof(((struct obdo *)0)->o_padding_1) == 2, " found %lld\n",
                 (long long)(int)sizeof(((struct obdo *)0)->o_padding_1));
        LASSERTF((int)offsetof(struct obdo, o_padding_3) == 180, " found %lld\n",
