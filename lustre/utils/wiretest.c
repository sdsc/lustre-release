...
void lustre_assert_wire_constants(void)
{
	...
	LASSERTF((int)sizeof(struct lfsck_request) == 80, "found %lld\n",
	...
	LASSERTF((int)offsetof(struct lfsck_request, lr_seq) == 48, "found %lld\n",
	...
	LASSERTF((int)offsetof(struct lfsck_request, lr_padding_1) == 56, "found %lld\n",
	...
	LASSERTF((int)offsetof(struct lfsck_request, lr_padding_2) == 64, "found %lld\n",
	...
	LASSERTF((int)offsetof(struct lfsck_request, lr_padding_3) == 72, "found %lld\n",
