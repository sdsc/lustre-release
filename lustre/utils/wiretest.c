...
void lustre_assert_wire_constants(void)
{
         ...
         * running on Linux RHEL6-nasf-CSW 2.6.32-220.el6-lustre #1 SMP Wed Feb 15 05:31:49 CST 2012 
        ...
        LASSERTF(OBD_CONNECT_PACKAGED_XATTR == 0x100000000000ULL, "found 0x%.16llxULL\n",
