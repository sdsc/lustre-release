...
void lustre_assert_wire_constants(void)
{
	  ...
	  * running on Linux mds 3.10.0-229.4.2.el7.centos.x86_64.debug #1 SMP Thu Jun 4 13:47:41 EDT 
	  * with gcc version 4.8.3 20140911 (Red Hat 4.8.3-9) (GCC)  */
	...
	/* Checks for struct nodemap_rec */
	LASSERTF((int)sizeof(struct nodemap_rec) == 32, "found %lld\n",
		 (long long)(int)sizeof(struct nodemap_rec));
