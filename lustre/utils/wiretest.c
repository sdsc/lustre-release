...
void lustre_assert_wire_constants(void)
{
	...
	LASSERTF((int)offsetof(struct obd_connect_data, ocd_maxinflight) == 72, "found %lld\n",
		 (long long)(int)offsetof(struct obd_connect_data, ocd_maxinflight));
	LASSERTF((int)sizeof(((struct obd_connect_data *)0)->ocd_maxinflight) == 8, "found %lld\n",
		 (long long)(int)sizeof(((struct obd_connect_data *)0)->ocd_maxinflight));
