...
void lustre_assert_wire_constants(void)
{
	...
	LASSERTF((int)sizeof(struct lmv_mds_md_v1) == 48, "found %lld\n",
	...
	LASSERTF((int)offsetof(struct lmv_mds_md_v1, lmv_padding3) == 28, "found %lld\n",
		 (long long)(int)offsetof(struct lmv_mds_md_v1, lmv_padding3));
	LASSERTF((int)sizeof(((struct lmv_mds_md_v1 *)0)->lmv_padding3) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct lmv_mds_md_v1 *)0)->lmv_padding3));
	LASSERTF((int)offsetof(struct lmv_mds_md_v1, lmv_pool_name[16]) == 48, "found %lld\n",
	...
	LASSERTF((int)offsetof(struct lmv_mds_md_v1, lmv_stripe_fids[0]) == 48, "found %lld\n",
