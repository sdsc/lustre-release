...
void lustre_assert_ioctl_constants(void)
{
	...
	/* FSFILT IOCTL */
	LASSERTF(FSFILT_IOC_GETFLAGS == 0x80086601UL, "found 0x%.8xUL\n",
		(unsigned)FSFILT_IOC_GETFLAGS);
	LASSERTF(FSFILT_IOC_SETFLAGS == 0x40086602UL, "found 0x%.8xUL\n",
		(unsigned)FSFILT_IOC_SETFLAGS);
	LASSERTF(FSFILT_IOC_GETVERSION == 0x80086603UL, "found 0x%.8xUL\n",
		(unsigned)FSFILT_IOC_GETVERSION);
	LASSERTF(FSFILT_IOC_SETVERSION == 0x40086604UL, "found 0x%.8xUL\n",
		(unsigned)FSFILT_IOC_SETVERSION);
	LASSERTF(FSFILT_IOC_GETVERSION_OLD == 0x80087601UL, "found 0x%.8xUL\n",
		(unsigned)FSFILT_IOC_GETVERSION_OLD);
	LASSERTF(FSFILT_IOC_SETVERSION_OLD == 0x40087602UL, "found 0x%.8xUL\n",
		(unsigned)FSFILT_IOC_SETVERSION_OLD);

	/* LL IOCTL */
	LASSERTF(LL_IOC_GETFLAGS == 0x80086697UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_GETFLAGS);
	LASSERTF(LL_IOC_SETFLAGS == 0x40086698UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_SETFLAGS);
	LASSERTF(LL_IOC_CLRFLAGS == 0x40086699UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_CLRFLAGS);
	LASSERTF(LL_IOC_LOV_SETSTRIPE == 0x4008669aUL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_LOV_SETSTRIPE);
	LASSERTF(LL_IOC_LOV_GETSTRIPE == 0x4008669bUL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_LOV_GETSTRIPE);
	LASSERTF(LL_IOC_LOV_SETEA == 0x4008669cUL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_LOV_SETEA);
	LASSERTF(LL_IOC_GROUP_LOCK == 0x4008669eUL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_GROUP_LOCK);
	LASSERTF(LL_IOC_GROUP_UNLOCK == 0x4008669fUL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_GROUP_UNLOCK);
	LASSERTF(LL_IOC_FLUSHCTX == 0x400866a6UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_FLUSHCTX);
	LASSERTF(LL_IOC_GETOBDCOUNT == 0x800866a8UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_GETOBDCOUNT);
	LASSERTF(LL_IOC_LLOOP_ATTACH == 0xc00866a9UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_LLOOP_ATTACH);
	LASSERTF(LL_IOC_LLOOP_DETACH == 0xc00866aaUL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_LLOOP_DETACH);
	LASSERTF(LL_IOC_LLOOP_INFO == 0xc01066abUL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_LLOOP_INFO);
	LASSERTF(LL_IOC_LLOOP_DETACH_BYDEV == 0xc00866acUL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_LLOOP_DETACH_BYDEV);
	LASSERTF(LL_IOC_PATH2FID == 0x800866adUL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_PATH2FID);
	LASSERTF(LL_IOC_GET_CONNECT_FLAGS == 0xc00866aeUL, "found 0x%.8xUL\n",
	...
	LASSERTF(LL_IOC_HSM_COPY_START == 0x400866d6UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_HSM_COPY_START);
	LASSERTF(LL_IOC_HSM_COPY_END == 0x400866d7UL, "found 0x%.8xUL\n",
	...
	LASSERTF(LL_IOC_SET_LEASE == 0xc00866f3UL, "found 0x%.8xUL\n",
	...
	LASSERTF(LL_IOC_MDC_GETINFO == 0xc0086917UL, "found 0x%.8xUL\n",
		(unsigned)LL_IOC_MDC_GETINFO);

	/* OBD IOCTL */
	LASSERTF(OBD_IOC_CREATE == 0xc0086665UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_CREATE);
	LASSERTF(OBD_IOC_DESTROY == 0x40086668UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_DESTROY);
	LASSERTF(OBD_IOC_SETATTR == 0x4008666bUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_SETATTR);
	LASSERTF(OBD_IOC_GETATTR == 0xc008666cUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_GETATTR);
	LASSERTF(OBD_IOC_READ == 0xc008666dUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_READ);
	LASSERTF(OBD_IOC_WRITE == 0xc008666eUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_WRITE);
	LASSERTF(OBD_IOC_STATFS == 0xc0086671UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_STATFS);
	LASSERTF(OBD_IOC_SYNC == 0x40086672UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_SYNC);
	LASSERTF(OBD_IOC_BRW_READ == 0xc008667dUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_BRW_READ);
	LASSERTF(OBD_IOC_BRW_WRITE == 0xc008667eUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_BRW_WRITE);
	LASSERTF(OBD_IOC_NAME2DEV == 0xc008667fUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_NAME2DEV);
	LASSERTF(OBD_IOC_UUID2DEV == 0xc0086682UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_UUID2DEV);
	LASSERTF(OBD_IOC_GETNAME == 0xc0086683UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_GETNAME);
	LASSERTF(OBD_IOC_GETMDNAME == 0x80806683UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_GETMDNAME);
	LASSERTF(OBD_IOC_GETDTNAME == 0xc0086683UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_GETDTNAME);
	LASSERTF(OBD_IOC_LOV_GET_CONFIG == 0xc0086684UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_LOV_GET_CONFIG);
	LASSERTF(OBD_IOC_CLIENT_RECOVER == 0x40086685UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_CLIENT_RECOVER);
	LASSERTF(OBD_IOC_PING_TARGET == 0x40086688UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_PING_TARGET);
	LASSERTF(OBD_IOC_NO_TRANSNO == 0x4008668cUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_NO_TRANSNO);
	LASSERTF(OBD_IOC_SET_READONLY == 0x4008668dUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_SET_READONLY);
	LASSERTF(OBD_IOC_ABORT_RECOVERY == 0x8008668eUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_ABORT_RECOVERY);
	LASSERTF(OBD_GET_VERSION == 0xc0086690UL, "found 0x%.8xUL\n",
		(unsigned)OBD_GET_VERSION);
	LASSERTF(OBD_IOC_CHANGELOG_SEND == 0x40086694UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_CHANGELOG_SEND);
	LASSERTF(OBD_IOC_GETDEVICE == 0xc0086695UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_GETDEVICE);
	LASSERTF(OBD_IOC_FID2PATH == 0xc0086696UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_FID2PATH);
	LASSERTF(OBD_IOC_QUOTACTL == 0xc0b066a2UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_QUOTACTL);
	LASSERTF(OBD_IOC_CHANGELOG_REG == 0x424066b1UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_CHANGELOG_REG);
	LASSERTF(OBD_IOC_CHANGELOG_DEREG == 0x424066b2UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_CHANGELOG_DEREG);
	LASSERTF(OBD_IOC_CHANGELOG_CLEAR == 0x424066b3UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_CHANGELOG_CLEAR);
	LASSERTF(OBD_IOC_PROCESS_CFG == 0xc00866b8UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_PROCESS_CFG);
	LASSERTF(OBD_IOC_PARAM == 0x400866bbUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_PARAM);
	LASSERTF(OBD_IOC_POOL == 0xc00866bcUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_POOL);
	LASSERTF(OBD_IOC_REPLACE_NIDS == 0xc00866bdUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_REPLACE_NIDS);
	LASSERTF(OBD_IOC_CATLOGLIST == 0xc00866beUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_CATLOGLIST);
	LASSERTF(OBD_IOC_LLOG_INFO == 0xc00866bfUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_LLOG_INFO);
	LASSERTF(OBD_IOC_LLOG_PRINT == 0xc00866c0UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_LLOG_PRINT);
	LASSERTF(OBD_IOC_LLOG_CANCEL == 0xc00866c1UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_LLOG_CANCEL);
	LASSERTF(OBD_IOC_LLOG_REMOVE == 0xc00866c2UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_LLOG_REMOVE);
	LASSERTF(OBD_IOC_LLOG_CHECK == 0xc00866c3UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_LLOG_CHECK);
	LASSERTF(OBD_IOC_NODEMAP == 0xc00866c5UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_NODEMAP);
	LASSERTF(OBD_IOC_GET_OBJ_VERSION == 0x800866d2UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_GET_OBJ_VERSION);
	LASSERTF(OBD_IOC_ECHO_MD == 0x824066ddUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_ECHO_MD);
	LASSERTF(OBD_IOC_ECHO_ALLOC_SEQ == 0xc24066deUL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_ECHO_ALLOC_SEQ);
	LASSERTF(OBD_IOC_START_LFSCK == 0xc00866e6UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_START_LFSCK);
	LASSERTF(OBD_IOC_STOP_LFSCK == 0x400866e7UL, "found 0x%.8xUL\n",
		(unsigned)OBD_IOC_STOP_LFSCK);
	LASSERTF(OBD_IOC_QUERY_LFSCK == 0x824066e8UL, "found 0x%.8xUL\n",
