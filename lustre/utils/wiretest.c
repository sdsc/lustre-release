...
void lustre_assert_wire_constants(void)
{
	...
	LASSERTF(OSS_REPLY == 0, "found %lld\n",
		 (long long)OSS_REPLY);
	...
	LASSERTF(OSS_PUNCH == 10, "found %lld\n",
		 (long long)OSS_PUNCH);
	LASSERTF(OSS_OPEN == 11, "found %lld\n",
		 (long long)OSS_OPEN);
	LASSERTF(OSS_CLOSE == 12, "found %lld\n",
		 (long long)OSS_CLOSE);
	...
	LASSERTF(OSS_QUOTA_ADJUST_QUNIT == 20, "found %lld\n",
		 (long long)OSS_QUOTA_ADJUST_QUNIT);
	LASSERTF(OSS_LAST_OPC == 21, "found %lld\n",
