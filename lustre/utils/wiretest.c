...
void lustre_assert_wire_constants(void)
{
	...
	LASSERTF((int)sizeof(((struct ladvise_hdr *)0)->lah_flags) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct ladvise_hdr *)0)->lah_flags));
	LASSERTF((int)offsetof(struct ladvise_hdr, lah_padding) == 12, "found %lld\n",
		 (long long)(int)offsetof(struct ladvise_hdr, lah_padding));
	LASSERTF((int)sizeof(((struct ladvise_hdr *)0)->lah_padding) == 20, "found %lld\n",
