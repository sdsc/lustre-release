...
void lustre_assert_wire_constants(void)
{
	...
	LASSERTF((int)sizeof(struct hsm_user_import) == 40, "found %lld\n",
	...
	LASSERTF((int)offsetof(struct hsm_user_import, hui_uid) == 8, "found %lld\n",
	...
	LASSERTF((int)offsetof(struct hsm_user_import, hui_gid) == 12, "found %lld\n",
	...
	LASSERTF((int)offsetof(struct hsm_user_import, hui_mode) == 16, "found %lld\n",
	...
	LASSERTF((int)offsetof(struct hsm_user_import, hui_atime) == 20, "found %lld\n",
		 (long long)(int)offsetof(struct hsm_user_import, hui_atime));
	LASSERTF((int)sizeof(((struct hsm_user_import *)0)->hui_atime) == 4, "found %lld\n",
	...
	LASSERTF((int)offsetof(struct hsm_user_import, hui_mtime) == 28, "found %lld\n",
		 (long long)(int)offsetof(struct hsm_user_import, hui_mtime));
	LASSERTF((int)sizeof(((struct hsm_user_import *)0)->hui_mtime) == 4, "found %lld\n",
		 (long long)(int)sizeof(((struct hsm_user_import *)0)->hui_mtime));
	LASSERTF((int)offsetof(struct hsm_user_import, hui_mtime_ns) == 32, "found %lld\n",
	...
	LASSERTF((int)offsetof(struct hsm_user_import, hui_archive_id) == 36, "found %lld\n",
