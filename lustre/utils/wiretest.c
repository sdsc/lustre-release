...
void lustre_assert_wire_constants(void)
{
         ...
         * running on Linux RHEL5-nasf-CSW 2.6.18-238.9.1 #1 SMP Fri May 20 21:07:56 CST 2011 i686 i6
        ...
        LASSERTF(OBD_STATFS_NODELAY == 0x00000001UL, "found 0x%.8xUL\n",
                 OBD_STATFS_NODELAY);
        LASSERTF(OBD_STATFS_FROM_CACHE == 0x00000002UL, "found 0x%.8xUL\n",
                 OBD_STATFS_FROM_CACHE);
        LASSERTF(OBD_STATFS_PTLRPCD == 0x00000004UL, "found 0x%.8xUL\n",
                 OBD_STATFS_PTLRPCD);
        ...
        LASSERTF(MGS_LAST_OPC == 256, "found %lld\n",
        ...
        LASSERTF(FMODE_READ == 000000000001UL, "found 0%.11oUL\n",
                 FMODE_READ);
        LASSERTF(FMODE_WRITE == 000000000002UL, "found 0%.11oUL\n",
                 FMODE_WRITE);
        LASSERTF(FMODE_EPOCH == 000001000000UL, "found 0%.11oUL\n",
                 FMODE_EPOCH);
        LASSERTF(FMODE_TRUNC == 000002000000UL, "found 0%.11oUL\n",
                 FMODE_TRUNC);
        LASSERTF(FMODE_SOM == 000004000000UL, "found 0%.11oUL\n",
                 FMODE_SOM);
        LASSERTF(FMODE_CLOSED == 000000000000UL, "found 0%.11oUL\n",
                 FMODE_CLOSED);
        ...
        LASSERTF((int)sizeof(struct mdt_remote_perm) == 28, "found %lld\n",
        ...
        LASSERTF((int)sizeof(struct md_fld) == 12, "found %lld\n",
        ...
        LASSERTF(OBD_FL_TRUNC == (0x0000200000000000ULL), "found 0x%.16llxULL\n",
                 OBD_FL_TRUNC);
        ...
        CLASSERT(OBD_FL_CKSUM_RSVD1 == 0x00004000);
