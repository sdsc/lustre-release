...
void lustre_assert_wire_constants(void)
{
	...
	LASSERTF((int)offsetof(struct lfsck_request, lr_padding_1) == 26, "found %lld\n",
		 (long long)(int)offsetof(struct lfsck_request, lr_padding_1));
	LASSERTF((int)sizeof(((struct lfsck_request *)0)->lr_padding_1) == 2, "found %lld\n",
		 (long long)(int)sizeof(((struct lfsck_request *)0)->lr_padding_1));
	LASSERTF((int)offsetof(struct lfsck_request, lr_padding_2) == 28, "found %lld\n",
