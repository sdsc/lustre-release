...
void lustre_assert_wire_constants(void)
{
	...
	LASSERTF((int)offsetof(struct hsm_user_import, hui_uid) == 0, "found %lld\n",
	...
	LASSERTF((int)offsetof(struct hsm_user_import, hui_gid) == 4, "found %lld\n",
	...
	LASSERTF((int)offsetof(struct hsm_user_import, hui_mode) == 8, "found %lld\n",
	...
	LASSERTF((int)offsetof(struct hsm_user_import, hui_size) == 16, "found %lld\n",
	...
	LASSERTF((int)offsetof(struct hsm_user_import, hui_atime) == 24, "found %lld\n",
	...
	LASSERTF((int)offsetof(struct hsm_user_import, hui_mtime) == 32, "found %lld\n",
	...
	LASSERTF((int)offsetof(struct hsm_user_import, hui_archive_id) == 40, "found %lld\n",
