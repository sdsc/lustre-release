 ...
 */
int lnet_config_route(struct kvl_s *params)
{
	struct kvl_s *net;
	struct kvl_s *gw;
	struct kvl_s *prio;
 ...
 *   Call the API to configure a route
 */
int lnet_config_net(struct kvl_s *params)
{
	struct kvl_s *net, *intf, *peer_to,
	      *peer_cr, *peer_buf_cr, *smp_param, *credits;
 ...
 */
int lnet_config_enable_routing(struct kvl_s *params)
{
	cYAML *err_rc = NULL;
	int rc;
 ...
 *   calls into the Lustre API to enable routing
 */
int lnet_config_disable_routing(struct kvl_s *params)
{
	cYAML *err_rc = NULL;
	int rc;
 ...
 *   Call the API to configure a route
 */
int lnet_config_buf(struct kvl_s *params)
{
	struct kvl_s *tiny, *small, *large;
 ...
 *   Call the API to configure a route
 */
int lnet_del_route(struct kvl_s *params)
{
	struct kvl_s *net;
	struct kvl_s *gw;
	cYAML *err_rc = NULL;
 ...
 *   Call the API to configure a route
 */
int lnet_del_net(struct kvl_s *params)
{
	struct kvl_s *net;
	cYAML *err_rc = NULL;
	int rc;
 ...
 *   Call the API to configure a route
 */
int lnet_del_buf(struct kvl_s *params)
{
	cYAML *err_rc = NULL;
	int rc;
 ...
 *   Call the API to configure a route
 */
int lnet_show_route(struct kvl_s *params)
{
	struct kvl_s *net;
	struct kvl_s *gw;
	struct kvl_s *prio;
 ...
 *   Call the API to configure a route
 */
int lnet_show_net(struct kvl_s *params)
{
	struct kvl_s *net;
	struct kvl_s *detail;
	int rc;
 ...
 *   Call the API to configure a route
 */
int lnet_show_buf(struct kvl_s *params)
{
	int rc;
	cYAML *show_rc = NULL, *err_rc = NULL;
 ...
 */
int lnet_config_file(struct kvl_s *params)
{
	struct kvl_s *file;
	int rc;
	cYAML *err_rc = NULL;
 ...
 *   calls into the Lustre API to configure entities specified in the file
 */
int lnet_del_file(struct kvl_s *params)
{
	struct kvl_s *file;
	int rc;
	cYAML *err_rc = NULL;
 ...
 *   calls into the Lustre API to configure entities specified in the file
 */
int lnet_show_file(struct kvl_s *params)
{
	struct kvl_s *file;
	int rc;
	cYAML *show_rc = NULL, *err_rc = NULL;
...
int lnet_show_stats(struct kvl_s *params)
{
	int rc;
	cYAML *show_rc = NULL, *err_rc = NULL;
