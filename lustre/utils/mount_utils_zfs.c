...
#define LDD_VERSION_PROP                LDD_PROP_PREFIX "version"
#define LDD_FLAGS_PROP                  LDD_PROP_PREFIX "flags"
#define LDD_INDEX_PROP                  LDD_PROP_PREFIX "index"
#define LDD_FSNAME_PROP                 LDD_PROP_PREFIX "fsname"
#define LDD_SVNAME_PROP                 LDD_PROP_PREFIX "svname"
#define LDD_UUID_PROP                   LDD_PROP_PREFIX "uuid"
#define LDD_USERDATA_PROP               LDD_PROP_PREFIX "userdata"
#define LDD_MOUNTOPTS_PROP              LDD_PROP_PREFIX "mountopts"
