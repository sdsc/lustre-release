...
static int ct_parseopts(int argc, char * const *argv)
{
	...
	{ .name = "abort-on-error",  .has_arg = no_argument,	   .val = 1,
	  .flag = &opt.o_abort_on_error },
	{ .name = "abort_on_error",  .has_arg = no_argument,	   .val = 1,
	  .flag = &opt.o_abort_on_error },
	{ .name = "archive",	     .has_arg = required_argument, .val = 'A' },
	{ .name = "bandwidth",	     .has_arg = required_argument, .val = 'b' },
	{ .name = "chunk-size",	     .has_arg = required_argument, .val = 'c' },
	{ .name = "chunk_size",	     .has_arg = required_argument, .val = 'c' },
	{ .name = "daemon",	     .has_arg = no_argument,	   .val = 1,
	  .flag = &opt.o_daemonize },
	{ .name = "event-fifo",	     .has_arg = required_argument, .val = 'f' },
	{ .name = "event_fifo",	     .has_arg = required_argument, .val = 'f' },
	{ .name = "dry-run",	     .has_arg = no_argument,	   .val = 1,
	  .flag = &opt.o_dry_run },
	{ .name = "help",	     .has_arg = no_argument,	   .val = 'h' },
	{ .name = "import",	     .has_arg = no_argument,	   .val = 'i' },
	{ .name = "max-sequence",    .has_arg = no_argument,	   .val = 'M' },
	{ .name = "max_sequence",    .has_arg = no_argument,	   .val = 'M' },
	{ .name = "no-attr",	     .has_arg = no_argument,
	  .flag = &opt.o_copy_attrs },
	{ .name = "no_attr",	     .has_arg = no_argument,
	  .flag = &opt.o_copy_attrs },
	{ .name = "no-shadow",	     .has_arg = no_argument,
	  .flag = &opt.o_shadow_tree },
	{ .name = "no_shadow",	     .has_arg = no_argument,
	  .flag = &opt.o_shadow_tree },
	{ .name = "no-xattr",	     .has_arg = no_argument,
	  .flag = &opt.o_copy_xattrs },
	{ .name = "no_xattr",	     .has_arg = no_argument,
	  .flag = &opt.o_copy_xattrs },
	{ .name = "hsm-root",	     .has_arg = required_argument, .val = 'p' },
	{ .name = "hsm_root",	     .has_arg = required_argument, .val = 'p' },
	{ .name = "quiet",	     .has_arg = no_argument,	   .val = 'q' },
	{ .name = "rebind",	     .has_arg = no_argument,	   .val = 'r' },
	{ .name = "update-interval", .has_arg = required_argument, .val = 'u' },
	{ .name = "update_interval", .has_arg = required_argument, .val = 'u' },
