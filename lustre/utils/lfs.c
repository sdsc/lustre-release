...
command_t cmdlist[] = {
        {"setstripe", lfs_setstripe, 0,
         ...
         "usage: setstripe [--stripe-count|-c <stripe-count>]\n"
         "                 [--stripe-index|--ost-index|-i <start_ost_idx>]\n"
        ...
        {"getstripe", lfs_getstripe, 0,
         ...
         "                 [--stripe-count|-c] [--stripe-index|--ost-index|-i]\n"
...
#endif
                {"ost-index",    required_argument, 0, 'o'},
                {"ost_index",    required_argument, 0, 'o'},
...
#warning "remove deprecated --count option"
                ...
                case 'o':
                        ...
                        fprintf(stderr, "warning: '--offset|-o' deprecated, "
                                "use '--ost-index|-i' instead\n");
#else
                        if (strcmp(argv[optind - 1], "--offset") == 0)
                                /* need to get --ost-index established first */
