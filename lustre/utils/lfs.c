...
command_t cmdlist[] = {
	...
	{"setdirstripe", lfs_setdirstripe, 0,
	 "To create a new directory with a specific striping pattern, only\n"
	 "support --index now.\n"
	...
	{"rm_entry", lfs_rmentry, 0,
	 "To remove the name entry of the remote directory. Note:This command\n"
	 "will only delete the name entry, i.e. the remote directory will\n"
	 "become an orphan after this command. This can only be done on MDT0\n"
	 "by administrator\n"
	 "usage: rm_entry <dir>\n"},
...
static int lfs_getdirstripe(int argc, char **argv)
{
	...
	fprintf(stderr, "Do not support lfs getdirstripe yet!: rc = %d\n",
		-ENOTSUPP);
	return -ENOTSUPP;
...
static int lfs_setdirstripe(int argc, char **argv)
{
	...
	fprintf(stderr, "Do not support lfs mkdir yet!: rc = %d\n",
		-ENOTSUPP);
	return -ENOTSUPP;
	...
	do {
		result = llapi_remote_dir_create(dname, flags, st_offset);
		if (result) {
...
static int lfs_rmentry(int argc, char **argv)
{
	...
	fprintf(stderr, "Do not support lfs rmdir yet!: rc = %d\n",
		-ENOTSUPP);
	return -ENOTSUPP;
