 ...
 *
 * This file includes helper functions for accessing Lustre-specific
 * functionality from a client or server.  This abstracts usage of Lustre-
 * specific ioctls, /proc files, etc. from appilcations and reduces the
 * incidence of application incompatibility if changes are made to Lustre.
 *
