...
static void info_callback_default(int level, int errcode, const char *fmt,
				  va_list ap)
{
...
static llapi_log_cb_t llapi_info_callback = info_callback_default;
...
void llapi_error(int level, int rc, const char *fmt, ...)
{
	...
	va_start(args, fmt);
	llapi_error_callback(level, abs(rc), fmt, args);
	va_end(args);
	errno = tmp_errno;
}
 ...
 */
llapi_log_cb_t llapi_msg_error_callback_set(llapi_log_cb_t cb)
{
	llapi_log_cb_t	old = llapi_error_callback;
 ...
 * This function returns the value of the old callback.
 */
llapi_log_cb_t llapi_msg_info_callback_set(llapi_log_cb_t cb)
{
	llapi_log_cb_t	old = llapi_info_callback;
