 ...
 */
/*
 * TODO This causes a compile error on some build machines.  Since the
 * emitter is not being used in lustre right now.  Commenting it out to
 * get the build going and the inspection started
...
#define WRITE_BREAK(emitter,string) 1
