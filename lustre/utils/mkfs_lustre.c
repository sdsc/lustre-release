	       ...
	       char **mountopts)
{
	static struct option long_opt[] = {
		{ .name = "backfs-mount-opts", .has_arg = required_argument,
		  .val = 'B' },
		{ .name = "failnode", .has_arg = required_argument,
		  .val = 'f' },
		{ .name = "failover", .has_arg = required_argument,
		  .val = 'f' },
		...
		{ .name = "mountfsoptions", .has_arg = required_argument,
		  .val = 'o' },
		{ .name = "param", .has_arg = required_argument, .val = 'p' },
		{ .name = "quiet", .has_arg = no_argument, .val = 'q' },
		{ .name = "servicenode", .has_arg = required_argument,
		  .val = 's' },
		{ .name = "network", .has_arg = required_argument, .val = 't' },
		{ .name = "comment", .has_arg = required_argument, .val = 'u' },
		{ .name = "force-nohostid", .has_arg = no_argument,
		  .val = 'U' },
		{ .name = "verbose", .has_arg = no_argument, .val = 'v' },
		{ .name = "version", .has_arg = no_argument, .val = 'V' },
#ifndef TUNEFS
		{ .name = "backfstype", .has_arg = required_argument,
		  .val = 'b' },
		{ .name = "stripe-count-hint", .has_arg = required_argument,
		  .val = 'c' },
		{ .name = "device-size", .has_arg = required_argument,
		  .val = 'd' },
		{ .name = "mgs", .has_arg = no_argument, .val = 'G' },
		{ .name = "mkfsoptions", .has_arg = required_argument,
		  .val = 'k' },
