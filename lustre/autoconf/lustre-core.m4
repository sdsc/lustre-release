...
#
AC_DEFUN([LC_HAVE_SECURITY_IINITSEC_CALLBACK],
[AC_MSG_CHECKING([if security_inode_init_security takes a callback to set xattrs])
LB_LINUX_TRY_COMPILE([
...
==============================================================================])
	...
	LC_HAVE_VOID_MAKE_REQUEST_FN
	LC_HAVE_PROTECT_I_NLINK
	LC_HAVE_SECURITY_IINITSEC_CALLBACK
