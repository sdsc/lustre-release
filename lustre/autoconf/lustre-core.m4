...
EXTRA_KCFLAGS="-I$LINUX/fs"
        LB_LINUX_TRY_COMPILE([
			...
			ERR="`find /var/lib/jenkins/workspace/lustre-reviews/arch/i686/build_type/server/distro/el6/ib_stack/inkernel/BUILD/reused/usr/src/kernels/2.6.32-279.19.1.el6_lustre.ge7838ff.i686/include -print`"
			AC_MSG_WARN($ERR)
			ERR="`find /var/lib/jenkins/workspace/lustre-reviews/arch/i686/build_type/server/distro/el6/ib_stack/inkernel/BUILD/reused/usr/src/kernels/2.6.32-279.19.1.el6_lustre.ge7838ff.i686/fs -print`"
			AC_MSG_WARN($ERR)
			ERR="`cat config.log`"
			AC_MSG_WARN($ERR)
