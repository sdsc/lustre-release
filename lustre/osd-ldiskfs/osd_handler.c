...
#if defined(EXT3_FEATURE_INCOMPAT_EA_INODE)
        if (EXT3_HAS_INCOMPAT_FEATURE(sb, EXT3_FEATURE_INCOMPAT_EA_INODE))
                param->ddp_max_ea_size = EXT3_XATTR_MAX_LARGE_EA_SIZE;
        else
#endif
