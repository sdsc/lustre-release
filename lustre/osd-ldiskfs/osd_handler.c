				    ...
				    __u32 ino, struct osd_thandle *oh)
{
	...
	inode = osd_iget(oti, osd, id, true);
	if (IS_ERR(inode)) {
...
#define LUDA_VISIBILITY_MASK (LUDA_VERIFY | LUDA_VERIFY_DRYRUN | LUDA_REPAIR | \
			      LUDA_UPGRADE | LUDA_IGNORE | LUDA_LOST_FOUND)
