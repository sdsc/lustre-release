			     ...
			     struct osd_object *obj, struct osd_thandle *oh)
{
	...
	rc = osd_ldiskfs_add_entry(osd, info, oh->ot_handle, dentry,
				   obj->oo_inode, NULL);
			     ...
			     handle_t *th)
{
	...
	rc = osd_ldiskfs_add_entry(osd, info, th, child,
				   inode, NULL);
			...
			const struct lu_fid *fid)
{
	...
	rc = osd_ldiskfs_add_entry(osd, info, jh, tgt_child, inode, NULL);
