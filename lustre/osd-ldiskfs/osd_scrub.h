...
struct osd_scrub {
        ...
        /* Point to ooi_oic or some inconsistent item.*/
        struct osd_idmap_cache *os_oicp;
        ...
        unsigned int            os_dirty:1, /* scrub file is dirty, should
                                ...
                                os_in_prior:1, /* process inconsistent item
                                                * found by RPC prior */
                                os_waiting:1, /* Waiting for scan window. */
                                os_full_speed:1, /* run w/o speed limit */
                                os_skip_obj:1, /* skip to process current obj */
