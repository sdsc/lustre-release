                                 ...
                                 struct thandle *handle)
{
	...
	osd_trans_declare_op(oh, OSD_OT_WRITE, credits);
                         ...
                         int ignore_quota)
{
	...
	/* osd_trans_exec_op(handle, OSD_OT_WRITE); */
                             ...
                             __u64 start, __u64 end, struct thandle *th)
{
	...
	int		    rc;
         ...
         * transaction
         */
	osd_trans_declare_op(oh, OSD_OT_PUNCH,
                     ...
                     struct lustre_capa *capa)
{
	...
	osd_trans_exec_op(th, OSD_OT_PUNCH);
