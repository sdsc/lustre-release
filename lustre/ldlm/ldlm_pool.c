...
{
	int rc;
	struct shrinker_var shsvar = {
		.count = ldlm_pools_srv_count,
		.scan  = ldlm_pools_srv_scan,
		.shrink= ldlm_pools_srv_shrink
	};
	struct shrinker_var shcvar = {
		.count = ldlm_pools_cli_count,
		.scan  = ldlm_pools_cli_scan,
