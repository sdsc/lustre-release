...
#ifdef __KERNEL__
static int ldlm_pool_state_seq_show(struct seq_file *m, void *unused)
{
...
LPROC_SEQ_FOPS_RO(ldlm_pool_state);

static int ldlm_grant_speed_seq_show(struct seq_file *m, void *unused)
{
	struct ldlm_pool *pl = m->private;
	int               grant_speed;
...
LPROC_SEQ_FOPS_RO(ldlm_grant_speed);

LDLM_POOL_PROC_READER_SEQ_SHOW(grant_plan, int);
LPROC_SEQ_FOPS_RO(ldlm_grant_plan);

LDLM_POOL_PROC_READER_SEQ_SHOW(recalc_period, int);
LDLM_POOL_PROC_WRITER(recalc_period, int);
static ssize_t ldlm_recalc_period_seq_write(struct file *file, const char *buf,
...
LPROC_SEQ_FOPS(ldlm_recalc_period);
...
static int ldlm_pool_proc_init(struct ldlm_pool *pl)
{
	...
	LDLM_POOL_ADD_VAR("grant_speed", pl, &ldlm_grant_speed_fops);
	LDLM_POOL_ADD_VAR("cancel_rate", &pl->pl_cancel_rate,
			  &ldlm_pool_atomic_fops);
	LDLM_POOL_ADD_VAR("grant_rate", &pl->pl_grant_rate,
			  &ldlm_pool_atomic_fops);
	LDLM_POOL_ADD_VAR("grant_plan", pl, &ldlm_grant_plan_fops);
	LDLM_POOL_ADD_VAR("recalc_period", pl, &ldlm_recalc_period_fops);
	LDLM_POOL_ADD_VAR("lock_volume_factor", &pl->pl_lock_volume_factor,
			  &ldlm_pool_rw_atomic_fops);
	LDLM_POOL_ADD_VAR("state", pl, &ldlm_pool_state_fops);
