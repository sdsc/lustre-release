                               ...
                               cfs_hlist_node_t *hnode, void *opaq)
{
	...
	struct ldlm_ns_cleanup_arg *arg  = (struct ldlm_ns_cleanup_arg *)opaq;
        ...
        cleanup_resource(arg->env, res, &res->lr_granted, arg->flags);
        cleanup_resource(arg->env, res, &res->lr_converting, arg->flags);
        cleanup_resource(arg->env, res, &res->lr_waiting, arg->flags);
