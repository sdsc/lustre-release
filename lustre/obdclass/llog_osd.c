                                               ...
                                               struct dt_device *dev)
{
	...
	//lgi->lgi_fid.f_seq = FID_SEQ_LOCAL_FILE;
	lgi->lgi_fid.f_seq = FID_SEQ_LOCAL_NAME;
        lgi->lgi_fid.f_oid = 1;
        lgi->lgi_fid.f_ver = 0;
...
EXPORT_SYMBOL(llog_get_cat_list_2);
...
EXPORT_SYMBOL(llog_put_cat_list_2);
