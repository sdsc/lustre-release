...
static unsigned
gen_hash(cfs_hash_t *hs, const void *key, unsigned mask)
{
...
static void
gen_export_get(cfs_hash_t *hs, struct hlist_node *hnode)
{
	struct obd_export *exp;
...
static void
gen_export_put_locked(cfs_hash_t *hs, struct hlist_node *hnode)
{
	struct obd_export *exp;
