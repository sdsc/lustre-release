...
static cfs_sysctl_table_t obd_table[] = {
		...
		/* The name of this file is a bit misleading, as it has
		 * been modified to limit not only the dirty pages, but
		 * also the unstable pages. Although, for compatibility
		 * purposes, we must not change the user interface */
