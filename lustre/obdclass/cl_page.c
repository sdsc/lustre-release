                         ...
                         enum cl_page_type type, struct cl_page **out)
{
        ...
        ENTRY;
        result = +1;
	OBD_SLAB_ALLOC_PTR_GFP(page, cl_page_kmem, __GFP_IO);
        if (page != NULL) {
 ...
 */
page_t *cl_page_vmpage(const struct lu_env *env, struct cl_page *page)
{
        const struct cl_page_slice *slice;
 ...
 */
struct cl_page *cl_vmpage_page(page_t *vmpage, struct cl_object *obj)
{
	struct cl_page *top;
	struct cl_page *page;
