 ...
 * the whole and fraction portions.
 */
			    ...
			    __u64 *val, __u64 def_mult, bool allow_units)
{
	...
	if (strwhole) {
		rc = kstrtoull(strwhole, 10, &whole);
		if (rc)
			return rc;
...
/*
 * This function parses numeric strings into __s64. It accepts a multiplier
