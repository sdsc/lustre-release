...
#define OSD_ASYNC_DESTROY_MIN_SIZE (1ULL << 30) /* 1G */
				      ...
				      struct thandle *th)
{
	...
	uint64_t		 oid = obj->oo_db->db_object, zapid;
	int			 rc;
	ENTRY;
