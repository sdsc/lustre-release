...
void lustre_print_user_md(int lvl, struct lov_user_md *lum, const char *msg)
{
	...
	if (lum->lmm_magic == LOV_USER_MAGIC_V4) {
		int i = lum->lmm_stripe_count;
...
static void lustre_swab_lov_user_md_common(struct lov_user_md_v1 *lum)
{
	...
	lustre_print_user_md(D_OTHER, lum, "swap");
	EXIT;
}
