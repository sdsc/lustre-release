...
/* NRS */
static inline int
ptlrpc_nrs_svcpt_has_hp(struct ptlrpc_service_part *svcpt)
{
	return svcpt->scp_hpreq_nrs != NULL;
}

static inline struct ptlrpc_nrs *
ptlrpc_svcpt2nrs(struct ptlrpc_service_part *svcpt, __u8 hp)
{
	/* Probably safe to remove this LASSERT() */
	LASSERT(ergo(hp, ptlrpc_nrs_svcpt_has_hp(svcpt)));
	return hp ? svcpt->scp_hpreq_nrs : &svcpt->scp_req_nrs;
}

static inline int
ptlrpc_nrspol2cptid(struct ptlrpc_nrs_policy *policy)
{
	return policy->pol_nrs->nrs_svcpt->scp_cpt;
}

static inline struct ptlrpc_service *
ptlrpc_nrspol2svc(struct ptlrpc_nrs_policy *policy)
{
	return policy->pol_nrs->nrs_svcpt->scp_service;
}

static inline struct ptlrpc_service_part *
ptlrpc_nrspol2svcpt(struct ptlrpc_nrs_policy *policy)
{
...
int ptlrpc_nrs_req_pending_nolock(struct ptlrpc_service_part *svcpt, __u8 hp);
struct ptlrpc_request *ptlrpc_nrs_req_poll_nolock(struct ptlrpc_service_part *svcpt,
						  __u8 hp);
...
int ptlrpc_nrs_policy_control(struct ptlrpc_service_part *svcpt,
