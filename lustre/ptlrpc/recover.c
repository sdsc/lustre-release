...
int ptlrpc_replay_next(struct obd_import *imp, int *inflight)
{
	...
	/* Clear the imp_known_replied_xid, since the XID of replay request
	 * could be lower than the known_replied_xid carried by the connect
	 * or the previous replay request. */
