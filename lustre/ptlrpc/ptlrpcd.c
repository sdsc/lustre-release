...
/*
 * ptlrpcd_partner_group_size defaults to 2, but keeping 0 here
...
static int ptlrpcd_init(void)
{
	...
	if (ptlrpcd_bind_policy != 0) {
		...
		if (ptlrpcd_partner_group_size == 0) {
			...
			CWARN("The ptlrpcd_partner_group_size is also set!\n");
		}
	}
	...
	if (ptlrpcd_partner_group_size == 0)
		...
		ptlrpcd_partner_group_size = -1;
	else if (max_ptlrpcds > 0 && ptlrpcd_partner_group_size > max_ptlrpcds)
