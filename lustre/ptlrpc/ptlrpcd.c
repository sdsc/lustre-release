...
static int ptlrpcd_init(void)
{
         ...
         *      RPCs processed in the same set under some casei(s). Because the
         *      ptlrpcd may be blocked by some async I/O RPC(s), then will cause
         *      other async non-I/O RPC(s) can not be processed in time.
         *
