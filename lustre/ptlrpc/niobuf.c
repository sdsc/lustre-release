...
int ptlrpc_send_reply(struct ptlrpc_request *req, int flags)
{
        ...
        /* In order to keep interoprability with the client which doesn't have
         * pb_jobid in ptlrpc_body, We have to shrink the ptlrpc_body in reply
         * buffer to ptlrpc_body_v2, otherwise, the reply buffer on client will
         * be overflow.
         *
