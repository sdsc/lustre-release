...
static const struct req_msg_field *mdt_extended_close_client[] = {
	&RMF_PTLRPC_BODY,
	&RMF_MDT_EPOCH,
	&RMF_REC_REINT,
	&RMF_CAPA1,
...
struct req_format RQF_MDS_EXTENDED_CLOSE =
	DEFINE_REQ_FMT0("MDS_CLOSE",
			mdt_extended_close_client, mds_last_unlink_server);
EXPORT_SYMBOL(RQF_MDS_EXTENDED_CLOSE);
