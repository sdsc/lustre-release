 ...
 */
#define NRS_ORR_BITS		30
#define NRS_ORR_BKT_BITS	15
			   ...
			   struct ptlrpc_nrs_request *nrq)
{
	...
	if (orro->oo_quantum == 0 || orro->oo_round < orrd->od_round ||
		 ...
		 * of its quantum still remainins unused, which implies we did
		 * not get a chance to schedule up to its maximum allowed batch
		 * size of requests in the previous round this object/OST
