 ...
 *		    stored.
 * \param[in]  moving_req  Is used for getting HP NRS head resources when set;
 *			   it signifies that allocations to get resources should
 *			   be atomic; for a full explanation, see comment in
