...
/*
 * Companion of cl_lsm_get. Release a reference on a lsm, last ref frees it.
 ...
 */
void cl_lsm_put(struct inode *inode, struct lov_stripe_md **lsmp)
{
        struct cl_inode_info *lli = cl_i2info(inode);
        ENTRY;
