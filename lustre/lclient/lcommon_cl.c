 ...
 * callers must release it with cl_object_release.
 *
...
EXPORT_SYMBOL(cl_object_dereference);
...
/**
 * Release cl_object - this must be called after cl_object_hold().
 */
...
EXPORT_SYMBOL(cl_object_layout_change);
