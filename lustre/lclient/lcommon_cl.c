...
page_t *ccc_page_vmpage(const struct lu_env *env,
...
page_t *cl2vm_page(const struct cl_page_slice *slice)
{
 ...
 */
struct cl_page *ccc_vmpage_page_transient(page_t *vmpage)
{
