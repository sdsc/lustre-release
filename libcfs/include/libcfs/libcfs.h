...
enum cfs_alloc_flags {
        ...
        CFS_ALLOC_NOWARN = (1 << 4),
        /* standard allocator flag combination */
        CFS_ALLOC_STD    = CFS_ALLOC_IO | CFS_ALLOC_ZERO,
        CFS_ALLOC_USER   = CFS_ALLOC_IO | CFS_ALLOC_FS | CFS_ALLOC_ZERO,
};
...
enum cfs_alloc_page_flags {
         ...
         * cfs_page_map(); */
        CFS_ALLOC_HIGH   = (1 << 5),
        CFS_ALLOC_HIGHUSER = CFS_ALLOC_FS | CFS_ALLOC_IO | CFS_ALLOC_HIGH,
};
