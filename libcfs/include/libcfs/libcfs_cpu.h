 ...
 *
 *   . User can speicify total number of CPU partitions while creating a
 ...
 */
int cfs_cpt_unset_cpu(struct cfs_cpt_table *cptab, int cpt, int cpu);
/**
 * add all cpus in \a mask to CPU partition \a cpt
 * number of successful setting is returned
 */
 ...
 */
int cfs_cpt_unset_cpumask(struct cfs_cpt_table *cptab,
                          int cpt, cpumask_t *mask);
/**
 ...
 */
int cfs_cpt_unset_node(struct cfs_cpt_table *cptab, int cpt, int node);
 ...
 */
int cfs_cpt_unset_nodemask(struct cfs_cpt_table *cptab,
                           int cpt, nodemask_t *mask);
/**
 * unset all cpus for CPU partition \a cpt
 */
int cfs_cpt_clear(struct cfs_cpt_table *cptab, int cpt);
/**
