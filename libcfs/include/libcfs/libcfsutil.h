 ...
 * Note: These bit maps are dependent on what CFS_MSG_MAX is
 *       from above.  If you change CFS_MSG_MAX, these bit maps
...
extern void cfs_error(int level, int _rc, const char *fmt, ...)
	__attribute__((format(printf, 3, 4)));
#define cfs_err_noerrno(level, fmt, a...)                             \
	cfs_error((level) | CFS_MSG_NO_ERRNO, 0, fmt, ## a)
extern void cfs_printf(int level, const char *fmt, ...)
