...
#define IOC_LIBCFS_ADD_ROUTE		   _IOWR(IOC_LIBCFS_TYPE, 85, \
						 IOCTL_CONFIG_SIZE)
#define IOC_LIBCFS_DEL_ROUTE		   _IOWR(IOC_LIBCFS_TYPE, 86, \
						 IOCTL_CONFIG_SIZE)
#define IOC_LIBCFS_GET_ROUTE		   _IOWR(IOC_LIBCFS_TYPE, 87, \
						 IOCTL_CONFIG_SIZE)
#define IOC_LIBCFS_ADD_NET		   _IOWR(IOC_LIBCFS_TYPE, 88, \
						 IOCTL_CONFIG_SIZE)
#define IOC_LIBCFS_DEL_NET		   _IOWR(IOC_LIBCFS_TYPE, 89, \
						 IOCTL_CONFIG_SIZE)
#define IOC_LIBCFS_GET_NET		   _IOWR(IOC_LIBCFS_TYPE, 90, \
						 IOCTL_CONFIG_SIZE)
#define IOC_LIBCFS_CONFIG_RTR		   _IOWR(IOC_LIBCFS_TYPE, 91, \
						 IOCTL_CONFIG_SIZE)
#define IOC_LIBCFS_ADD_BUF		   _IOWR(IOC_LIBCFS_TYPE, 92, \
						 IOCTL_CONFIG_SIZE)
#define IOC_LIBCFS_GET_BUF		   _IOWR(IOC_LIBCFS_TYPE, 93, \
						 IOCTL_CONFIG_SIZE)
#define IOC_LIBCFS_GET_PEER_INFO	   _IOWR(IOC_LIBCFS_TYPE, 94, \
						 IOCTL_CONFIG_SIZE)
#define IOC_LIBCFS_GET_LNET_STATS	   _IOWR(IOC_LIBCFS_TYPE, 95, \
						 IOCTL_CONFIG_SIZE)
#define IOC_LIBCFS_MAX_NR			      96
