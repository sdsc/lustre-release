...
struct cfs_range_expr {
        /**
         * Link to cfs_num_expr_list::el_exprs.
         */
        cfs_list_t      re_link;
        __u32           re_lo;
        __u32           re_hi;
...
int cfs_num_expr_parse(char *str, int len, unsigned min, unsigned max,
                       struct cfs_num_expr_list **elpp);
void cfs_num_expr_list_free(cfs_list_t *list);
int cfs_ip_addr_parse(char *str, int len, cfs_list_t *list);
int cfs_num_addr_match(__u32 addr, cfs_list_t *list, int shift);
