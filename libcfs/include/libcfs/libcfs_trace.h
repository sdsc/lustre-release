...
do {									\
	cfs_debug_trace(trace_lnet_info, __FILE__, __LINE__, __func__,	\
			fmt, ## __VA_ARGS__);				\
									\
...
do {									\
	cfs_debug_trace(trace_lnet_config, __FILE__, __LINE__, __func__,\
			fmt, ## __VA_ARGS__);				\
									\
...
do {									\
	cfs_debug_trace(trace_lnet_other, __FILE__, __LINE__, __func__,	\
			fmt, ## __VA_ARGS__);				\
									\
...
do {									\
	cfs_debug_trace(trace_lnet_ioctl, __FILE__, __LINE__, __func__,	\
			fmt, ## __VA_ARGS__);				\
									\
