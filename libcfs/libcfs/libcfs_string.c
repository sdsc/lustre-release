...
CFS_EXPORT_SYMBOL(cfs_expr_list_match);
...
CFS_EXPORT_SYMBOL(cfs_expr_list_free);
...
CFS_EXPORT_SYMBOL(cfs_expr_list_print);
...
CFS_EXPORT_SYMBOL(cfs_expr_list_parse);
...
CFS_EXPORT_SYMBOL(cfs_expr_list_free_list);
