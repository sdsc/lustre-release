...
/*
 * alloc_page
 *   To allocate the page_t and also 1 page of memory
 *
 * Arguments:
 *   flags:  the allocation options
 *
 * Return Value:
 *   pointer to the page_t strcture in success or
...
/*
 * __free_page
 *   To free the page_t including the page
 *
 * Arguments:
 *   pg:  pointer to the page_t strcture
 *
 * Return Value:
 *   N/A
 *
    ...
    )
{
    ...
    kmc = kmalloc (sizeof(cfs_mem_cache_t), 0);
