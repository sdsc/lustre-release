...
static int 
libcfs_psdev_open(struct inode *in, file_t * file)
{ 
...
static int 
libcfs_psdev_release(struct inode *in, file_t * file)
{
...
static int 
libcfs_ioctl(file_t * file, unsigned int cmd, ulong_ptr_t arg)
{ 
