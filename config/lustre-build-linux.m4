			...
			case $RHEL_KERNEL_VERSION in
				2.6.32-358*)
					EXTRA_LNET_INCLUDE="$EXTRA_LNET_INCLUDE -DCONFIG_COMPAT_RHEL_6_4"
                                        EXTRA_LNET_INCLUDE="$EXTRA_LNET_INCLUDE -DCONFIG_COMPAT_IS_PHYS_ID_STATE"
                                        EXTRA_LNET_INCLUDE="$EXTRA_LNET_INCLUDE -DCONFIG_COMPAT_IS_PCI_PHYSFN -DCONFIG_COMPAT_IS_KSTRTOX"
                                        EXTRA_LNET_INCLUDE="$EXTRA_LNET_INCLUDE -DCONFIG_COMPAT_IS_BITOP -DCONFIG_COMPAT_NETLINK_3_7"
                                        EXTRA_LNET_INCLUDE="$EXTRA_LNET_INCLUDE -DCONFIG_COMPAT_IS_IP_TOS2PRIO -DCONFIG_COMPAT_IS_NETIF_RSS_QUEUES"
                                        EXTRA_LNET_INCLUDE="$EXTRA_LNET_INCLUDE -DCONFIG_COMPAT_IS_NOOP_LLSEEK -DCONFIG_COMPAT_IS_SIMPLE_OPEN -DCONFIG_COMPAT_RCU"
                                        EXTRA_LNET_INCLUDE="$EXTRA_LNET_INCLUDE -DCONFIG_COMPAT_HAS_NUM_CHANNELS -DCONFIG_COMPAT_ETHTOOL_OPS_EXT"
					;;
			esac
		fi
