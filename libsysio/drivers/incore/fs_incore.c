...
#define INCORE_DIR_TEMPLATE_LEN (INCORE_D_RECLEN(1) + INCORE_D_RECLEN(2))

static char *incore_dir_template;
#if 0
...
_sysio_incore_init()
{
	 ...
	 */
	incore_dir_template = malloc(INCORE_DIR_TEMPLATE_LEN);
		     ...
		     struct intnl_stat *st)
{
	 ...
	 */
	err = incore_trunc(icino, INCORE_DIR_TEMPLATE_LEN, 1);
	if (err) {
